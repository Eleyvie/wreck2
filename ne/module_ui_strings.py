...
ui_strings = [
    ...
    ("explanation_intelligence", "Intelligence: Every point to intelligence immediately gives one extra skill point. The following skills can not be developed beyond 1/3 of Intelligence: Trainer, Tracking, Tactics, Pathfinding, Spotting, Inventory Management, Wound Treatment, Surgery, First Aid, Engineer."),
    ("explanation_charisma", "Charisma: Each point increases your party size limit by +1. The following skills can not be developed beyond 1/3 of Charisma: Persuasion, Prisoner Management, Leadership, Trade."),
    ("level", "Level: %d"),
    ("xp", "Experience: %d"),
    ...
    ("duel", "Duel"),
    ("mount", "Mount"),
    ("riding_skill_not_adequate_to_mount", "(You cannot ride this mount)"),
    ("dismount", "Dismount"),
    ("exit", "Exit"),
    ("door_to", "Door to "),
    ("open", "Open"),
    ...
    ("order_7", "Select Order 7"),
    ("order_8", "Select Order 8"),
    ...
    ("order_form_1_row", "Form one row"),
    ("form_1_row_e_", "%s, form one row!"),
    ("order_form_2_row", "Form two rows"),
    ("form_2_row_e_", "%s, form two rows!"),
    ("order_form_3_row", "Form three rows"),
    ("form_3_row_e_", "%s, form three rows!"),
    ("order_form_4_row", "Form four rows"),
    ("form_4_row_e_", "%s, form four rows!"),
    ("order_form_5_row", "Form five rows"),
    ("form_5_row_e_", "%s, form five rows!"),
    ("order_button_fire_at_my_command", "Fire at my command"),
    ("fire_at_my_command_e_", "%s, fire at my command!"),
    ("order_button_all_fire_now", "Fire now"),
    ("all_fire_now_e_", "%s, fire now!"),
    ("order_button_left_fire_now", "Left flank fire"),
    ("left_fire_now_e_", "%s left flank, fire!"),
    ("order_button_middle_fire_now", "Center fire"),
    ("middle_fire_now_e_", "%s center, fire!"),
    ("order_button_right_fire_now", "Right flank fire"),
    ("right_fire_now_e_", "%s right flank, fire!"),
    ("order_button_weapon_usage_orders", "Equipment orders"),
    ("order_button_use_melee_weapons", "Use melee weapons"),
    ("use_melee_weapons_e_", "%s, use melee weapons!"),
    ("order_button_use_ranged_weapons", "Use ranged weapons"),
    ("use_ranged_weapons_e_", "%s, use ranged weapons!"),
