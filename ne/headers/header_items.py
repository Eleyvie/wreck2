...
itc_1h_attack_swing = itcf_force_64_bits | itcf_overswing_onehanded | itcf_slashright_onehanded | itcf_slashleft_onehanded
itc_1h_attack_thrust = itcf_force_64_bits | itcf_thrust_onehanded
itc_2h_attack_swing = itcf_force_64_bits | itcf_overswing_twohanded | itcf_slashright_twohanded | itcf_slashleft_twohanded
itc_2h_attack_thrust = itcf_force_64_bits | itcf_thrust_twohanded
itc_polearm_attack_swing = itcf_force_64_bits | itcf_overswing_polearm | itcf_slashright_polearm | itcf_slashleft_polearm
itc_polearm_attack_thrust = itcf_force_64_bits | itcf_thrust_onehanded_lance | itcf_thrust_polearm
itc_lance_attack = itcf_force_64_bits | itcf_thrust_onehanded_lance

itc_mounted_attack_slash = itcf_force_64_bits | itcf_horseback_slashright_onehanded | itcf_horseback_slashleft_onehanded | itcf_horseback_slash_polearm
itc_mounted_attack_sweep = itcf_force_64_bits | itcf_horseback_slashright_onehanded | itcf_horseback_slashleft_onehanded
itc_mounted_attack_swing = itcf_force_64_bits | itcf_horseback_slashright_onehanded | itcf_horseback_slashleft_onehanded | itcf_horseback_overswing_right_onehanded | itcf_horseback_overswing_left_onehanded
itc_mounted_attack_thrust = itcf_force_64_bits | itcf_horseback_thrust_onehanded
itc_mounted_attack_lance = itcf_force_64_bits | itcf_thrust_onehanded_lance_horseback

itc_1h_parry = itcf_force_64_bits | itcf_parry_forward_onehanded | itcf_parry_up_onehanded | itcf_parry_right_onehanded | itcf_parry_left_onehanded
itc_2h_parry = itcf_force_64_bits | itcf_parry_forward_twohanded | itcf_parry_up_twohanded | itcf_parry_right_twohanded | itcf_parry_left_twohanded
itc_polearm_parry = itcf_force_64_bits | itcf_parry_forward_polearm | itcf_parry_up_polearm | itcf_parry_right_polearm | itcf_parry_left_polearm



itc_stiletto = itc_1h_attack_thrust | itc_mounted_attack_thrust | itc_1h_parry
itc_cleaver  = itc_1h_attack_swing | itc_mounted_attack_swing
itc_dagger   = itc_1h_attack_swing | itc_1h_attack_thrust | itc_mounted_attack_swing

itc_sword_1h = itc_1h_attack_swing | itc_1h_attack_thrust | itc_mounted_attack_swing | itc_mounted_attack_thrust | itc_1h_parry
itc_sword_2h = itc_2h_attack_swing | itc_2h_attack_thrust | itc_mounted_attack_swing | itc_mounted_attack_thrust | itc_2h_parry

itc_sabre_1h = itc_1h_attack_swing | itc_mounted_attack_swing | itc_1h_parry
itc_sabre_2h = itc_2h_attack_swing | itc_mounted_attack_swing | itc_2h_parry

itc_rapier_1h = itc_1h_attack_thrust | itc_mounted_attack_thrust | itc_1h_parry
itc_rapier_2h = itc_2h_attack_thrust | itc_mounted_attack_thrust | itc_2h_parry

itc_lance   =                            itc_lance_attack          |                            itc_mounted_attack_lance  | itc_polearm_parry
itc_pike    =                            itc_polearm_attack_thrust |                            itc_mounted_attack_thrust | itc_polearm_parry
itc_poleaxe = itc_polearm_attack_swing |                             itc_mounted_attack_slash |                             itc_polearm_parry
itc_halberd = itc_polearm_attack_swing | itc_polearm_attack_thrust |                            itc_mounted_attack_thrust | itc_polearm_parry
itc_hafted  = itc_polearm_attack_swing | itc_polearm_attack_thrust | itc_mounted_attack_slash | itc_mounted_attack_thrust | itc_polearm_parry

itc_rhodok  = itc_2h_attack_swing      | itc_polearm_attack_thrust |                            itc_mounted_attack_thrust | itc_polearm_parry

itc_staff   = itc_polearm_attack_swing | itc_polearm_attack_thrust |                            itc_mounted_attack_thrust | itc_polearm_parry
itc_spear   =                            itc_polearm_attack_thrust |                            itc_mounted_attack_thrust | itc_polearm_parry
