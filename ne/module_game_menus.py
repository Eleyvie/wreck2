    ...
    [
      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Praven, in the Kingdom of Swadia.",
       [
		 ...
		 # NE 
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_guard_troop, "trp_swadian_sergeant"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_messenger_troop, "trp_swadian_messenger"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_prison_guard_troop, "trp_swadian_prison_guard"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_castle_guard_troop, "trp_swadian_castle_guard"),
		 # NE
		 # NECOMMENT
      ...
      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Reyvadin, in the Kingdom of the Vaegirs.",
       [
		 ...
		 # NE 
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_guard_troop, "trp_vaegir_varangian_guard"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_messenger_troop, "trp_vaegir_messenger"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_prison_guard_troop, "trp_vaegir_prison_guard"),
          (faction_set_slot, "fac_player_supporters_faction",  slot_faction_castle_guard_troop, "trp_vaegir_castle_guard"),
          # NE 
...
#         (change_screen_return),
      ...
      ("town_3",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Tulga, in the Khergit Khanate.",
       [
		 ...
		 # NE 
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_guard_troop, "trp_khergit_rider"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_messenger_troop, "trp_khergit_messenger"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_prison_guard_troop, "trp_khergit_prison_guard"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_castle_guard_troop, "trp_khergit_castle_guard"),
		  # NE 
		 (jump_to_menu, "mnu_start_phase_2_5"),
#         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
#         (change_screen_return),
      ...
      ("town_4",[(eq, "$current_startup_quest_phase", 0),],"take a ship to Sargoth, in the Kingdom of the Nords.",
       [
		 ...
		 # NE 
		           (faction_set_slot, "fac_player_supporters_faction", slot_faction_guard_troop, "trp_nord_warrior"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_messenger_troop, "trp_nord_messenger"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_prison_guard_troop, "trp_nord_prison_guard"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_castle_guard_troop, "trp_nord_castle_guard"),
		  # NE 
		 (jump_to_menu, "mnu_start_phase_2_5"),
#         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
#         (change_screen_return),
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),],"take a ship to Jelkala, in the Kingdom of the Rhodoks.",
       [
		 ...
		 # NE 
		           (faction_set_slot, "fac_player_supporters_faction", slot_faction_guard_troop, "trp_rhodok_veteran_spearman"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_messenger_troop, "trp_rhodok_messenger"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_prison_guard_troop, "trp_rhodok_prison_guard"),
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_castle_guard_troop, "trp_rhodok_castle_guard"),
		  # NE 
		 (jump_to_menu, "mnu_start_phase_2_5"),
#         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
#         (change_screen_return),
      ...
      ("town_6",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Shariz, in the Sarranid Sultanate.",
       [
		 ...
		 # NE 
		           (faction_set_slot, "fac_player_supporters_faction", slot_faction_guard_troop, "trp_sarranid_castle_guard"),
          ...
          (faction_set_slot, "fac_player_supporters_faction", slot_faction_castle_guard_troop, "trp_sarranid_castle_guard"), 
		  # NE 
		 (jump_to_menu, "mnu_start_phase_2_5"),
#         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
#         (change_screen_return),
  ...
  (
	...
	# TUTORIAL
	("tutorial", mnf_disable_all_keys, "You approach a field where the locals are training with weapons. You can practice here to improve your combat skills.", "none", [
		(try_begin),
			inject('menu_tutorial_code'),
			(change_screen_quit),
		(try_end),
    ],
    [
		inject('menu_tutorial_options'),
  ...
  ("reports",0,
   ...
   [(call_script, "script_game_get_party_companion_limit"),
    ...
    (assign, "$temp", 0), # No fiefs held by player
    ...
    [
      inject('menu_reports_items'),

      ("party_report", [], "View party report.", [
        (change_screen_notes, 5, "ip_party"),
      ]),

      ("characters_report", [], "View character and companions report.", [
        (change_screen_notes, 5, "ip_characters"),
      ]),
      ...
      ("relations_report", [], "View your relations with kingdoms and lords.", [
        (change_screen_notes, 5, "ip_relations"),
      ]),
      ...
      ("fief_report", [(eq, "$temp", 1)], "View fiefs report.", [
        (change_screen_notes, 5, "ip_fiefs"),
      ]),

      ("construction_report", [(eq, "$temp", 1)], "View construction report.", [
        (change_screen_notes, 5, "ip_construction"),
      ]),

      ("alerts_report", [(eq, "$temp", 1)], "View military alerts.", [
        (change_screen_notes, 5, "ip_alerts"),
      ]),
      ...
      ("world_map", [], "View world political map.", [
      ...
      ("status_check", [(eq,"$cheat_mode",1)], "{!}Cheat: NPC status check.", [
  ...
  ("camp",mnf_scale_picture,
   ...
   [
	...
	##NE settings
      ("camp_game_settings_new", [], "Change game settings.", [
          (start_presentation, "prsnt_ne_settings"),
      ]),
# NE End
...
################################################################################
# CHARACTER GENERATION MENUS - BEFORE CHARACTER CREATION
################################################################################
    
    ("start_game_1", menu_text_color(0xFF000000)|mnf_disable_all_keys, "Select your character's gender.", "none", [], [
        ("start_male", [], "Male", [
        ...
        inject('menu_start_game_options'),
 ...
 and these debts can only be paid in blood..."),
        (jump_to_menu,"mnu_ask_brutality_create"),
        ]),
 ...
 You want everything, and you won't let anyone stop you from having it..."),
  ...
  # This is a separate, duplicate brutality menu used only at character creation
    ("ask_brutality_create",0,
   "Enable Brutality Mode? \
     ^^Brutality mode is an optional game-playing mode for Native Expansion that greatly increases the difficulty of the game. Many aspects of gameplay are changed. Once activated, this mode cannot be disabled. Be absolutely certain you are prepared for the challenges you will face. If you do not enable Brutality mode now, you must do so in-game before you reach level 3 if you want to use it. See the Native Expansion FAQ for a feature list.",
   "none",
   [
    ...
    [
      ("dont_enable_brutality",[],"Let me reconsider. I don't think I'm ready.",
       [(assign,"$setting_brutality_mode",0),
        (display_message,"@Brutality mode has not been enabled. Remember you must activate it before you reach level 3."),
        (jump_to_menu, "mnu_ask_darkknight_invade"),
       ]),
      ("enable_brutality",[],"I'm ready to conquer. Enable Brutality.",
       [(assign,"$setting_brutality_mode",1),
        (assign,"$setting_use_wounding",1),
        (assign,"$setting_towns_rebel",1),
        (assign,"$setting_lords_rebel",1),
        (assign,"$setting_lords_ask",1),
        (assign,"$disable_npc_complaints",0),
        (assign,"$setting_require_faction_noble_recruit",1),
        (assign,"$setting_use_new_noble_recruit_system",1),
        (assign,"$setting_prisoner_penalties",1),
        (troop_set_slot, "trp_player", slot_troop_renown, 0),
        (display_message,"@Brutality mode has been enabled. Good luck, brave soldier."),
        (jump_to_menu, "mnu_ask_darkknight_invade"),
       ]),
     ]),
   ...
   [
    ...
    [
      ("dont_enable_invasion",[(eq, "$setting_brutality_mode", 0)],"Do not allow invasion.",
       [(assign,"$invaded",1),
  ...
  (
    ...
    [
      ...
      (try_begin),
        ...
        (troop_raise_skill, "trp_player",skl.weapon_master,1),
        (troop_raise_skill, "trp_player",skl.power_strike,1),
        (troop_raise_skill, "trp_player",skl.riding,1),
        (troop_raise_skill, "trp_player",skl.tactics,1),
        ...
        # NE 6xx series Male Noble Father bonuses
        (troop_add_gold, "trp_player", 2400),
      (else_try),
        (eq,"$background_type",cb_noble),
        (eq,"$character_gender",tf_female),
        (troop_raise_attribute, "trp_player",ca_intelligence,2),
        (troop_raise_attribute, "trp_player",ca_charisma,1),
        (troop_raise_skill, "trp_player",skl.wound_treatment,1),
        (troop_raise_skill, "trp_player",skl.riding,2),
        ...
        #(troop_add_item, "trp_player","itm_tab_shield_round_a",imod.battered),
        (troop_add_gold, "trp_player", 100),
        # NE 6xx series Female Noble Father bonuses
        (troop_add_gold, "trp_player", 2400),
      (else_try),
        ...
        (troop_raise_skill, "trp_player",skl.riding,1),
        (troop_raise_skill, "trp_player",skl.leadership,1),
        (troop_raise_skill, "trp_player",skl.trade,2),
        (troop_raise_skill, "trp_player",skl.inventory_management,1),
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,10),
        (troop_add_gold, "trp_player", 250),
        (troop_set_slot, "trp_player", slot_troop_renown, 20),
         # NE 600 series Merchant Father bonuses
      ...
      (else_try),
        ...
        # NE 600 series Veteran Warrior Father Bonuses
      ...
      (else_try),
        ...
        # NE 600 series Hunter Father Bonuses
        (troop_add_gold, "trp_player", 470),
        (troop_add_item, "trp_player","itm_short_bow",0),
        (troop_add_item, "trp_player","itm_hunting_arrows",0),
      (else_try),
        ...
        (troop_set_slot, "trp_player", slot_troop_renown, 10),
        # NE 600 series Nomad Father Bonuses
        (troop_add_gold, "trp_player", 485),
        (troop_add_item, "trp_player","itm_khergit_horse",0),
      (else_try),
        (eq,"$background_type",cb_nomad),
        (eq,"$character_gender",tf_female),
        (troop_raise_attribute, "trp_player",ca_strength,1),
      ...
      (else_try),
        ...
        # NE 600 series Nomad Father Bonuses
        (troop_add_gold, "trp_player", 225),
        (troop_add_item, "trp_player","itm_throwing_daggers",0),
        (troop_add_item, "trp_player","itm_sword_medieval_c_small",0),
      (try_end),
	...
	(try_begin),
        ...
        (troop_add_item, "trp_player","itm_food_meat_dry",0),
        (troop_add_item, "trp_player","itm_food_meat_dry",0),
        (troop_add_item, "trp_player","itm_goods_furs",0),
        (troop_add_item, "trp_player","itm_goods_furs",0),
        # NE 600 Series Poacher Career Starting Gear
        (troop_add_item, "trp_player","itm_broadhead_arrows",0),
        (troop_add_item, "trp_player","itm_broadhead_arrows",0),
        (troop_add_item, "trp_player","itm_long_bow",0),
        (troop_add_item, "trp_player","itm_sword_norman",0),
        (troop_add_item, "trp_player","itm_shield_common_kite_e",0),
        ...
        (troop_add_item, "trp_player","itm_light_leather_boots",0),
        (troop_add_item, "trp_player","itm_hunter_horse",0),
        (troop_add_item, "trp_player","itm_food_meat_dry",0),
        (troop_add_item, "trp_player","itm_food_meat_dry",0),
    (else_try),
        ...
        #(troop_add_item, "trp_player","itm_goods_tools",0),
        #(troop_add_item, "trp_player","itm_saddle_horse",0),
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        # NE 600 Series Smith Career Starting Gear
        (troop_add_item, "trp_player","itm_hammer",0),
        (troop_add_item, "trp_player","itm_sledgehammer",0),
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        (troop_add_item, "trp_player","itm_shield_common_round_a",0),
        ...
        (troop_add_item, "trp_player","itm_hunter_horse",0),
        (troop_add_item, "trp_player","itm_book_weapon_mastery",0),
        (troop_add_gold, "trp_player", 900),
    (else_try),
        ...
        #(troop_add_item, "trp_player","itm_goods_linen",0),
       # (troop_add_item, "trp_player","itm_goods_pottery",0),
        #(troop_add_item, "trp_player","itm_goods_wool",0),
        #(troop_add_item, "trp_player","itm_goods_wool",0),
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        # NE 600 Series Peddler Career Starting Gear
        (troop_add_item, "trp_player","itm_falchion_new",0),
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        (troop_add_item, "trp_player","itm_leather_armor",0),
        (troop_add_item, "trp_player","itm_light_leather_boots",0),
        (troop_add_item, "trp_player","itm_riding_horse",0),
        (troop_add_item, "trp_player","itm_book_trade",0),
        (troop_add_item, "trp_player","itm_goods_salt",0),
        (troop_add_item, "trp_player","itm_goods_salt",0),
        (troop_add_item, "trp_player","itm_goods_dyes",0),
        (troop_add_item, "trp_player","itm_goods_dyes",0),
        (troop_add_item, "trp_player","itm_goods_furs",0),
        (troop_add_item, "trp_player","itm_goods_furs",0),
        (troop_add_gold, "trp_player", 410),
    (else_try),
        ...
        # NE 600 Series Bard Career Starting Gear
        (troop_add_item, "trp_player","itm_mandolin",0),
        (troop_add_item, "trp_player","itm_leather_armor",0),
        (troop_add_item, "trp_player","itm_light_leather_boots",0),
        (troop_add_item, "trp_player","itm_book_persuasion",0),
        (troop_add_item, "trp_player","itm_food_apples",0),
        (troop_add_item, "trp_player","itm_drink_ale",0),
        (troop_add_item, "trp_player","itm_drink_ale",0),
        (troop_add_item, "trp_player","itm_food_grapes",0),
        (troop_add_item, "trp_player","itm_scimitar",0),
        (troop_add_gold, "trp_player", 910),
    (else_try),
        ...
        #(troop_add_item, "trp_player","itm_saddle_horse",imod.swaybacked),
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        # NE 600 Series Squire/Lady In Waiting Career Starting Gear
        (troop_add_item, "trp_player","itm_hera_swadian_inf_shield_b",0),
        ...
        (troop_add_item, "trp_player","itm_mail_boots",0),
        (troop_add_item, "trp_player","itm_hunter_horse",0),
        (troop_add_item, "trp_player","itm_book_training_reference",0),
        (troop_add_gold, "trp_player", 1230),
    (else_try),
        ...
        #(troop_add_item, "trp_player","itm_hunting_crossbow",0),
        #(troop_add_item, "trp_player","itm_bolts",0),
        #(troop_add_item, "trp_player","itm_courser_horse", imod.spirited),
        ...
        (troop_add_item, "trp_player","itm_food_fish_smoked",0),
        # NE 600 Series Squire/Lady In Waiting Career Starting Gear
        (troop_add_item, "trp_player","itm_hera_swadian_cav_shield_a",0),
        (troop_add_item, "trp_player","itm_spear",0),
        (troop_add_item, "trp_player","itm_sword_norman",0),
        (troop_add_item, "trp_player","itm_mail_coif",0),
        (troop_add_item, "trp_player","itm_mail_mittens",0),
        (troop_add_item, "trp_player","itm_mail_shirt",0),
        (troop_add_item, "trp_player","itm_red_dress",0),
        (troop_add_item, "trp_player","itm_mail_boots",0),
        (troop_add_item, "trp_player","itm_hunter_horse",0),
        (troop_add_item, "trp_player","itm_book_training_reference",0),
        (troop_add_gold, "trp_player", 1230),
    (else_try),
        ...
        # NE 600 Series Student Career Starting Gear
        (store_random_in_range, ":book_no", books_begin, books_end),
        (troop_add_item, "trp_player",":book_no",0),
        (store_random_in_range, ":book_no", books_begin, books_end),
        (troop_add_item, "trp_player",":book_no",0),
...
##        (troop_raise_proficiency, "trp_player",5,10),
      ...
      (troop_add_item, "trp_player","itm_mule",0),

      inject('menu_start_game_final_options'),

      # NE 600 Series - Reset renown if player opted for brutality mode
      (try_begin),
        (eq,"$setting_brutality_mode",1),
        (troop_set_slot, "trp_player", slot_troop_renown, 0),
      (try_end),
           (try_begin),
             (eq, "$background_type", cb_noble),
...
################################################################################
# CHARACTER GENERATION MENUS - AFTER CHARACTER CREATION + STARTING QUEST
################################################################################
  ...
  (
    ...
    [
     ...
     (try_for_range, ":cur_good", trade_goods_begin, trade_goods_end),
	   (neq, ":cur_good", "itm_food_pork"), #tied to price of grain
	   (neq, ":cur_good", "itm_food_chicken"), #tied to price of grain
	   (neq, ":cur_good", "itm_food_butter"), #tied to price of cheese
	   (neq, ":cur_good", "itm_food_beef"),
	   (neq, ":cur_good", "itm_food_cabbages"), #possibly include later
...
################################################################################
# ARENA DUEL GAME MENUS
################################################################################

# NE change distance to 100000 from 10000
  ("arena_duel_fight",0,
...
################################################################################
# ENCOUNTER AND BATTLE GAME MENUS
################################################################################
...
#          NE 600 Series - bypass total defeat menu for tactical escape checks. Tactical menu MUST return to mnu_total_defeat
#          (jump_to_menu, "mnu_total_defeat"),
          (jump_to_menu, "mnu_ne_tactical_escape"),
        (try_end),
    ...
    [
      ...
      [
        ...
        (try_begin),
		  ...
		  # NE building
## Caltrops check - Jinnai
                                  (try_begin),
                                    (party_slot_eq, "$g_encounter_is_in_village", slot_center_has_caltrops, 1),
                                    (set_jump_mission,"mt_village_raid_no_horses"),
                                  (else_try),
...
#NPC companion changes end
	 ...
	 # NE settings
	     (str_clear,s12), # Start of the wounding system report - Jinnai
     (try_begin),
       (eq,"$setting_use_wounding",1),
       (store_sub, ":wound_severity", -1, "$setting_brutality_mode"), # 1 for normal mode, 2 for brutality
       (store_current_hours, ":cur_hours"),
       (assign,":p_wounded",0),
       (party_get_skill_level, ":wound_treat", "p_main_party", "skl_wound_treatment"),
       (val_mul,":wound_treat",24), # Take off one day per level of skill
       ...
       (try_for_range, ":i_stack", 0, ":num_stacks"),
         ...
         (is_between, ":stack_troop", companions_begin, companions_end), # Only apply wounds to player and his companions
         (troop_get_type,reg4,":stack_troop"),
         (try_begin),
           (eq,":stack_troop","trp_player"),
           (str_store_string,s0,"@You have "),
         (else_try),
           (str_store_troop_name,s0,":stack_troop"),
           (str_store_string,s0,"@{s0} has "),
         (try_end),
         (store_random_in_range,":add_hours",168,337), # Get a one week range of hours plus 1 week
         (val_sub,":add_hours",":wound_treat"),
         (gt, ":add_hours", 0), # Only proceed if some time is actually added, otherwise it's a post-battle heal
         (store_random_in_range,":rand",1,4),
         (try_begin),
           (eq,":rand",1),
           (troop_get_slot,":wound",":stack_troop",slot_troop_wound_str),
           (try_begin),
             (gt,":wound",0), # This has already been wounded
             (val_max,":add_hours",0), # To make sure wound treatment doesn't make this negative.  Heal from taking a wound? o.O
             (val_add,":wound",":add_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_str,":wound"),
             (str_store_string,s0,"@{s0}aggravated "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your wound affecting your strength."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} wound affecting {reg4?her:his} strength."),
             (try_end),
           (else_try),
             (val_add,":add_hours",168), # Add 1 week of recovery
             (val_add,":add_hours",":cur_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_str,":add_hours"),
             (troop_raise_attribute, ":stack_troop", ca_strength, ":wound_severity"),
             (str_store_string,s0,"@{s0}suffered a wound to the chest, affecting "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your strength."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} strength."),
             (try_end),
           (try_end),
         (else_try),
           (eq,":rand",2),
           (troop_get_slot,":wound",":stack_troop",slot_troop_wound_agi),
           (try_begin),
             (gt,":wound",0),
             (val_max,":add_hours",0),
             (val_add,":wound",":add_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_agi,":wound"),
             (str_store_string,s0,"@{s0}aggravated "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your wound affecting your agility."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} wound affecting {reg4?her:his} agility."),
             (try_end),
           (else_try),
             (val_add,":add_hours",168),
             (val_add,":add_hours",":cur_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_agi,":add_hours"),
             (troop_raise_attribute,":stack_troop",ca_agility,":wound_severity"),
             (str_store_string,s0,"@{s0}suffered wounds to the arms and legs, affecting "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your agility."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} agility."),
             (try_end),
           (try_end),
         (else_try),
           (eq,":rand",3),
           (troop_get_slot,":wound",":stack_troop",slot_troop_wound_cha),
           (try_begin),
             (gt,":wound",0),
             (val_max,":add_hours",0),
             (val_add,":wound",":add_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_cha,":wound"),
             (str_store_string,s0,"@{s0}aggravated "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your wound affecting your charisma."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} wound affecting {reg4?her:his} charisma."),
             (try_end),
           (else_try),
             (val_add,":add_hours",168),
             (val_add,":add_hours",":cur_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_cha,":add_hours"),
             (troop_raise_attribute,":stack_troop",ca_charisma,":wound_severity"),
             (str_store_string,s0,"@{s0}suffered a disfiguring wound to the head, affecting "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your charisma."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} charisma."),
             (try_end),
           (try_end),
         (else_try),
           (eq,":rand",4), # If it ever actually picks int, then the player gets -1 skill points.  Which is not a good thing...
           (troop_get_slot,":wound",":stack_troop",slot_troop_wound_int),
           (try_begin),
             (gt,":wound",0),
             (val_max,":add_hours",0),
             (val_add,":wound",":add_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_int,":wound"),
             (str_store_string,s0,"@{s0}aggravated "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your wound affecting your intelligence."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} wound affecting {reg4?her:his} intelligence."),
             (try_end),
           (else_try),
             (val_add,":add_hours",168),
             (val_add,":add_hours",":cur_hours"),
             (troop_set_slot,":stack_troop",slot_troop_wound_int,":add_hours"),
             (troop_raise_attribute,":stack_troop",ca_intelligence,":wound_severity"),
             (str_store_string,s0,"@{s0}suffered a concussive wound to the head, affecting "),
             (try_begin),
               (eq,":stack_troop","trp_player"),
               (str_store_string,s0,"@{s0}your intelligence."),
             (else_try),
               (str_store_string,s0,"@{s0}{reg4?her:his} intelligence."),
             (try_end),
           (try_end),
         (try_end),
         (val_add,":p_wounded",1),
         (str_store_string,s12,"@{s12}{s0}^"),
         (display_message,s0,0xff4040),
       (try_end),
       (gt,":p_wounded",0),
       (str_store_string,s12,"@{s12}^"),
     (try_end), 
	 # NE end settings
     ],
    [
  ...
  (
    "total_victory", 0,
    "You have defeated your enemies! {s9}",
    "none",
    [
        ...
        (else_try),          
          ...
          (assign, ":loot_interface_caller", "mnu_total_victory"),
          (try_begin),
            inject('loot_interface_check'),
            (change_screen_loot, "trp_temp_troop"),
          (try_end),
        (else_try),
          #finished all
          ...
          (else_try),            
            (try_begin), #my kingdom
              ...
              (else_try), #player took a walled center for player's kingdom
                ...
                (assign, ":best_troop", "trp_swadian_veteran_crossbowman"),
  ...
  (
    "ne_tactical_escape",0,
    "In the grim moments after {s1}, your enemies begin {s2}. {s3}, giving you a brief opportunity to attempt escape. What will you do?",
    "none",
    [
        (str_store_party_name, 1,"$g_encountered_party"),
         # Reset this to 0 in the event the player is defeated twice (we use this to allow lords to always imprison a player if they fail an escape)
        (assign, "$g_player_attempted_escape", 0),
        (try_begin),
          # The player has surrendered
          (eq, "$g_player_surrenders", 1),
#          (this_or_next|eq, "$g_next_menu", "mnu_captivity_start_wilderness_surrender"),
#          (this_or_next|eq, "$g_next_menu", "mnu_captivity_start_wilderness_defeat"),
#          (eq, "$g_next_menu", "mnu_captivity_start_wilderness"),
          (str_store_string, s1, "@surrendering your army"),
          (str_store_string, s2, "@taking your soldiers captive and looting your supplies"),
          (str_store_string, s3, "@Their guard is down following your surrender"),
        (else_try),
          # The player was defeated
          (str_store_string, s1, "@your defeat"),
          (str_store_string, s2, "@looting bodies and collecting their wounded"),
          (str_store_string, s3, "@Your enemies are occupied with looting"),
        (try_end),
      ],
    [
      ("tactical_escape_all_costs",[
         # Below will only allow a desparate escape outside of sieges. Disable for now.
#          (this_or_next|eq, "$g_next_menu", "mnu_captivity_start_wilderness_surrender"),
#          (this_or_next|eq, "$g_next_menu", "mnu_captivity_start_wilderness_defeat"),
#          (eq, "$g_next_menu", "mnu_captivity_start_wilderness"),
          ],
          "Avoid capture at all costs, fleeing into the wilderness... [Pathfinding]",
            [
            # Companions dislike a coward
              (call_script, "script_objectionable_action", tmt_aristocratic, "str_flee_battle"),
              (assign, "$g_player_attempted_escape", 1),

            # Additional hit to honor and renown if the player surrendered first, for perfidy
              (try_begin),
                (eq, "$g_player_surrenders", 1),
                (call_script, "script_change_player_honor", -5),
              (try_end),

            # Fleeing has a 90% chance of losing a soldier
...
#                (assign, "$g_recalculate_ais", 1),
          ...
          #    (call_script, "script_remove_troop_from_prison", ":stack_troop"),
            ...
            # Roll the player's escape chance
            (try_begin),
              (store_skill_level, ":pathfinding_level", "skl_pathfinding", "trp_player"),
              (store_mul, ":escape_chance", ":pathfinding_level", 10),
              (val_add, ":escape_chance", 50),
              (store_random_in_range, ":rand", 0, 100),
              (try_begin),
                (gt, ":escape_chance", 95),
                (assign, ":escape_chance", 95),
              (try_end),
              (assign, reg4, ":escape_chance"),
              #(display_message, "@DEBUG: Your escape chance is {reg4} percent."),
              (gt, ":escape_chance", ":rand"),
              (jump_to_menu,"mnu_ne_escape_desparate"),
            (else_try),
              (display_message, "@You are caught attempting to escape, angering your captors further."),
              (jump_to_menu,"mnu_total_defeat"),
#              (set_camera_follow_party, "$capturer_party"),
#              (assign, "$g_player_is_captive", 1),
#              (store_random_in_range, ":random_hours", 72, 144),         
...
#              (jump_to_menu,"mnu_total_defeat")
      ...
      ("tactical_escape_surrender",[
          (eq, "$g_player_surrenders", 1),
          ],
          "Surrender peacefully, presenting arms to your captors. [Honor]",[
              (call_script, "script_change_player_honor", 3),
              (jump_to_menu,"mnu_total_defeat")]),
      ("tactical_escape_noresist",[
          # The player didn't surrender, but is not attempting to escape
          (eq, "$g_player_surrenders", 0),
          ],
          "Accept defeat, presenting arms to your captors. [Renown]",[
              (call_script, "script_change_troop_renown", "trp_player", 5),
              (jump_to_menu,"mnu_total_defeat")]),
    ]
  ),
  ...
  (
    "ne_failed_escape",0,
    "Abandoning soldier and sword alike, you take every desparate measure needed to escape. Though your reputation will surely suffer, you are free and alive to fight again.",
    "none",
    [
        (troop_get_type, ":is_female", "trp_player"),
        (try_begin),
          (eq, ":is_female", "trp_player"),
      ...
      [
          ("continue", [], "Continue...", [
            ...
            # Running away leaves the player's inventory easy picking
            ...
            # Free the player
              ...
              (change_screen_return),
              (display_message, "@You flee into the wilderness and escape your captors."),
            ]),
      ]
  ),

  (
    "ne_escape_desparate",0,
    "Abandoning soldier and sword alike, you take every desparate measure needed to escape. Though your reputation will surely suffer, you are free and alive to fight again.",
    "none",
    [
        (troop_get_type, ":is_female", "trp_player"),
  ...
  (
    ...
    [
        ...
        (str_store_string, s5, "$g_next_menu"),
        (assign, reg4, "$g_next_menu"),
        ...
        #(try_end),
          ...
          (else_try),
            ...
            (else_try),
# NE chivalry
              (try_begin), # Give the player a chance to escape - Jinnai
                # NE 600 series - Lord is angered by escape attempt and will not allow player to go free
                (eq, "$g_player_attempted_escape", 0),
                (party_stack_get_troop_id,":leader","$g_encountered_party"),
                (is_between,":leader",active_npcs_begin,active_npcs_end),
                (troop_get_slot,":lord_party",":leader",slot_troop_leaded_party),
                (gt,":lord_party",0),
                (troop_get_slot, ":rep", ":leader", slot_lord_reputation_type),
                (call_script, "script_troop_get_player_relation",":leader"),
                (assign, ":relation", reg0),
                (ge,":relation",0), # Only lords that don't actively hate the player will let them go free
                (this_or_next|eq,":rep",lrep_upstanding),
                (this_or_next|eq,":rep",lrep_martial),
                (eq,":rep",lrep_goodnatured), # Only goodnatured, upstanding, and martial will consider it
                (store_random_in_range,":rand",1,11),
                (le,":rand",5), #50% chance
                (assign,"$g_next_menu","mnu_lord_released_player"),
              (try_end),
...
# NE chivalry
## The player was released by the lord - Jinnai
  (
    "lord_released_player",mnf_scale_picture,
    "{s0} recognizes {s1} and decides to let you go free.  However, {reg4?she:he} recommends you move to a safe\
 location quickly, before {reg4?she:he} changes {reg4?her:his} mind.",
    "none",
    [
        ...
        (try_begin),
          (eq, "$g_player_surrenders", 1),
          (str_store_string, s1, "@the honor in surrendering your army to avoid a needless bloodbath"),
        (else_try),
          (str_store_string, s1, "@your bravery and valor in combat"),
        (try_end),
     ],
    [
      ("continue",[],"Continue...",
...
{reg1? You may station troops here to defend it against enemies who may try to recapture it. Also, you should select now whether you will hold the {reg2?town:castle} yourself or give it to a faithful vassal...:}",# Only visible when castle is taken without being a vassal of a kingdom.
    ...
    [
        ...
        (try_begin),
		  ...
		  # NE 
		  (call_script, "script_change_player_relation_with_faction", "$players_kingdom", 5), #Give players a relation bump with faction for capturing a castle or town
		  # NE 
         (party_get_slot,":old_lord","$g_encountered_party",slot_town_lord),
          (try_begin), ## Give a relation penalty to the player for taking their castle from them and fix rebellion relation - Jinnai
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_leader, "trp_player"),
            (try_begin),
              (gt,":old_lord",0),
              (call_script,"script_change_player_relation_with_troop",":old_lord",-15),
            (else_try),
              (party_get_slot, ":relation", "$g_encountered_party", slot_center_player_relation),
              (val_max,":relation",-5),
              (party_set_slot, "$g_encountered_party", slot_center_player_relation, ":relation"),
            (try_end),
          (try_end),		
		  # Ne end 
		  # NE end
...
################################################################################
# REQUESTED CENTER GRANTING GAME MENUS
################################################################################
...
(
 ...
 ",
    ...
    [
        ...
        (call_script, "script_troop_add_gold", "trp_player", reg6),
		# NE finances
		(call_script, "script_adjust_finances", slot_finance_from_battles, reg6),
		# Ne end finances
        (change_screen_return),
        ]),
    ],
...
################################################################################
# WALLED CENTER VISIT GAME MENUS
################################################################################
    ...
    [
      ...
      ("castle_start_siege",
       ...
       [
         ...
         (call_script, "script_village_set_state", "$g_player_besiege_town", svs_under_siege),
...
#                                                       (set_jump_mission,"mt_town_default"),
 ...
 # NE kingdom
  ...
  (
    ...
    [
        ...
        (try_begin),
          ...
          (call_script, "script_adjust_finances", slot_finance_taxes_collected, ":total_tax"),
  ...
  (
    "all_center_tax",mnf_disable_all_keys,
    "You receive the accumulated rents and taxes for all of your fiefs, amounting to {reg1} denars.",
    "none",
    [
        (str_clear, s3),
        (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
        ...
        (try_for_range, ":town_no", centers_begin, centers_end),
          ...
          (store_add, ":total_tax", ":total_tax", ":accumulated_tariffs"),
          (store_add, ":total_tax", ":total_tax", ":accumulated_rents"),
          (party_set_slot, ":town_no", slot_center_accumulated_rents, 0),
          (party_set_slot, ":town_no", slot_center_accumulated_tariffs, 0),
        (try_end),
        (assign, reg1, ":total_tax"),
        (call_script, "script_troop_add_gold", "trp_player", ":total_tax"),
        (call_script, "script_adjust_finances", slot_finance_taxes_collected, ":total_tax"),
...
# NE building
            ...
            (try_begin),
              (eq, "$current_town", "$g_player_court"),
              (try_begin),
                (faction_slot_eq,"fac_player_supporters_faction",slot_faction_university,"$current_town"),
                (str_store_string,s11,"@ Your own banner flies over the town gates and this is the capital of your kingdom. The university here is bustling with activity."),
              (else_try),
                (str_store_string,s11,"@ Your own banner flies over the town gates and this is the capital of your kingdom."),
              (try_end),
            (else_try),
              (try_begin),
                (faction_slot_eq,"fac_player_supporters_faction",slot_faction_university,"$current_town"),
                (str_store_string,s11,"@ Your own banner flies over the town gates. The university here has fallen into disrepair."),
              (else_try),
                (str_store_string,s11,"@ Your own banner flies over the town gates."),
              (try_end),
            (try_end),			
...
# maybe update later 
          ...
          (else_try),
            ...
            #(str_store_string,s11,"@ You see the banner of {s7} over the town gates."),
			 (try_begin),
              (faction_slot_eq,"fac_player_supporters_faction",slot_faction_university,"$current_town"),
              (str_store_string,s11,"@ You see the banner of {s7} over the town gates. The university here has fallen into disrepair."),
            (else_try),
              (str_store_string,s11,"@ You see the banner of {s7} over the town gates."),
            (try_end),
			# ne end building
...
# NE kingdom
## Tax changes part 1 begin - Jinnai
...
## Allow lords in prison at this town to challenge the player to a duel - Jinnai
        ...
        (else_try),
          ...
          (else_try),
            (try_begin),
              (faction_slot_eq,"fac_player_supporters_faction",slot_faction_university,"$current_town"),
              (str_store_string,s11,"@ The townsfolk here have declared their independence. The university here has fallen into disrepair."),
            (else_try),
              (str_store_string,s11,"@ The townsfolk here have declared their independence."),
            (try_end),
          (try_end),
...
#		(try_end),
            ...
            # Lav changes for 0.610: determining in advance what town management features are available to the player
            #(try_begin),
            #(try_end),
        ],
    [
      ...
      ("town_castle",[        
       ...
       [           
           ...
           (else_try),
			...
			(else_try),
			# NE assassin
		   # added Josef 586 assassin attack check
		   (party_slot_eq, "$current_town", slot_town_lord, "trp_player"), #for castles, only have assassin attacks in own castle
	       (call_script, "script_cf_enter_center_location_assassin_check", 1),	
	       (else_try), 
			#end add			
			# NE end assassin
...
# NE misc
## Talk to guild master begin - Jinnai

      ("talk_with_locals", [
          (party_slot_eq,"$current_town",slot_party_type, spt_town)
      ], "Talk to...", [
          (jump_to_menu, "mnu_town_talk_locals"),
      ]),

      ("talk_with_guild_master",
       [
           (eq, 1, 0), # Disabled by Lav for 0.608b9
           (party_slot_eq,"$current_town",slot_party_type, spt_town)
        ],
...
## Talk to guild master end
# Ne end misc		
		
		
     ("town_enterprise",
      [
        (eq, 1, 0), # Disabled by Lav for 0.608b9 (moved to commerce menu)
        (party_slot_eq,"$current_town",slot_party_type, spt_town),
    ...
    ("visit_lady",
	[
    (party_slot_eq, "$current_town", slot_party_type, spt_castle), # Disabled for towns by Lav for 0.608b9 (moved to commerce menu)
      ...
      ("trade_with_merchants",
       [
         ...
         [
          ...
          # Player is noble
          # Town has volunteers
          # Player party has free capacity
          # Player is not king or marshall of this faction
          # Player is non-hostile with faction
          # Player has enough relation + persuasion with town
          ("recruit_nobles",[
            #(neg|party_slot_eq, "$current_town", slot_village_state, svs_under_siege),
            (party_slot_eq, "$current_town", slot_party_type, spt_town),        # Only in towns
            (eq,"$entry_to_town_forbidden",0),                                  # If legally entered
            (neg|party_slot_eq, "$current_town", slot_town_lord, "trp_player"), # Player not lord of this town
            (this_or_next|gt, "$player_has_homage", 0),                         # Player must be a lord
            (eq, "$players_kingdom", "fac_player_supporters_faction"),          # Or a foreign king
            (party_slot_ge, "$current_town", slot_center_volunteer_troop_amount, 0), # Town has volunteers
            (party_slot_ge, "$current_town", slot_center_volunteer_troop_type, 1),
            (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),  # Player party has capacity
            (ge, ":free_capacity", 1),
            (troop_slot_ge, "trp_player", slot_troop_renown, 250),              # Player renown >= 250
            # Additional checks
            (store_faction_of_party, ":faction", "$current_town"),
            (neg|faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),   # Player not king of this faction
            (neg|faction_slot_eq, ":faction", slot_faction_marshall, "trp_player"), # Player not marshall of this faction
            (store_relation, ":relation", ":faction", "fac_player_faction"),
            (ge, ":relation", 0),                                                   # Player not hostile with faction
            # Calculate center relation prerequisite
            (store_skill_level, ":relation_req", "skl_persuasion", "trp_player"),
            (try_begin),
              (eq, ":faction", "$players_kingdom"), # Same faction?
              (store_sub, ":relation_req", 0, ":relation_req"),
            (else_try),
              (store_sub, ":relation_req", 10, ":relation_req"),
            (try_end),
            (party_slot_ge, "$current_town", slot_center_player_relation, ":relation_req"),
          ] ,"Recruit nobles.", [
            (try_begin),
              (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try),
...
#        ("recruit_noble_debug",[],"Debug Noble Recruit",[(jump_to_menu, "mnu_recruit_volunteers")]),
#        ("recruit_elite_debug",[],"Debug Elite Recruit",[(jump_to_menu, "mnu_recruit_special")]),		
#        ("recruit_noble_debug_new",[],"Debug Noble Recruit New",[(jump_to_menu, "mnu_recruit_nobles_new_system")]),
        #("recruit_elite_debug_new",[],"Debug Elite Recruit New",[(jump_to_menu, "mnu_recruit_special_new_system")]),		
#        ("recruit_add_renown_debug",
#          [],"Debug Add Renown",
#            [
#              (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
#              (store_mul, ":renown_increase", 10, 10),
#              (val_add, ":player_renown", ":renown_increase"),
#              (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
#              (display_message, "@You gain 100 renown for being a cheater."),
#            ]
#        ),
...
# Ne building
      ("recruit_special",[
                      ...
                      (assign,":continue",0),
                      (try_begin),
                        (party_slot_eq, "$current_town", slot_center_has_cathedral, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@cathedral"),
                      (else_try),
                        (party_slot_eq, "$current_town", slot_center_has_ivory_temple, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@ivory temple"),
                      (else_try),
                        (party_slot_eq, "$current_town", slot_center_has_palace, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@palace"),
                      (else_try),
                        (party_slot_eq, "$current_town", slot_center_has_hall, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@halls of glory"),
                      (else_try),
                        (party_slot_eq, "$current_town", slot_center_has_chambers, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@council chambers"),
                      (else_try),
                        (party_slot_eq, "$current_town", slot_center_has_baths, 1),
                        (assign,":continue",1),
                        (str_store_string,s1,"@House of Swords"),									
                      (try_end),
                      (eq,":continue",1),
       ...
       [
         (try_begin),
           (call_script, "script_cf_enter_center_location_bandit_check"),
         (else_try),
           (eq,"$setting_use_new_noble_recruit_system",1),
           (jump_to_menu, "mnu_recruit_special_new_system"),
         (else_try),
           (jump_to_menu, "mnu_recruit_special"),
         (try_end),
        ]),
...
# Ne end building 	
      ...
      [
        ...
        (this_or_next|faction_slot_eq, ":faction", slot_faction_marshall, "trp_player"),
        (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
        (assign, reg0, 1),
        (try_begin),
          (party_slot_eq, "$current_town", slot_party_type, spt_castle),
	   ...
	   # NE assassin
		...
		# ne end assassin
           ...
           #(assign, "$g_next_menu", "mnu_town"),
             (jump_to_menu, "mnu_walled_center_manage"),
		  # NE assassin 
		   (try_end),
		   # ne end assassin
       ]),
	  ...
	  # NE garrison
## Allow garrisoning of troops in towns of the player's kingdom that they don't personally own - Jinnai
     ("castle_give_troops",
      [
          (eq, 1, 0), # Disabled by Lav for 0.608b9
          (store_faction_of_party, ":faction", "$current_town"),
          (eq,":faction","fac_player_supporters_faction"),
          (party_slot_ge, "$current_town", slot_town_lord, 0), # I.e. belongs to someone
          (neg|party_slot_eq,"$current_town",slot_town_lord, "trp_player"), # But not to player
       ],
         "Give troops to the garrison here...",
         [
  ...
  ( "blacksmith_forge",0,
    ...
    [
      ("slot_0",[
           ...
           (this_or_next|eq,":mod",imod.battered),
           (this_or_next|eq,":mod",imod.cracked),
           (this_or_next|eq,":mod",imod.bent),
           (this_or_next|eq,":mod",imod.chipped),
           (this_or_next|eq,":mod",imod.old),
           (this_or_next|eq,":mod",imod.tarnished),
           (this_or_next|eq,":mod",imod.makeshift),
           (this_or_next|eq,":mod",imod.crude),
                        (eq,":mod",imod.unwieldy),
...
# NE end     
  ...
  (
	...
	# NE finances
	(try_begin),
       (eq,"$temp_2",100003), #A hack, but it'll have to do to not break saves making a new variable since everything after change_screen is called before the screen changes - Jinnai
       (store_troop_gold,"$temp_2","trp_player"),
       (val_sub,"$temp_2","$temp"),
       (call_script, "script_adjust_finances", slot_finance_items, "$temp_2"),
       (assign, "$temp_2", 0),
     (try_end),
	 # Ne end finances
...
## Part 1 of blacksmith forge option - Jinnai
      ("repair_items",
       [
           ...
           (faction_slot_eq,"fac_player_supporters_faction", slot_faction_leader, "trp_player"),
           (faction_slot_eq,"fac_player_supporters_faction", slot_faction_univ_repair, 1),
...
################################################################################
# VILLAGE VISIT GAME MENUS
################################################################################

  (
    "village",mnf_enable_hot_keys,
    "{s10} {s12}^{s11}^{s6}{s8}{s7}",
    "none",
    [
        (assign, "$current_town", "$g_encountered_party"),
        (call_script, "script_update_center_recon_notes", "$current_town"),
        ...
        # NE 600 series: Display if the village has a militia or not
        (try_begin),
          (party_get_slot, ":militia_completed", "$current_town", slot_militia_quest_completed),
          (gt, ":militia_completed", 0),
          (str_store_string,s8,"@This village has a militia protecting it."),
        (else_try),
          (str_store_string,s8,"@This village does not have a militia."),
        (try_end),
        # End display if the village has a militia or not
        ...
        (try_begin),
		  ...
		  # NE kingdom
		            (neq,":center_faction","fac_outlaws"), #Make sure this doesn't show up as infested by bandits if rebelling - Jinnai
		  #v585 Josefgirl
		  #(neg|check_quest_active,"qst_hunt_down_girl"),
		  #endv585 Josef
		  # NE end kingdom
...
# NE quests 		
		#v585 Josefgirl
          ...
          (party_slot_ge, "$current_town", slot_village_infested_by_wedding, 1),
          (neq,":center_faction","fac_outlaws"), #Make sure this doesn't show up as infested by bandits if rebelling - Jinnai
          (party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_wedding),
          (store_character_level, ":player_level", "trp_player"),
          (store_add, "$qst_eliminate_wedding_infesting_village_num_guests", ":player_level", 10),
          ...
          # (store_random_in_range, "$qst_eliminate_wedding_infesting_village_num_villagers", 25, 30),
          (assign, reg8, "$qst_eliminate_wedding_infesting_village_num_guests"),
          (str_store_troop_name_by_count, s35, ":bandit_troop", "$qst_eliminate_wedding_infesting_village_num_guests"),
          (str_store_string, s6, "@^A wedding is taking place here. People are singing and laughing... until they catch sight of you. The wedding party confronts you angrily."),
          # (try_begin),
            # (eq, ":bandit_troop", "trp_forest_bandit"),
            # (set_background_mesh, "mesh_pic_forest_bandits"),
          # (else_try),
...
# NE end quests		
    ...
    [    
      ...
      [
		...
		# NE quests
								 #v585 Josefgirl
						 (neg|party_slot_ge, "$current_town", slot_village_infested_by_wedding, 1),
		# NE end quests
        (party_slot_eq, "$current_town", slot_town_lord, "trp_player")
        ]
       ,"Manage this village.",
...
# NE misc		
## Talk to village elder begin - Jinnai

      ("talk_with_village_elder",
       [
           (neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
           (neg|party_slot_eq, "$current_town", slot_village_state, svs_being_raided),
           (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
		   ...
		   (neg|party_slot_ge, "$current_town", slot_village_infested_by_wedding, 1),
           (party_get_slot, ":village_elder_troop", "$current_town",slot_town_elder),
           (str_store_troop_name,s9,":village_elder_troop"),
        ],
         "Speak with {s9}, the Village Elder.",
         [
           (try_begin),
             (call_script, "script_cf_enter_center_location_bandit_check"),
           (else_try),
...
# Ne Rebellion
	  ...
	  (store_faction_of_party, ":center_faction", "$current_town"),
	  (neq,":center_faction","fac_outlaws"),
	  ],
       "Attack the bandits.",
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_bandits),
...
# Option to attempt to suppress the rebellion - Jinnai
      ("suppress_rebellion",[(party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),(store_faction_of_party, ":center_faction", "$current_town"),(eq,":center_faction","fac_outlaws"),],
       ...
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_bandits),
        ...
        (set_battle_advantage, 0),
        (assign, "$g_battle_result", 0),
        (set_jump_mission,"mt_village_rebellion"),
        (jump_to_scene, ":scene_to_use"),
        (assign, "$g_next_menu", "mnu_village_rebellion_result"),
        (jump_to_menu, "mnu_battle_debrief"),
        (assign, "$g_mt_mode", vba_normal),
        (change_screen_mission),
        ]),
...
# Ne quests
		...
		#v585 Josefgirl
		# Option to deal with wedding party 
      ("village_attack_wedding",[
	  (party_slot_ge, "$current_town", slot_village_infested_by_wedding, 1),
	  (store_faction_of_party, ":center_faction", "$current_town"),
	  (neq,":center_faction","fac_outlaws"),
	  # Only call when hunting the girl quest is active
	  (check_quest_active,"qst_hunt_down_girl"),
		   ],
       ...
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_wedding),
        ...
        (modify_visitors_at_site,":scene_to_use"),
        (reset_visitors),
        (set_visitors, 0, ":bandit_troop", "$qst_eliminate_wedding_infesting_village_num_guests"),
		# we ddon't want any villagers helping us out
        # (set_visitors, 2, "trp_farmer", "$qst_eliminate_bandits_infesting_village_num_villagers"),
        (set_party_battle_mode),
        (set_battle_advantage, 0),
        (assign, "$g_battle_result", 0),
       ...
       [(party_slot_eq, "$current_town", slot_center_has_manor, 1),
        ...
        (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
         ...
         [
		   ...
		   # Ne building
		   ## Festival stuff - Jinnai
           (store_current_hours, ":cur_hours"),
           (store_add, "$g_last_rest_festival_until", ":cur_hours", 24),
		   # NE end building 
...
# NE conscription		   
      ...
      ("conscript_townsfolk",[(call_script, "script_cf_village_conscript_volunteers_cond"),],
       "Conscript the Villagers.",
       [
         (try_begin),
           (call_script, "script_cf_enter_center_location_bandit_check"),
         (else_try),
           (jump_to_menu, "mnu_conscript_volunteers"),
         (try_end),
        ]),
##consctipt end
# NE end conscription
    ...
    [
      ("continue",[],"Continue...",
       [(party_set_slot, "$g_encountered_party", slot_village_infested_by_bandits, 0),
        (party_set_slot, "$g_encountered_party", slot_militia_quest_completed, 0),
 ...
 but they offer you all they can find.",
    ...
    [(party_get_slot, ":bandit_troop", "$g_encountered_party", slot_village_infested_by_bandits),
     (party_set_slot, "$g_encountered_party", slot_village_infested_by_bandits, 0),
     (try_begin), # Remove militia with 50% chance
...
# The next two menus are rebellion suppression attempt results - Jinnai
  (
    "village_rebellion_result",mnf_scale_picture,
    "{s9}",
    "none",
    [(try_begin),
       (eq, "$g_battle_result", 1),
       (jump_to_menu, "mnu_village_rebellion_suppressed"),
     (else_try),
       (str_store_string, s9, "@Try as you might, you could not defeat the peasants. They continue to rebel against you and your kingdom."),
       (set_background_mesh, "mesh_pic_looted_village"),
     (try_end),
    ],
    [
  ...
  (
    "village_rebellion_suppressed",mnf_disable_all_keys,
    "You crush the peasant uprising and establish a semblance of order.  The village is badly damaged and the spirits of its people crushed, but it is once again yours.",
    "none",
    [(party_get_slot, ":bandit_troop", "$g_encountered_party", slot_village_infested_by_bandits),
     (party_set_slot, "$g_encountered_party", slot_village_infested_by_bandits, 0),
     (party_set_slot, "$g_encountered_party", slot_militia_quest_completed, 0),
...
#NPC companion changes end
		...
		# NE finances
		 (call_script, "script_adjust_finances", slot_finance_from_battles, reg1),
		# NE end finances
      ],
    [
      ("continue",[], "Continue...",
 ...
 currently building {s7}. The building will be completed after {reg8} day{reg9?s:}.:}",
    ...
    [(assign, ":num_improvements", 0),
     ...
     (else_try),
	   ...
	   (assign, ":end", walled_center_improvements_and_specials_end), # Show the special buildings too - Jinnai
	   # NE end building
     ...
     (try_for_range, ":improvement_no", ":begin", ":end"),
       ...
       (try_begin),
         ...
         (str_store_string, s18, "@{!}{s50}"),
       (else_try),
         (str_store_string, s18, "@{!}{s18}, {s50}"),
       (try_end),
     (try_end),
	...
	# NE building
	## New building construction - Jinnai
      ("center_build_university",[(eq, reg6, 0),
                             (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                             (faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
                             (faction_slot_eq, "fac_player_supporters_faction", slot_faction_university, 0),
                             (eq, "$g_encountered_party", "$g_player_court"),
                                  ],
       "Build a university.",[(jump_to_menu, "mnu_build_university"),]),
	   # ne end building 
      ...
      ("center_build_school",[(eq, reg6, 0),
       ...
       "Build a school.",[(assign, "$g_improvement_type", slot_center_has_school),
		...
		# NE building
	      ("center_build_cattle_ranch",[(eq, reg6, 0),
                              (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                              (party_slot_eq, "$g_encountered_party", slot_center_has_cattle_ranch, 0),
                                  ],
       "Build a cattle ranch.",[(assign, "$g_improvement_type", slot_center_has_cattle_ranch),
                          (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_palisade",[(eq, reg6, 0),
                              (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
       ...
       "Build a palisade.",[(assign, "$g_improvement_type", slot_center_has_palisade),
                          (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_horse_ranch",[(eq, reg6, 0),
                              (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                              (party_slot_eq, "$g_encountered_party", slot_center_has_horse_ranch, 0),
                                  ],
       "Build a horse ranch.",[(assign, "$g_improvement_type", slot_center_has_horse_ranch),
                          (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_distillery",[(eq, reg6, 0),
                              (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                              (party_slot_eq, "$g_encountered_party", slot_center_has_distillery, 0),
                                  ],
       "Build a distillery.",[(assign, "$g_improvement_type", slot_center_has_distillery),
                          (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_caltrops",[(eq, reg6, 0),
                              (party_slot_eq, "$g_encountered_party", slot_party_type, spt_village),
                              (party_slot_eq, "$g_encountered_party", slot_center_has_caltrops, 0),
                                  ],
       "Build caltrops.",[(assign, "$g_improvement_type", slot_center_has_caltrops),
                          (jump_to_menu, "mnu_center_improve"),]),
	...
	# NE build
	      ("center_build_caravan_escort",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_caravan_escort, 0),
                                       ],
       "Build a caravan escort outpost.",[(assign, "$g_improvement_type", slot_center_has_caravan_escort),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_bookstore",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_bookstore, 0),
                                       ],
       "Build a bookstore.",[(assign, "$g_improvement_type", slot_center_has_bookstore),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_festival_square",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_festival_square, 0),
                                       ],
       "Build a festival square.",[(assign, "$g_improvement_type", slot_center_has_festival_square),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ...
      ("center_build_cathedral",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_cathedral, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_1"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_cathedral, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_cathedral),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build a cathedral.",[(assign, "$g_improvement_type", slot_center_has_cathedral),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_temple",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_ivory_temple, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_2"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_ivory_temple, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_ivory_temple),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build an ivory temple.",[(assign, "$g_improvement_type", slot_center_has_ivory_temple),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_palace",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_palace, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_3"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_palace, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_palace),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build a palace.",[(assign, "$g_improvement_type", slot_center_has_palace),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_hall",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_hall, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_4"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_hall, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_hall),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build halls of glory.",[(assign, "$g_improvement_type", slot_center_has_hall),
                                  (jump_to_menu, "mnu_center_improve"),]),
      ("center_build_chambers",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_chambers, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_5"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_chambers, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_chambers),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build council chambers.",[(assign, "$g_improvement_type", slot_center_has_chambers),
                                  (jump_to_menu, "mnu_center_improve"),]),      
								
	   ("center_build_baths",[(eq, reg6, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
                                      (party_slot_eq, "$g_encountered_party", slot_center_has_baths, 0),
                                      (party_slot_eq, "$g_encountered_party", slot_center_original_faction, "fac_kingdom_6"),
									  (eq,"$players_kingdom", "fac_player_supporters_faction"),
                                      (assign, ":number", 0),
                                      (try_for_range,":center_no",towns_begin,towns_end),
                                        (this_or_next|party_slot_eq, ":center_no", slot_center_has_baths, 1),
                                        (party_slot_eq, ":center_no", slot_center_current_improvement, slot_center_has_baths),
                                        (val_add,":number",1),
                                      (try_end),
                                      (lt,":number",2), # Only allow 2 to ever exist at once
                                       ],
       "Build House of Swords.",[(assign, "$g_improvement_type", slot_center_has_baths),
                                  (jump_to_menu, "mnu_center_improve"),]),    
...
# ne end build								  
 ...
 {reg5} denars and will take {reg6} days.",
    ...
    [(call_script, "script_get_improvement_details", "$g_improvement_type"),
     ...
     (str_store_string, s19, s51),
     (call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
     (assign, ":max_skill", reg0),
     # Sponsorship fix for 0.608b9:
     (try_begin),
         (eq, "$temp_3", 0), # Player's own construction, no changes
     (else_try),
         (store_faction_of_party, ":faction", "$current_town"),
         (party_slot_eq, ":faction", slot_faction_leader, "trp_player"),
         (party_slot_eq, ":faction", slot_faction_logistics_adviser, 1), # This is player's kingdom and he has hired logistics advisor
         (val_add, ":max_skill", 2),
         (val_div, ":max_skill", 2),
     (else_try),
         (val_add, ":max_skill", 1),
         (val_div, ":max_skill", 2),
     (try_end),
     # End sponsorship fix (also look below)
     (assign, ":max_skill_owner", reg1),
     (assign, reg2, ":max_skill"),
	 ...
	 (val_div, ":improvement_time", 3), # This is the time divisor - Jinnai
     (val_add, ":improvement_time", 3),   
	 
	 # NE building
	 # (val_div, ":improvement_time", 1000), # This is debug code COMMENT IT OUT BUILD TIME

     (val_min, ":improvement_time", 50), #This makes sure that everything is built in 50 days or less regardless of cost
     ...
     (try_begin),
         (eq, "$temp_3", 1),
         (val_div, reg5, 2), # Halve the cost for sponsored construction
     (try_end),
    ],
    [
      ("improve_cont",[(store_troop_gold, ":cur_gold", "trp_player"),
       ...
       "Go on.", [(troop_remove_gold, "trp_player", reg5),
	              # NE finances
				                    (store_mul,"$temp",reg5,-1),
                  (call_script, "script_adjust_finances", slot_finance_center_upgrades, "$temp"),
				  # Ne end finances
...
## Menu to build the university - Jinnai
  ("build_university",0,
    "A university is a unique upgrade. Only one can be built per kingdom, and it must be built in the capital. Be absolutely sure this\
 is the location you want yours before choosing to build here. A university will attract the most brilliant minds in Calradia who will\
 randomly make breakthroughs in scientific achievement.  Each of these will provide a unique bonus to your kingdom. Because these minds\
 must have time to gather at the university, the engineering skill has no effect on cost or length of construction.  Building one will cost you\
 {reg5} denars and will take {reg6} days.",
    "none",
    [(assign, ":improvement_cost", 40000),
     (assign, ":improvement_time", 20),
     (assign, reg5, ":improvement_cost"),
     (assign, reg6, ":improvement_time"),
    ],
    [
      ("improve_cont",[(store_troop_gold, ":cur_gold", "trp_player"),
       ...
       "Go on.", [(troop_remove_gold, "trp_player", reg5),
                  (store_mul,"$temp",reg5,-1),
                  (call_script, "script_adjust_finances", slot_finance_center_upgrades, "$temp"),
                  (party_set_slot, "$g_encountered_party", slot_center_current_improvement, slot_center_university_placeholder),
                  (faction_set_slot,"fac_player_supporters_faction", slot_faction_university, -1),
                  (store_current_hours, ":cur_hours"),
                  (store_mul, ":hours_takes", reg6, 24),
                  (val_add, ":hours_takes", ":cur_hours"),
                  (party_set_slot, "$g_encountered_party", slot_center_improvement_end_hour, ":hours_takes"),
...
################################################################################
# ARENA AND TOURNAMENT GAME MENUS
################################################################################
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
    ...
    [
		...
		# Ne finances
		(call_script, "script_adjust_finances", slot_finance_tournament, reg9),
		# NE end finances
        (str_clear, s8),
		...
		# NE finances
		(call_script, "script_adjust_finances", slot_finance_tournament, ":total_win"),
		# NE end finances
 ...
 You get up and try to look for any other survivors from your party.",
  ...
  (
    ...
    [
      ("continue",[],"Continue...",
       [
         # Taleworlds patch 1.153 stripped the below section since companions already had a high chance of being removed
         # I've opted to leave this code in for now
         (try_for_range, ":npc", companions_begin, companions_end),
           (main_party_has_troop, ":npc"),
           (store_random_in_range, ":rand", 0, 100),
           (lt, ":rand", 30),
 ...
 he proposes to free you in return for {reg5} denars of your hidden wealth. You decide to...",
    ...
    [
      ...
      [
		...
		# Ne finances
		(store_mul,"$temp","$player_ransom_amount",-1),
        (call_script, "script_adjust_finances", slot_finance_lost_in_combat, "$temp"),
		# Ne end finances
        (try_begin),
          (party_is_active, "$capturer_party"),
...
################################################################################
 ...
 He will surely be offended if you do not take the offer...",
  ...
  (
    "invite_player_to_faction_without_center_swa",mnf_scale_picture,
    "You receive an offer of vassalage!^^\
 {s8} of {s9} has sent a royal herald to bring you an invitation in her own hand.\
 You would be granted the honour of becoming a vassal {lord/lady} of {s9},\
 and in return {s8} asks you to swear an oath of homage to her and fight in her military campaigns,\
 although she offers you no lands or titles.\
 She will surely be offended if you do not take the offer...",
    "none",
    [
        (set_background_mesh, "mesh_pic_messenger"),
        (faction_get_slot, "$g_invite_faction_lord", "$g_invite_faction", slot_faction_leader),
 ...
 He will surely be offended if you do not take the offer...",
   ...
   (
    "invite_player_to_faction_swa",mnf_scale_picture,
    "You receive an offer of vassalage!^^\
 {s8} of {s9} has sent a royal herald to bring you an invitation in her own hand.\
 You would be granted the honour of becoming a vassal {lord/lady} of {s9},\
 and in return {s8} asks you to swear an oath of homage to her and fight in her military campaigns,\
...
################################################################################
# INSTANT NOTIFICATIONS GAME MENUS
################################################################################
  ...
  (
    ...
    [
      ("ransom_accept",[],"Accept the offer.",
	   ...
	   # Ne finances
	   (call_script, "script_adjust_finances", slot_finance_prisoners, reg12),
	   # Ne end finances
...
#		(str_store_faction_name, s9, "$players_kingdom"),
  ...
  (
    ...
    [
      ...
      (try_begin),
		...
		# NE dk
		(neq, "$g_notification_menu_var1", "fac_dark_knights"),
		# NE end dk
  ...
  # NE rebellion
## Lord rebellion notifications begin - Jinnai

  (
    "notification_lord_restart_freed",0,
    "Rebellion!^^{s1} has left the {s2}.^^{s1} has freed {s5} from {s3} and reformed the {s4}.",
    "none",
    [
      (str_store_troop_name, s1, "$g_notification_menu_var1"),
      (str_store_faction_name, s2, "$players_kingdom"),
      (str_store_party_name, s3, "$g_notification_menu_var2"),
      (store_troop_faction,":faction","$g_notification_menu_var1"),
      (str_store_faction_name, s4, ":faction"),
      (faction_get_slot,":monarch",":faction",slot_faction_leader),
      (str_store_troop_name, s5, ":monarch"),
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
      (position_set_y, pos0, 30),
      (position_set_z, pos0, 170),
      (set_game_menu_tableau_mesh, "tableau_faction_note_mesh_for_menu", ":faction", pos0),
      ],
    [
      ("continue",[],"Continue...",
       [(change_screen_return),
  ...
  (
    "notification_lord_restart",0,
    "Rebellion!^^{s1} has left the {s2}.^^{s1} has found {s3} and reseated {reg4?her:him} as the ruler of the {s4}.",
    "none",
    [
      (troop_get_type, reg4, "$g_notification_menu_var2"),
      (str_store_troop_name, s1, "$g_notification_menu_var1"),
      (str_store_faction_name, s2, "$players_kingdom"),
      (str_store_troop_name, s3, "$g_notification_menu_var2"),
      (store_troop_faction,":faction","$g_notification_menu_var1"),
      (str_store_faction_name, s4, ":faction"),
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
  ...
  (
    "notification_lord_rebellion",0,
    "Rebellion!^^{s1} has left the {s2} and {s5}.",
    "none",
    [
      (str_store_troop_name, s1, "$g_notification_menu_var1"),
      (str_store_faction_name, s2, "$players_kingdom"),
      ...
      (try_begin),
        (gt,"$g_notification_menu_var2",0),
        (troop_get_type, reg4, "$g_notification_menu_var2"),
        (str_store_troop_name, s4, "$g_notification_menu_var2"),
        (str_store_string,s5,"@followed {s4} in {reg4?her:his} rebellion by joining the {s3}"),
      (else_try),
        (str_store_string,s5,"@joined the {s3}"),
      (try_end),
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 55),
      (position_set_y, pos0, 20),
...
## Lord rebellion notifications end
...
#      (else_try),
 ...
 # ne crown
  ...
  ("notification_give_crown",0, #Jinnai
  
  # v585 Josef crown_non_armour
  # "In recognition of your leadership, the blacksmiths of {s4} have crafted you a new crown to wear into battle.",
	"In recognition of your leadership, the blacksmiths of {s4} have crafted you several new crowns - two to wear into battle, and one to wear around town.",
    "none",
    [
      (str_store_party_name, s4, "$g_notification_menu_var1"),
      (troop_add_items, "trp_player", "itm_crown_diadem", 1),
      (troop_add_items, "trp_player", "itm_crown_coif", 1),
      (troop_add_items, "trp_player", "itm_crown_helm", 1),
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
      (position_set_y, pos0, 30),
      (position_set_z, pos0, 170),
 ...
 # NE quests
   # v585 Josef gift
    ("notification_give_liege_gift",0, 
    "A messenger boy, riding hard, gallops up to you. He stops and wheels his horse,\
 which paws the ground impatiently. He hands you a package, and with that, he is gone.",
    "none",
    [
	  (set_background_mesh, "mesh_pic_messenger"),
      ],
  ...
  # v585 Josef nemesis
     ("notification_of_nemesis",0, 
    "A faint cloud of dust on the horizon gradually materialises into the shape of a messenger boy astride a courser.\
 He calls out as he approaches, '{Sir/Madam}, I bring an urgent message from the Spymaster at Praven.\
 It says, 'Greetings, {playername}. The news has reached me that\
 one of the lesser lords, in a bid to make a name for himself, has hired some mercenaries to track you down.\
 Be alert for danger'. With that, the messenger spurs his horse and is gone.",
    "none",
    [
	  (set_background_mesh, "mesh_pic_messenger"),
      ],
 ...
 # ne building
 # Scientific breakthrough notification - Jinnai
  ("notification_breakthrough",0,
    "Scientific Breakthrough^^Your university reports it has completed another advancement in science. They have discovered {s10}",
    "none",
    [
      ],
    [
...
## Monarch threatening the player with war - Jinnai
  ("threaten_war",0,
    "{s1} threatens war.^^{s3} of the {s1} sends word that {reg4?she:he} will declare war on your kingdom if you do not immediately hand over {s2} to {reg4?her:him}.\
 {s2} is currently owned by {s4}.",
    "none",
    [
       (set_fixed_point_multiplier, 100),
       (position_set_x, pos0, 65),
       ...
       (try_begin),
         ...
         (eq, "$g_notification_menu_var2", "$g_player_court"),
         (str_store_string,s4,"@{s4} and it is the capital of your kingdom"),
       (else_try),
         (str_store_troop_name,s4,":lord"),
       (try_end),
       (troop_get_type, reg4, ":king"),
    ],
    [
      ("give",[],"Agree to give up the town.",
       [
          (party_get_slot,":lord","$g_notification_menu_var2",slot_town_lord),
          (try_begin),
            (neq,":lord","trp_player"),
          ...
          (try_end),
          (party_set_slot, "$g_notification_menu_var2", slot_center_last_taken_by_troop, -1),
          (call_script, "script_give_center_to_faction", "$g_notification_menu_var2", "$g_notification_menu_var1"),
          (try_begin),
            (call_script, "script_order_best_besieger_party_to_guard_center", "$g_notification_menu_var2", "$g_notification_menu_var1"),
            (call_script, "script_cf_reinforce_party", "$g_notification_menu_var2"),
          (try_end),
          (change_screen_return),
        ]),
      ("dontgive",[],"Refuse to be intimidated.",
       [
          (call_script, "script_diplomacy_start_war_between_kingdoms", "$g_notification_menu_var1", "fac_player_supporters_faction", 1),
          (change_screen_return),
        ]),
    ],
  ),
...
# NE 600 Series DK Invasion Warning
  (
 ...
 Your contract has now expired. What will you do?",
    ...
    [
      ("renew_oath",[(faction_get_slot, ":faction_leader", "$players_kingdom", slot_faction_leader),
       ...
       [
		 ...
		 (assign, "$mercenary_now", 1), 
         (change_screen_return),
         ]),
      ("dont_renew_oath",[],"Become free of your bond.",
       [
         (call_script, "script_player_leave_faction", 1), #1 means give back fiefs
		 (assign, "$mercenary_now", 0), 
         (change_screen_return),
         ]),
    ]
  ),
  ...
  (
    ...
    [(party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
     ...
     (store_troop_gold, ":gold", "trp_player"),
	 (try_begin), #Recruit nobles from towns now too - Jinnai
       (party_slot_eq, "$current_town", slot_party_type, spt_town),
     ...
     (else_try),
       (assign,":cost", 10),
     (try_end),
     (store_div, ":gold_capacity", ":gold", ":cost"),#10 denars per man
     ...
     (else_try),
	    # ne noble
	   (store_mul, reg6, ":volunteer_amount", ":cost"),
     ...
     # NE 600 Series - Do not allow recruiting from villages not in your faction when in brutality mode
     (try_begin),
       (eq, "$setting_brutality_mode", 1),
       (party_slot_eq, "$current_town", slot_party_type, spt_village),
       (neg|eq, "$players_kingdom", ":town_faction"),
       (str_store_string, s18, "@Terrified of retribution at the hands of their master, the peasants here refuse to follow you."),
       (assign, reg7, 3),
     (try_end),
     # Nobles refusing to follow a nobody
     (try_begin),
       (party_slot_eq, "$current_town", slot_party_type, spt_town),
       (neg|troop_slot_ge, "trp_player", slot_troop_renown, 250),
       (str_store_string, s18, "@Unwilling to fight for someone they do not know, no one volunteers to join you."),
       (assign, reg7, 3),
     (try_end),
     # Restrict recruitment by foreigners
     (try_begin),
       (party_slot_eq, "$current_town", slot_party_type, spt_town),
       (eq,"$setting_require_faction_noble_recruit",1),
       (store_faction_of_party, ":town_faction", "$current_town"),
       (neg|eq, "$players_kingdom", ":town_faction"),
       (str_store_string, s18, "@The soldiers here see the royal banner you carry, and decline entering service with someone who doesn't serve the same lord they do."),
       (assign, reg7, 3),
     (try_end),
     ...
     (else_try),
       (party_get_slot, ":troop_faction", "$current_town", slot_center_original_faction),
       (val_sub, ":troop_faction", "fac_kingdom_1"),
       (val_add, ":troop_faction", "mesh_pic_arms_swadian"),
       (set_background_mesh, ":troop_faction"),
     (try_end),
    ...
    [
      ...
      [
        ...
        # Deduct renown based on the number of soldiers hired, 5 renown currently
        (try_begin),
          (party_slot_eq, "$current_town", slot_party_type, spt_town), # Only proceed if in town, i.e. recruiting nobles
          (eq, "$setting_use_new_noble_recruit_system", 1),
          (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
          (store_mul, ":renown_decrease", reg5, 5),
          (val_sub, ":player_renown", ":renown_decrease"),
          (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
          (store_mul, reg5, reg5, 5),
          (display_message, "@You lose {reg5} renown."),
        (try_end),
...
# NE enhanced noble recruiting
# This is a copy/paste from the original NE recruiting that allowed you
# to recruit nobles from towns, but modified for renown. This is done such
# that it is trivial to enable/disable this feature and also trivial to
# later port it to an external module file or rewrite it.


# END NE 600 series 

# BEGIN NE 600 series elite recruit menu
# this menu is invoked if the player has opted (default on) recruitment system
# for elites that checks renown/costs renown

  ("recruit_special_new_system",0,
    "{s18}^^There are currently^{reg5} {s1}^{reg6} {s2}^available to recruit at the moment.",
    "none",
    [(party_get_slot,":kingdom","$current_town",slot_center_original_faction),
     (faction_get_slot,":troop1",":kingdom",slot_faction_special_troop_1),
     (faction_get_slot,":troop2",":kingdom",slot_faction_special_troop_2),
     #     (faction_get_slot,":troop3",":kingdom",slot_faction_special_troop_3),
     (try_begin),
       (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
       (lt, ":player_renown", 750),
       (jump_to_menu, "mnu_recruit_special_rejection"),
     (else_try),
       (faction_slot_eq,":kingdom",slot_faction_special_building_a,"$current_town"),
       (faction_get_slot,":num1",":kingdom",slot_faction_special_troop_num_1a),
       (faction_get_slot,":num2",":kingdom",slot_faction_special_troop_num_2a),
#       (faction_get_slot,":num3",":kingdom",slot_faction_special_troop_num_3a),
     (else_try),
       (faction_slot_eq,":kingdom",slot_faction_special_building_b,"$current_town"),
       (faction_get_slot,":num1",":kingdom",slot_faction_special_troop_num_1b),
       (faction_get_slot,":num2",":kingdom",slot_faction_special_troop_num_2b),
#       (faction_get_slot,":num3",":kingdom",slot_faction_special_troop_num_3b),
     (else_try),
       (display_message,"@ERROR WITH SPECIAL BUILDING LOCATION!"),
       (jump_to_menu, "mnu_town"),
     (try_end),
     (try_begin),
       (eq,":kingdom","fac_kingdom_1"),
       (str_store_string,s18,"@Cathedral"),
     (else_try),
       (eq,":kingdom","fac_kingdom_2"),
       (str_store_string,s18,"@Ivory Temple"),
     (else_try),
       (eq,":kingdom","fac_kingdom_3"),
       (str_store_string,s18,"@Palace"),
     (else_try),
       (eq,":kingdom","fac_kingdom_4"),
       (str_store_string,s18,"@Halls of Glory"),
     (else_try),
	   (eq,":kingdom","fac_kingdom_5"),
       (str_store_string,s18,"@Council Chambers"),
	 (else_try),
       (str_store_string,s18,"@House of Swords"),
     (try_end),
	 
     (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
     (val_min, ":num1", ":free_capacity"),
     (val_min, ":num2", ":free_capacity"),
#     (val_min, ":num3", ":free_capacity"),
     (store_troop_gold, ":gold", "trp_player"),
     (assign,":cost",500),
     (store_div, ":gold_capacity", ":gold", ":cost"),
     (val_min, ":num1", ":gold_capacity"),
     (val_min, ":num2", ":gold_capacity"),
#     (val_min, ":num3", ":gold_capacity"),
     (assign, reg5, ":num1"),
     (assign, reg6, ":num2"),
#     (assign, reg7, ":num3"),
     (str_store_troop_name_by_count, s1, ":troop1", ":num1"),
     (str_store_troop_name_by_count, s2, ":troop2", ":num2"),
#     (str_store_troop_name_by_count, s3, ":troop3", ":num3"),
     (store_mul, reg8, ":num1", ":cost"),
     (store_mul, reg9, ":num2", ":cost"),
#     (store_mul, reg10, ":num3", ":cost"),
     (set_background_mesh, "mesh_pic_arms_swadian"),
    ],
    [
      ("recruit_1",[(gt, reg5, 0)],
       "Recruit the {s1} ({reg8} denars).",[
                      (troop_remove_gold, "trp_player", reg8),
                      (val_mul,reg8,-1),
                      (call_script, "script_adjust_finances", slot_finance_wages, reg8),
                      (party_get_slot,":kingdom","$current_town",slot_center_original_faction),
                      (faction_get_slot,":troop",":kingdom",slot_faction_special_troop_1),
                      (party_add_members, "p_main_party", ":troop", reg5),
                      (try_begin),
                        (faction_slot_eq,":kingdom",slot_faction_special_building_a,"$current_town"),
                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_1a,0),
                      (else_try),
                        (faction_slot_eq,":kingdom",slot_faction_special_building_b,"$current_town"),
                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_1b,0),
                      (try_end),
                      (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
                      (store_mul, ":renown_decrease", reg5, 10),
                      (val_sub, ":player_renown", ":renown_decrease"),
                      (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
                      (store_mul, reg5, reg5, 10),
                      (display_message, "@You lose {reg5} renown for hiring Elite soldiers."),
                      (jump_to_menu,"mnu_town"),
                   ]),
      ("recruit_2",[(gt, reg6, 0)],
       "Recruit the {s2} ({reg9} denars).",[
                      (troop_remove_gold, "trp_player", reg9),
                      (val_mul,reg9,-1),
                      (call_script, "script_adjust_finances", slot_finance_wages, reg9),
                      (party_get_slot,":kingdom","$current_town",slot_center_original_faction),
                      (faction_get_slot,":troop",":kingdom",slot_faction_special_troop_2),
                      (party_add_members, "p_main_party", ":troop", reg6),
                      (try_begin),
                        (faction_slot_eq,":kingdom",slot_faction_special_building_a,"$current_town"),
                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_2a,0),
                      (else_try),
                        (faction_slot_eq,":kingdom",slot_faction_special_building_b,"$current_town"),
                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_2b,0),
                      (try_end),
                      (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
                      (store_mul, ":renown_decrease", reg5, 10),
                      (val_sub, ":player_renown", ":renown_decrease"),
...
#      ("recruit_3",[(gt, reg7, 0)],
#       "Recruit the {s3} ({reg10} denars).",[
#                      (troop_remove_gold, "trp_player", reg10),
#                      (val_mul,reg10,-1),
#                      (call_script, "script_adjust_finances", slot_finance_wages, reg10),
#                      (party_get_slot,":kingdom","$current_town",slot_center_original_faction),
#                      (faction_get_slot,":troop",":kingdom",slot_faction_special_troop_3),
#                      (party_add_members, "p_main_party", ":troop", reg7),
#                      (try_begin),
#                        (faction_slot_eq,":kingdom",slot_faction_special_building_a,"$current_town"),
#                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_3a,0),
#                      (else_try),
#                        (faction_slot_eq,":kingdom",slot_faction_special_building_b,"$current_town"),
#                        (faction_set_slot,":kingdom",slot_faction_special_troop_num_3b,0),
#                      (try_end),
#                      (jump_to_menu,"mnu_town"),
#                   ]),
      ("forget_it",[],
  ...
  (
    "recruit_special_rejection",0,
    "Unwilling to fight for someone with so few accomplishments, your calls for volunteers go unheeded.",
    "none",
    [
     (set_background_mesh, "mesh_pic_arms_swadian"),
    ],
    [
      ("continue_player_is_a_nobody",
      [
      ],
      "I'll return when I've made my mark on the world...",
      [
        (jump_to_menu,"mnu_town"),
      ]),
    ],
...
## Recruiting special troops - Jinnai
  ("recruit_special",0,
    "{s18}^^There are currently^{reg5} {s1}^{reg6} {s2}^available to recruit at the moment.",
    "none",
    [(party_get_slot,":kingdom","$current_town",slot_center_original_faction),
...
#                   ]),
  ...
  ##Conscription
  (
    "conscript_volunteers",0,
    "{s18}",
    "none",
    [(party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
     (party_get_slot, ":volunteer_amount", "$current_town", slot_center_volunteer_troop_amount),
     (val_max,":volunteer_amount",10),
     (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
     (val_min, ":volunteer_amount", ":free_capacity"),
     (store_troop_gold, ":gold", "trp_player"),
     (store_div, ":gold_capacity", ":gold", 2),#2 denars per conscript
     (val_min, ":volunteer_amount", ":gold_capacity"),
     (assign, reg5, ":volunteer_amount"),
     (try_begin),
       (eq, ":volunteer_amount", 0),
       (str_store_string, s18, "@No one here is fit for combat duty and eligible for conscription."),
     (else_try),
       (store_mul, reg6, ":volunteer_amount", 2),#2 denars per man
       (str_store_troop_name_by_count, s3, ":volunteer_troop", ":volunteer_amount"),
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@One {s3} is fit for conscription."),
       (else_try),
         (str_store_string, s18, "@{reg5} {s3} are fit for conscription."),
       (try_end),
       (set_background_mesh, "mesh_pic_recruits"),
     (try_end),
    ],
    [
      ...
      ("recruit_them",[(gt, reg5, 0)],
       "Conscript them. ({reg6} denars).",[(call_script, "script_conscript_troops_in_village"),
                        (jump_to_menu,"mnu_village"),
                        ]),
      ("forget_it",[(gt, reg5, 0)],
      "Forget it.",[(jump_to_menu,"mnu_village")]),
...
##end conscription  
 ...
 # The next two menus are wedding party suppression attempt results - v585 Josef
  (
    "village_wedding_result",mnf_scale_picture,
    "{s9}",
    "none",
    [(try_begin),
       (eq, "$g_battle_result", 1),
     ...
     (else_try),
       (str_store_string, s9, "@Try as you might, you could not defeat the wedding party. They go back to their feast, laughing and joking, and leave you to lick your wounds."),
       (set_background_mesh, "mesh_pic_defeat"),
     (try_end),
    ],
    [
  ...
  (
    "village_wedding_suppressed",mnf_disable_all_keys,
    "You trample the wedding guests underfoot and establish a semblance of order. As you pick through the corpses, you find the bridegroom has been slain but there is no sign of the bride. You will have to search the village.",
    "none",
    [
     (party_set_slot, "$g_encountered_party", slot_village_infested_by_wedding, 0),
     (party_set_slot, "$g_encountered_party", slot_militia_quest_completed, 0),
	 (call_script, "script_change_player_relation_with_center", "$g_encountered_party", -5),
...
#      (call_script, "script_loot_player_items", 0),
 ...
 Or perhaps, it was given to them by someone who wanted to arrange a suitable ending to your life.",
    ...
    [
	  ...
	  # NE finances
	  (call_script, "script_adjust_finances", slot_finance_from_battles, ":gold_reward"),
	  # Ne end finances
    ],
    [
      ("continue",[],"Continue...",[(change_screen_return)]),
  ...
  # Ne assassin
 # v586 Josef Assassin result screens 

  (
    "town_assassins_failed",mnf_disable_all_keys,
    "{s4} {s5} {s6}",
    "none",
    [
  
# renown penalty - 10% renown permanently removed                
      (troop_get_slot, ":renown", "trp_player", slot_troop_renown),
	  (val_div, ":renown", 100),
	  (val_mul, ":renown", 90),
...
# morale - down by 40%
      ...
      (party_get_num_companions, ":num_companions", "p_main_party"),
      # (str_store_string, s4, "@The assasins work their deadly trade and you are quickly cut down. ."),
      (str_store_string, s4, "@As you fall to the ground, you can already feel the numbing effect of what must surely be poison working\
 its way into your veins. They have left you alive, but for how long?^"),
      (try_begin),
        (gt, ":num_companions", 3),
        (str_store_string, s5, "@Luckily your men come to search for you when you do not return, and find you lying paralysed where you fell. They hurry you to safety and dress your wounds.\
 However, the insidious effect of the poisoned blade leaves you as weak as a mewling kitten, and you are forced to rest to regain your strength.^^"),
      (else_try),
        (str_store_string, s5, "@Luckily the changing of the guard means that your insensate body is discovered after a short while. The Guardsmen drag you away and dress your wounds.\
 However, the insidious effect of the poisoned blade leaves you childlike and sickly, and you must spend some days in bed to regain your strength.^^"),
      (try_end),
       (str_store_string, s6, "@In your few moments of lucidity over the next few days, you wonder how your men will react to this bout of sickness;\
 surely morale will be affected. And worse, the myth of your invincibility has now been exposed, and your renown will suffer. But most of all, you wonder,\
 'Who? Who could have ordered such an attack?'"),	  
  ...
  (
    "town_assassins_succeeded",mnf_disable_all_keys,
					   
    "Assassins! You stand over the blood spattered corpse of an assailant, your breath ragged and hoarse.\
 As you begin to recover from the attack you rifle through his pockets. About to give\
 up, you feel something in the lining of his cloak - a concealed document.^^\
 Cutting the lining, you discover a sealed packet of parchment, which contains notes\
 on your security, maps of your holdings, and instructions from {s4} of {s5} to end your life\
 in 'the most painfulle waye posyble'. The documents are wrapped around a coin purse that contains gems and\
 heavy weighted precious coins, the first part of your would-be assassin's payment.",
    "none",
    [
	  ...
	  (try_begin), 
        (lt, ":player_relation", -1),
		   (try_begin), 
		   (lt,  ":player_relation", ":score_to_beat" ),
		   (assign, ":score_to_beat", ":player_relation"),
		   (try_end),
		   (try_begin),
		   (le, ":player_relation", ":score_to_beat"),
           (str_store_troop_name, s4, ":troop_no"),
		   (store_troop_faction, ":enemy_faction", ":troop_no"),
           (str_store_faction_name,s5,":enemy_faction"),	
           (try_end),		   
	   (try_end), 
	  (try_end), 
...
# give the player some gems etc? 	  
	 (store_free_inventory_capacity, ":free_inventory"),
	 (try_begin),
     (ge, ":free_inventory", 1),
	 (troop_add_item, "trp_player","itm_goods_gems",0),
	 (try_end),
...
# v586 Josef Assassin result screens end 
  # NE end assassin
...
# They must learn field discipline and the steadiness to follow orders in combat before they can be thought to use arms.",
 ...
 You think {reg0} of them {reg1?have:has} fully grasped the training and {reg1?are:is} ready for some practice.",
    ...
    [
      ...
      (quest_get_slot, ":negative_effects", "qst_train_peasants_against_bandits", slot_quest_convince_value),
      (try_begin),
        (quest_get_slot, ":target_center", "qst_train_peasants_against_bandits", slot_quest_target_center),
        (lt, ":negative_effects", 0),
        (call_script, "script_change_center_prosperity", ":target_center", -1),
        (call_script, "script_change_player_relation_with_center", ":target_center", ":negative_effects"),
      (try_end),
     ],
    [
      ...
      ("continue", [], "Continue...",
       [
         (try_begin),
           ...
           (try_begin),
             (quest_slot_ge, "qst_train_peasants_against_bandits", slot_quest_convince_value, 0), # Training was not forced, i.e. it was because of a real bandit threat
           ...
           (else_try),
             ...
             (call_script, "script_ne_enable_militia_on_village", "$current_town"),
 ...
 terrified of the peasants and their new champion."),
	(call_script, "script_succeed_quest", "qst_train_peasants_against_bandits"),
        # NE 600 series - toggle the militia flag on
        (call_script, "script_ne_enable_militia_on_village", "$current_town"),
        # End NE 600 series militia flag toggle
...
#        (call_script, "script_change_player_relation_with_troop", ":faction_marshall", -3),
 ...
 This will surely be your best opportunity to attack him.",
  ...
  # v585 Josef bar brawl
    ...
    (
    "bar_brawl_begin",0,
    "You wait until a young boy comes running down the street.\
 '{Sir! Sir!/My Lady!}' he cries. 'The troublemakers have left the tavern and are coming this way. Be ready!'",
    "none",
    [
    ],
    [
	  ...
	  (else_try),
	   ...
	   #(set_jump_mission,"mt_back_alley_bar_brawl"),
        (party_get_slot, ":town_alley", "$qst_bar_brawl_center", slot_town_center),
        (modify_visitors_at_site,":town_alley"),
        (reset_visitors),
    ...
    [
      ...
      [      
        ...
        (try_begin),
          ...
          (gt, reg0, 0),          
          (troop_sort_inventory, "trp_temp_troop"),
          (assign, ":loot_interface_caller", "mnu_bandit_lair"),
          (try_begin),
            inject('loot_interface_check'),
            (change_screen_loot, "trp_temp_troop"),
          (try_end),
  ...
  ("establish_court",mnf_disable_all_keys,
    ...
    [
      ("establish",[
	  (player_has_item, "itm_goods_tools"),
	  (player_has_item, "itm_goods_velvet"),
	  ],"Establish {s4} as your court",
       [         
		(assign, "$g_player_court", "$current_town"),
	    (troop_remove_item, "trp_player", "itm_goods_tools"),
	    (troop_remove_item, "trp_player", "itm_goods_velvet"),
        (jump_to_menu, "mnu_walled_center_manage"),         
       ]),       
 ...
 # Ne assassination
    # v586 josef - assassin attack
  (
    "assassination_failed",0,
    "A messenger reins in beside your party.^^\
 '{Sir/Madam}, I bring grave news. Your attack on {s2} has failed.\
 The assassins attacked at dawn, as the lord made his way to the privy,\
 but the first quarrel missed high when he stooped to remove something from his shoe.\
 Alas, the element of surprise was lost, and he fought off the assassins. ^^Your Spymaster sends his condolences.",
    "none",
    [
      # (str_store_party_name, s1, "$g_notification_menu_var1"),
      (str_store_troop_name, s2, "$hero_requested_to_learn_assassinate"),
      (store_troop_faction, ":troop_faction", "$hero_requested_to_learn_assassinate"),
      (str_store_faction_name, s3, ":troop_faction"),
	  (set_background_mesh, "mesh_pic_messenger"),
      ],
    [
    ...
    (
    "assassination_fought_off",0,
    "A messenger reins in beside your party.^^\
 '{Sir/Madam}, I bring good news. Your attack on {s2} has failed.\
 The assassins attacked at dusk, but the guards were alert, and engaged\
 the killers. Many died, but the lord escaped. However {s2}'s personal retinue has been\
 reduced, and it will be some time before he can rebuild his forces.^^\
 Your Spymaster sends word that this might be an auspicious time to launch an attack.",
    "none",
    [
      # (str_store_party_name, s1, "$g_notification_menu_var1"),
	  (troop_get_slot, ":lord_party", "$hero_requested_to_learn_assassinate", slot_troop_leaded_party),
	  (call_script, "script_inflict_casualties_to_party", ":lord_party" ,1500),
      (str_store_troop_name, s2, "$hero_requested_to_learn_assassinate"),
      (store_troop_faction, ":troop_faction", "$hero_requested_to_learn_assassinate"),
      (str_store_faction_name, s3, ":troop_faction"),
	  (set_background_mesh, "mesh_pic_messenger"),
    ...
    [
      ...
      (
    "assassination_prosperity",0,
    "A messenger reins in beside your party.^^'{Sir/Madam}, I bring mixed news. Your attack on {s2} was successful.\
 However, the element of surprise was missing, and before they could administer the killing blow, the assassins were cut down.^^\
 That said, not all is lost. Seeing their lord struck down, his fiefs were shaken by their Lord's vulnerability,\
 and there was talk of war, though with whom, no one knew. The prosperity of all {s2}'s holdings is down by twenty points and this will\
 hit him in his pocketbook, though he lives still.^Your Spymaster sends his congratulations.",
    "none",
    [
      # (str_store_party_name, s1, "$g_notification_menu_var1"),
      (str_store_troop_name, s2, "$hero_requested_to_learn_assassinate"),
      ...
      (party_slot_eq, ":center_no", slot_town_lord, "$hero_requested_to_learn_assassinate"),
    ...
    [
      ...
      (
    "assassination_fiefed",0,
    "A messenger reins in beside your party.^^'{Sir/Madam}, I bring great news. Your attack on {s2} has succeeded.\
 Nay, he is not dead, more's the pity. But apparently his liege had already been unsatisfied with his vassalage, and this attack\
 has confirmed {s2}'s weakness. ^^{Sir/Madam}, {s1} has relieved {s2} of all his lands and titles, and has bestowed them\
 upon {s3}! ^^{s2} is humiliated and landless! Your Spymaster congratulates you on your cunning!",
    "none",
    [
      # (str_store_party_name, s1, "$g_notification_menu_var1"),
      ...
      (store_troop_faction, ":troop_faction", "$hero_requested_to_learn_assassinate"),
      #(str_store_faction_name, s3, ":troop_faction"),
	  (faction_get_slot, ":cur_king", ":troop_faction", slot_faction_leader),
	  (str_store_troop_name, s1, ":cur_king"),
	  (call_script, "script_cf_get_random_lord_except_king_with_faction", ":troop_faction"),
	  (assign, ":troop_no", reg0), 
	  (try_begin),
	  (neq, ":troop_no", 0), 
	  (try_for_range, ":center_no", centers_begin, centers_end),
      (party_slot_eq, ":center_no", slot_town_lord, "$hero_requested_to_learn_assassinate"),
	  (call_script, "script_give_center_to_lord", ":center_no", ":troop_no", 0),

	  (try_end),
	  (else_try), 
	  (try_for_range, ":center_no", centers_begin, centers_end),
      (party_slot_eq, ":center_no", slot_town_lord, "$hero_requested_to_learn_assassinate"),
	  (call_script, "script_give_center_to_lord", ":center_no", ":cur_king", 0),	
	  (str_store_string,s3,"@himself"),
	  # (str_store_troop_name, s3, ":cur_king"),
      (try_end),
	  (try_end),
	  (str_store_troop_name, s2, "$hero_requested_to_learn_assassinate"),
	  (str_store_troop_name, s1, ":cur_king"),
...
## Lord dueling begin - Jinnai

  ("duel_requested",0,
    "{s5}^^As the law of civilized warfare dictates, should {reg4?she:he} win {reg4?she:he} will be allowed to go free.^^Do you accept the challenge?",
    "none",
    [
        (try_begin),
          (eq,"$g_tournament_player_team_won",1),
          (jump_to_menu,"mnu_lord_duel_won"),
        (else_try),
          (eq,"$g_tournament_player_team_won",0),
          (jump_to_menu,"mnu_lord_duel_lost"),
        (try_end),
        ...
        (try_begin),
          (troop_slot_eq, "$temp", slot_troop_prisoner_of_party, "$current_town"),
          (str_store_string,s5,"@Your prison guards bring word that {s1} demands to duel you in fair and single combat."),
        (else_try),
          (str_store_string,s5,"@{s1} demands to duel you in fair and single combat."),
        (try_end),
    ],
    [
      ("yes",[],"Yes.",
       [(party_get_slot, ":arena_scene", "$current_town", slot_town_arena),
        (modify_visitors_at_site, ":arena_scene"),
        (reset_visitors),
        (mission_tpl_entry_clear_override_items, "mt_arena_lord_duel", 0),
        (mission_tpl_entry_clear_override_items, "mt_arena_lord_duel", 1),
        (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 0, "itm_hera_swadian_cav_shield_b"),
        (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 1, "itm_hera_swadian_cav_shield_b"),
        (store_attribute_level, ":pstr", "trp_player", ca_strength),
        (store_attribute_level, ":str", "$temp", ca_strength),
        (try_begin), #Just to be sure one isn't unarmed for some reason
          (ge,":pstr",12),
          (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 0, "itm_sword_medieval_d_long"),
        (else_try),
          (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 0, "itm_sword_norman"),
        (try_end),
        (try_begin),
          (ge,":str",12),
          (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 1, "itm_sword_medieval_d_long"),
        (else_try),
          (mission_tpl_entry_add_override_item, "mt_arena_lord_duel", 1, "itm_sword_norman"),
        (try_end),

        (set_visitor, 0, "trp_player"),
        (set_visitor, 1, "$temp"),
        (set_jump_mission, "mt_arena_lord_duel"),
        (jump_to_scene,":arena_scene"),
        (change_screen_mission),
        ]),
      ("no",[],"No.",
  ...
  ("lord_duel_won",0,
    ...
    [
      (troop_get_type, reg4, "$temp"),
      (str_store_troop_name,s1,"$temp"),
      (troop_get_slot, ":rep", "$temp", slot_lord_reputation_type),
      (try_begin),
        (this_or_next|eq,":rep",lrep_upstanding),
        (this_or_next|eq,":rep",lrep_goodnatured),
        (this_or_next|eq,":rep",lrep_none),
        (eq,":rep",lrep_martial),
        (str_store_string,s5,"@{s1} admits you have fairly beaten {reg4?her:him} and thanks you for abiding by the rules of civilized warfare."),
        (call_script, "script_change_player_honor", 3),
        (call_script, "script_change_player_relation_with_troop", "$temp", 5),
      (else_try),
        (eq,":rep",lrep_cunning),
        (str_store_string,s5,"@{s1} admits you have fairly beaten {reg4?her:him} and thanks you for abiding by the rules of civilized warfare.\
 As {reg4?she:he} is led away, {reg4?she:he} compliments you on your form with your weapon and asks if you would teach {reg4?her:him} a few moves in the future."),
        (call_script, "script_change_player_honor", 3),
        (call_script, "script_change_player_relation_with_troop", "$temp", 1),
      (else_try),
#        (this_or_next|eq,":rep",lrep_quarrelsome),
#        (this_or_next|eq,":rep",lrep_selfrighteous),
#        (eq,":rep",lrep_debauched),
        (str_store_string,s5,"@{s1} claims you cheated! There is no way someone as weak as you could have beaten {reg4?her:him} fairly."),
        (call_script, "script_change_player_honor", 3),
        (call_script, "script_change_player_relation_with_troop", "$temp", -5),
      (try_end),
  ...
  ("lord_duel_lost",0,
    ...
    [
      ...
      (try_begin),
        ...
        (this_or_next|eq,":rep",lrep_none),
        (eq,":rep",lrep_martial),
        (str_store_string,s5,"@{s1} salutes you and thanks you for keeping your word and granting {reg4?her:him} freedom."),
        (call_script, "script_change_player_honor", 1),
        (call_script, "script_change_player_relation_with_troop", "$temp", 2),
      (else_try),
        (eq,":rep",lrep_cunning),
        (str_store_string,s5,"@As {s1} climbs on {reg4?her:his}, {reg4?she:he} thanks you for keeping your word and granting {reg4?her:him} freedom."),
        (call_script, "script_change_player_honor", 1),
      (else_try),
#        (this_or_next|eq,":rep",lrep_quarrelsome),
#        (this_or_next|eq,":rep",lrep_selfrighteous),
#        (eq,":rep",lrep_debauched),
        (str_store_string,s5,"@{s1} laughs as {reg4?she:he} rides away, a free {reg4?woman:man}.  As {reg4?she:he} rides into the streets, you overhear\
 {reg4?her:him} loudly proclaiming to anyone who will listen how easily {reg4?she:he} bested you in single combat."),
        (call_script, "script_change_player_honor", 1),
        (call_script, "script_change_troop_renown", "trp_player", -20),
      (try_end),
      (troop_get_slot, ":remove_from", "$temp", slot_troop_prisoner_of_party),
      (party_remove_prisoners, ":remove_from", "$temp", 1),
      (call_script, "script_remove_troop_from_prison", "$temp"),
      (str_store_troop_name_link, s1, "$temp"),
...
# NE quests 
  ...
  # v585 Josef fight king = Lose duel
    ("king_duel_lost",0,
    "Defeat.^^{s5}",
    "none",
    [
      ...
      (str_store_string,s5,"@{s1} sympathises with your humiliating defeat, and tells you to pick your fights more carefully in future."),
	  (display_log_message, "@{s1} has beaten you in single combat."),
		(call_script, "script_change_player_honor", 1),
        (call_script, "script_change_troop_renown", "trp_player", -20),   
      ],
    [
    ...
    # v585 Josef fight king = win duel 
    ("king_duel_won",0,
    "Victory!^^{s5}",
    "none",
    [
      ...
      (str_store_troop_name,s1,"$g_talk_troop"),
      (str_store_string,s5,"@{s1} congratulates you on your unexpected victory."),
	  
	  (display_log_message, "@You have beaten {s1} in single combat."),
...
## Lord dueling end
    ...
    ("walled_center_manage", 0, "{s19}^{reg6?^^You are currently building {s7}. The building will be completed after {reg8} day{reg9?s:}.:}", "none", [
        ...
        (try_for_range, ":improvement_no", walled_center_improvements_begin, walled_center_improvements_and_specials_end),
            (party_slot_ge, "$g_encountered_party", ":improvement_no", 1),
            (val_add,  ":num_improvements", 1),
            (call_script, "script_get_improvement_details", ":improvement_no"),
            (try_begin),
		...
		("recruit_nobles", [
		    # Basic requirements
            (party_slot_eq, "$current_town", slot_party_type, spt_town), # Restrict to towns
            (troop_slot_ge, "trp_player", slot_troop_renown, 250),
            (party_slot_ge, "$current_town", slot_center_volunteer_troop_amount, 0),
            (party_slot_ge, "$current_town", slot_center_volunteer_troop_type, 1),
            (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
            (ge, ":free_capacity", 1),
            # Relation/persuasion requirements
            # Same faction, king    : relation 0 - persuasion*3
            # Same faction, marshall: relation 0 - persuasion*2
            # Same faction, lord    : relation 0 - persuasion*1
            (store_faction_of_party, ":faction", "$current_town"),
            (store_skill_level, ":relation_req", "skl_persuasion", "trp_player"),
            (try_begin),
                (faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),
                (val_mul, ":relation_req", -3),
            (else_try),
                (faction_slot_eq, ":faction", slot_faction_marshall, "trp_player"),
                (val_mul, ":relation_req", -2),
            (else_try),
                (val_mul, ":relation_req", -1),
            (try_end),
            (party_slot_ge, "$current_town", slot_center_player_relation, ":relation_req"),
        ], "Recruit nobles.", [
            (assign, "$quest_auto_menu", "mnu_walled_center_manage"), # Auto-return here instead of town
            (jump_to_menu, "mnu_recruit_volunteers"),
        ]),
        ...
        ("recruit_elites", [
            (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
            (party_slot_eq, "$current_town", slot_party_type, spt_town),
            (troop_slot_ge, "trp_player", slot_troop_renown, 1000),
            (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
            (ge, ":free_capacity", 1),
            (assign, ":elite_building", 0),
            (try_for_range, ":slot", slot_center_has_cathedral, slot_center_has_baths + 1),
                (party_slot_eq, "$current_town", ":slot", 1),
                (assign, ":elite_building", ":slot"),
            (try_end),
            (neq, ":elite_building", 0),
            (val_sub, ":elite_building", village_improvements_begin),
            (val_add, ":elite_building", "str_improvement_manor"),
            (str_store_string, s1, ":elite_building"),
            # Honour requirements
            (store_faction_of_party, ":faction", "$current_town"),
            (store_skill_level, ":honor_req", "skl_persuasion", "trp_player"),
            (try_begin),
                (faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),
                (val_mul, ":honor_req", -2),
                (val_add, ":honor_req", 10),
            (else_try),
                (faction_slot_eq, ":faction", slot_faction_marshall, "trp_player"),
                (val_mul, ":honor_req", -2),
                (val_add, ":honor_req", 20),
            (else_try),
                (val_mul, ":honor_req", -1),
                (val_add, ":honor_req", 20),
            (try_end),
            (ge, "$player_honor", ":honor_req"),
        ], "Visit the {s1}.", [
            (try_begin),
              (eq,"$setting_use_new_noble_recruit_system",1),
              (jump_to_menu, "mnu_recruit_special_new_system"),
        ...
        ("walled_center_abort", [
            (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
            (party_slot_ge, "$current_town", slot_center_current_improvement, 1),
            (party_get_slot, ":cur_improvement", "$g_encountered_party", slot_center_current_improvement),
            (call_script, "script_get_improvement_details", ":cur_improvement"),
        ], "Abort construction of {s50}.", [
            (jump_to_menu, "mnu_center_construction_abort"),
        ]),

        ("walled_center_manage", [
            (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
            (neg|party_slot_ge, "$current_town", slot_center_current_improvement, 1),
        ], "Start construction.", [
            (assign, "$temp_3", 0), # No sponsorship
            (jump_to_menu, "mnu_center_manage"),
        ]),

        ("walled_center_sponsor", [
            (neg|party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
            (neg|party_slot_ge, "$current_town", slot_center_current_improvement, 1),
            (store_faction_of_party, ":faction", "$current_town"),
            (this_or_next|faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),
            ...
            (assign, "$temp_3", 1), # Construction sponsored by player
            (jump_to_menu, "mnu_center_manage"),
        ]),

        ("castle_station_troops", [
            # 1. Player is center lord.
            # 2. Center does not belong to anyone but player is king.
            (assign, ":player_can_draw_from_garrison", 0),
            (try_begin),
                (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
                (assign, ":player_can_draw_from_garrison", 1),
            (else_try),
                (store_faction_of_party, ":faction", "$current_town"),
                (neg|party_slot_ge, "$current_town", slot_town_lord, 0),          # Castle is unowned
                (faction_slot_eq, ":faction", slot_faction_leader, "trp_player"), # Player is king
                (assign, ":player_can_draw_from_garrison", 1),
            (try_end),
            (eq, ":player_can_draw_from_garrison", 1),
        ], "Manage the garrison.", [
        ...
        ## Allow garrisoning of troops in towns of the player's kingdom that they don't personally own - Jinnai
        ("castle_give_troops", [
            # 1. King can give troops to his lords' garrisons but cannot give troops to unowned centers
            # 2. Marshall can give troops to both lords' garrisons and unowned centers
            (store_faction_of_party, ":faction", "$current_town"),
            (neg|party_slot_eq,"$current_town",slot_town_lord, "trp_player"),              # Center does not belong to player
            (assign, ":proceed", 0),
            (try_begin),
                (faction_slot_eq, ":faction", slot_faction_marshall, "trp_player"),   # Player is marshall
                (neg|faction_slot_eq, ":faction", slot_faction_leader, "trp_player"), # Player is not king
                (assign, ":proceed", 1),
            (else_try),
                (faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),     # Player is king
                (party_slot_ge, "$current_town", slot_town_lord, 0),                  # Center belongs to some lord
                (assign, ":proceed", 1),
            (try_end),
            (eq, ":proceed", 1),
        ...
        ("return", [], "Go back.", [(jump_to_menu, "mnu_town")]),

    ]),

    ("town_talk_locals", 0, "{s1} is a large town, and there are many people living here. Who do you want to talk to?", "none", [
        ...
        ("lady", [
            ...
            (try_for_range, ":lady_no", kingdom_ladies_begin, kingdom_ladies_end),
                ...
                (troop_slot_eq, ":lady_no", slot_troop_spouse, -1),
                (ge, ":lady_guardian", 0), #not sure when this would not be the case
                (this_or_next|troop_slot_ge, ":lady_no", slot_troop_met, 2), # must have spoken to either father or lady
                (troop_slot_eq, ":lady_guardian", slot_lord_granted_courtship_permission, 1),
                (neg|troop_slot_eq, ":lady_no", slot_troop_met, 4),
                (try_begin),
                    (eq, "$love_interest_in_town", 0),
        ...
        ("minister", [
            ...
            (faction_slot_eq, "$g_encountered_party_faction", slot_faction_leader, "trp_player"),
        ], "Discuss matters of state with your minister", [
            (try_begin),
                (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try), 
                (call_script, "script_cf_enter_center_location_assassin_check", 1),	
            (else_try),
                (assign, ":spawned_troop", "$g_player_minister"),
                (party_get_slot, ":town_scene", "$current_town", slot_town_castle),
                (modify_visitors_at_site, ":town_scene"),
                (reset_visitors),
                (set_visitor, 0, "trp_player"),
                (set_visitor, 16, ":spawned_troop"),
                (set_jump_mission,"mt_visit_town_castle"),
                (mission_tpl_entry_set_override_flags, "mt_visit_town_castle", 0, af_override_head|af_override_horse),
        ...
        ("mercenary", [
            ...
            (party_get_slot, ":merc", "$current_town", slot_center_mercenary_troop_type),
            (str_store_troop_name, s1, ":merc"),
        ], "Talk with {s1}.", [
            (try_begin),
                (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try), 
                (call_script, "script_cf_enter_center_location_assassin_check", 1),	
            (else_try),
                (party_get_slot, ":spawned_troop", "$current_town", slot_center_mercenary_troop_type),
                (party_get_slot, ":town_scene", "$current_town", slot_town_tavern),
                (modify_visitors_at_site, ":town_scene"),
                (reset_visitors),
                (set_visitor, 0, "trp_player"),
                (set_visitor, 17, ":spawned_troop"),
                (set_jump_mission,"mt_town_default"),
                (mission_tpl_entry_set_override_flags, "mt_town_default", 0, af_override_head|af_override_horse),
        ...
        ("book_seller", [
            (this_or_next|eq, "$entry_to_town_forbidden", 0),
            (eq, "$sneaked_into_town", 1),
            (party_slot_ge, "$current_town", slot_center_tavern_bookseller, 1),
        ], "Speak with visiting Book Merchant.", [
            (try_begin),
                (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try), 
                (call_script, "script_cf_enter_center_location_assassin_check", 1),	
            (else_try),
                (party_get_slot, ":spawned_troop", "$current_town", slot_center_tavern_bookseller),
                (party_get_slot, ":town_scene", "$current_town", slot_town_tavern),
                (modify_visitors_at_site, ":town_scene"),
                (reset_visitors),
                (set_visitor, 0, "trp_player"),
        ...
        ("ransom_broker", [
            ...
            (try_end),
            (gt, ":ransom_broker", 0),
            (assign, reg60, ":ransom_broker"),
        ], "Speak with Ransom Broker.", [
            (assign, ":ransom_broker", reg60),
            (try_begin),
                (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try), 
                (call_script, "script_cf_enter_center_location_assassin_check", 1),	
            (else_try),
                ...
                (reset_visitors),
                (set_visitor, 0, "trp_player"),
                (set_visitor, 17, ":ransom_broker"),
                (set_jump_mission,"mt_town_default"),
                (mission_tpl_entry_set_override_flags, "mt_town_default", 0, af_override_head|af_override_horse),
                (mission_tpl_entry_clear_override_items, "mt_town_default", 0),
                (jump_to_scene, ":town_scene"),
                (assign, "$talk_context", tc_tavern_talk),
                (change_screen_map_conversation, ":ransom_broker"),
            (try_end),
        ]),
        ...
        ("tavern_keeper", [
            ...
            (else_try), 
                (call_script, "script_cf_enter_center_location_assassin_check", 1),	
            (else_try),
                (party_get_slot, ":spawned_troop", "$current_town", slot_town_tavernkeeper),
                (party_get_slot, ":town_scene", "$current_town", slot_town_tavern),
                (modify_visitors_at_site, ":town_scene"),
                (reset_visitors),
                (set_visitor,0,"trp_player"),
        ...
        ("guild_master", [], "Speak with the Guild Master.", [
            (try_begin),
                (call_script, "script_cf_enter_center_location_bandit_check"),
            (else_try), 
                # added Josef 586 assassin attack check
            ...
            (else_try),
                ...
                (set_visitor,11,":spawned_troop"),
                (set_jump_mission,"mt_town_center"),
                (mission_tpl_entry_set_override_flags, "mt_town_center", 0, af_override_head|af_override_horse),
    ...
    ("center_construction_abort", 0, "You can abort the construction of {s50} in {s2}, but it won't get you back any resources you spent on it before.^^Do you really wish to abort the construction?", "none", [
        (party_get_slot, ":cur_improvement", "$g_encountered_party", slot_center_current_improvement),
        (call_script, "script_get_improvement_details", ":cur_improvement"),
		(call_script, "script_set_town_picture"),
        (str_store_party_name, s2, "$current_town"),
        ...
        ("confirm", [], "Yes, I do.", [
            ...
            (display_message, "@Construction of {s50} in {s2} was aborted."),
            (jump_to_menu, "mnu_walled_center_manage"),
        ]),
        ("cancel", [], "No, let it continue.", [
            (jump_to_menu, "mnu_walled_center_manage"),
        ]),
    ]),

################################################################################
# NE KINGDOM MANAGEMENT GAME MENUS - FOR REMOVAL OR REFACTORING
################################################################################

# NE Kingdom 
## Kingdom management part 2 begin - Jinnai

  ( "manage_kingdom",0,
    "Which aspect of your kingdom would you like to modify?",
    "none",
    [],
    [
      ("set_capital",[(neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_capital, "$g_encountered_party"),],
       "Set this town as your kingdom's capital.",
       [
           (store_current_hours, ":cur_hours"),
           (faction_get_slot,":finish","fac_player_supporters_faction",slot_faction_capital_moved),
           (try_begin),
             (ge,":cur_hours",":finish"),
             (str_store_party_name, s1, "$g_encountered_party"),
             (str_store_faction_name, s2, "fac_player_supporters_faction"),
             (faction_set_slot,"fac_player_supporters_faction",slot_faction_capital,"$g_encountered_party"),
             (display_message, "@{s1} is now the capital of {s2}."),
             (val_add,":cur_hours",168),
             (faction_set_slot,"fac_player_supporters_faction",slot_faction_capital_moved,":cur_hours"),
           (else_try),
             (val_sub,":finish",":cur_hours"),
             (val_div,":finish",24),
             (assign,reg0,":finish"),
             (store_add,reg1,":finish",-1),
             (display_message, "@Your capital was moved too recently to move it again. You need {reg0} {reg1?days:day} to establish its current location."),
           (try_end),
           (jump_to_menu,"mnu_town"),
        ]),
      ("set_war",[],
       ...
       [
           (jump_to_menu,"mnu_declare_war"),
        ]),
      ("award_fief",[],
       "Award a fief to a lord.",
       [
           (assign,"$temp_2",0),
           (jump_to_menu,"mnu_award_fief"),
        ]),
      ("get_adviser",[(this_or_next|neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_civil_adviser, 1),
                      (this_or_next|neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_logistics_adviser, 1),
                      (this_or_next|neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_intel_adviser, 1),
                      (neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_financial_adviser, 1),],
       "Hire an adviser to assist in managing your kingdom.",
       [(jump_to_menu,"mnu_hire_adviser"),]),
      ("reset_name",[],
  ...
  ( "change_kingdom_name",0,
    "Which source do you want to take your kingdom name from?",
    "none",
    [],
    [
      # ("use_troops",[
          # (troop_get_upgrade_troop,":use_name","trp_player_kingdom_name",0),
          # (try_begin),
             # (eq, ":use_name", 1),
             # (str_store_troop_name, s3, "trp_player"),
             # (str_store_string, s1, "@Kingdom of {s3}"),
          # (else_try),
            # (str_store_troop_name, s1, "trp_player_kingdom_name"),
          # (try_end),
       # ],
       # "Troops.txt: {s1}",
       # [
          ...
          # (try_begin),
             # (eq, ":use_name", 1),
             # (str_store_troop_name, s1, "trp_player"),
             # (faction_set_name, "fac_player_supporters_faction", "@Kingdom of {s1}"),
             # (display_message, "@{s2} has changed its name to Kingdom of {s1}."),
          # (else_try),
             # (faction_set_name, "fac_player_supporters_faction", "@{s1}"),
             # (display_message, "@{s2} has changed its name to {s1}."),
          # (try_end),
          # (call_script, "script_update_all_notes"),
          # (jump_to_menu,"mnu_town"),
        # ]),
      ("use_player",[(str_store_troop_name, s2, "trp_player"),],
       "Player's current name: {s2}",
       [
          (str_store_faction_name, s2, "fac_player_supporters_faction"),
          (str_store_troop_name, s1, "trp_player"),
          (faction_set_name, "fac_player_supporters_faction", "@{s1}"),
      ...
      ("return",[],
       "Never mind.",
       [(jump_to_menu,"mnu_manage_kingdom")]),
    ]),

  ( "declare_war",0,
    "Which kingdom do you want to declare war on?",
    "none",
    [(str_store_faction_name,s1,"fac_kingdom_1"),
     (str_store_faction_name,s2,"fac_kingdom_2"),
     (str_store_faction_name,s3,"fac_kingdom_3"),
     (str_store_faction_name,s4,"fac_kingdom_4"),
     (str_store_faction_name,s5,"fac_kingdom_5"),
	 (str_store_faction_name,s6,"fac_kingdom_6"),
     ],
    [
      ("kingdom_1",[(faction_slot_eq,"fac_kingdom_1", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_1"),
           (gt,":relation",-40),
        ],
       "{s1}",
       [
           (assign,"$temp","fac_kingdom_1"),
           (jump_to_menu,"mnu_declare_war_do"),
        ]),
      ("kingdom_2",[(faction_slot_eq,"fac_kingdom_2", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_2"),
           (gt,":relation",-40),
        ],
       "{s2}",
       [
      ...
      ("kingdom_3",[(faction_slot_eq,"fac_kingdom_3", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_3"),
           (gt,":relation",-40),
        ],
       "{s3}",
       [
      ...
      ("kingdom_4",[(faction_slot_eq,"fac_kingdom_4", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_4"),
           (gt,":relation",-40),
        ],
       "{s4}",
       [
      ...
      ("kingdom_5",[(faction_slot_eq,"fac_kingdom_5", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_5"),
           (gt,":relation",-40),
        ],
       "{s5}",
       [
	 ...
	 ("kingdom_6",[(faction_slot_eq,"fac_kingdom_6", slot_faction_state, sfs_active),
           (store_relation, ":relation", "fac_player_supporters_faction", "fac_kingdom_6"),
           (gt,":relation",-40),
        ],
       "{s6}",
       [
           (assign,"$temp","fac_kingdom_6"),
           (jump_to_menu,"mnu_declare_war_do"),
        ]),
  ...
  (
    "declare_war_do",0,
    "Declaration of War^^You have declared war against {s1}!",
    "none",
    [
      (store_relation, ":relation", "fac_player_supporters_faction", "$temp"),
      (val_min, ":relation", -10),
      (val_add, ":relation", -30),
      (set_relation, "fac_player_supporters_faction", "$temp", ":relation"),
      (store_relation, ":relation", "fac_player_supporters_faction", "$temp"),
      (val_min, ":relation", -30),
      (call_script, "script_set_player_relation_with_faction", "$temp", ":relation"),
      (str_store_faction_name_link, s2, "fac_player_supporters_faction"),
      (str_store_faction_name_link, s3, "$temp"),
      (display_log_message, "@{s2} has declared war against {s3}."),
      (call_script, "script_update_faction_notes", "fac_player_supporters_faction"),
      (call_script, "script_update_faction_notes", "$temp"),
      (assign, "$g_recalculate_ais", 1),
      (str_store_faction_name,s1,"$temp"),
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
      (position_set_y, pos0, 30),
      (position_set_z, pos0, 170),
      (store_sub, ":faction_1", "fac_player_supporters_faction", kingdoms_begin),
      (store_sub, ":faction_2", "$temp", kingdoms_begin),
      (val_mul, ":faction_1", 128),
      (val_add, ":faction_1", ":faction_2"),
      (set_game_menu_tableau_mesh, "tableau_2_factions_mesh", ":faction_1", pos0),
      ],
  ...
  ( "award_fief",0,
    ...
    [(try_begin),
          (eq,"$temp_2",10000),
          (str_store_string,s1,"@Who would you like to award this village to?"),
        (else_try),
          (str_store_string,s1,"@Who would you like to award a fief to?"),
        (try_end),
        (assign, "$num_castle_meeting_troops", 0),
    ...
    [
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 0),(troop_get_slot, ":troop_no", "trp_temp_array_a", 0),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 0),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 1),(troop_get_slot, ":troop_no", "trp_temp_array_a", 1),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 1),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 2),(troop_get_slot, ":troop_no", "trp_temp_array_a", 2),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 2),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 3),(troop_get_slot, ":troop_no", "trp_temp_array_a", 3),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 3),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 4),(troop_get_slot, ":troop_no", "trp_temp_array_a", 4),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 4),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 5),(troop_get_slot, ":troop_no", "trp_temp_array_a", 5),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 5),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 6),(troop_get_slot, ":troop_no", "trp_temp_array_a", 6),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 6),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 7),(troop_get_slot, ":troop_no", "trp_temp_array_a", 7),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 7),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 8),(troop_get_slot, ":troop_no", "trp_temp_array_a", 8),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 8),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 9),(troop_get_slot, ":troop_no", "trp_temp_array_a", 9),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 9),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 10),(troop_get_slot, ":troop_no", "trp_temp_array_a", 10),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 10),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 11),(troop_get_slot, ":troop_no", "trp_temp_array_a", 11),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 11),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 12),(troop_get_slot, ":troop_no", "trp_temp_array_a", 12),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 12),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 13),(troop_get_slot, ":troop_no", "trp_temp_array_a", 13),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 13),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 14),(troop_get_slot, ":troop_no", "trp_temp_array_a", 14),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 14),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 15),(troop_get_slot, ":troop_no", "trp_temp_array_a", 15),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 15),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 16),(troop_get_slot, ":troop_no", "trp_temp_array_a", 16),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 16),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 17),(troop_get_slot, ":troop_no", "trp_temp_array_a", 17),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 17),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 18),(troop_get_slot, ":troop_no", "trp_temp_array_a", 18),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 18),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 19),(troop_get_slot, ":troop_no", "trp_temp_array_a", 19),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 19),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 20),(troop_get_slot, ":troop_no", "trp_temp_array_a", 20),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 20),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 21),(troop_get_slot, ":troop_no", "trp_temp_array_a", 21),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 21),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 22),(troop_get_slot, ":troop_no", "trp_temp_array_a", 22),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 22),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 23),(troop_get_slot, ":troop_no", "trp_temp_array_a", 23),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 23),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 24),(troop_get_slot, ":troop_no", "trp_temp_array_a", 24),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 24),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 25),(troop_get_slot, ":troop_no", "trp_temp_array_a", 25),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 25),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 26),(troop_get_slot, ":troop_no", "trp_temp_array_a", 26),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 26),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 27),(troop_get_slot, ":troop_no", "trp_temp_array_a", 27),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 27),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 28),(troop_get_slot, ":troop_no", "trp_temp_array_a", 28),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 28),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 29),(troop_get_slot, ":troop_no", "trp_temp_array_a", 29),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 29),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 30),(troop_get_slot, ":troop_no", "trp_temp_array_a", 30),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 30),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 31),(troop_get_slot, ":troop_no", "trp_temp_array_a", 31),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 31),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 32),(troop_get_slot, ":troop_no", "trp_temp_array_a", 32),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 32),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 33),(troop_get_slot, ":troop_no", "trp_temp_array_a", 33),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 33),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 34),(troop_get_slot, ":troop_no", "trp_temp_array_a", 34),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 34),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 35),(troop_get_slot, ":troop_no", "trp_temp_array_a", 35),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 35),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 36),(troop_get_slot, ":troop_no", "trp_temp_array_a", 36),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 36),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 37),(troop_get_slot, ":troop_no", "trp_temp_array_a", 37),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 37),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 38),(troop_get_slot, ":troop_no", "trp_temp_array_a", 38),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 38),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 39),(troop_get_slot, ":troop_no", "trp_temp_array_a", 39),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 39),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 40),(troop_get_slot, ":troop_no", "trp_temp_array_a", 40),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 40),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 41),(troop_get_slot, ":troop_no", "trp_temp_array_a", 41),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 41),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 42),(troop_get_slot, ":troop_no", "trp_temp_array_a", 42),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 42),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 43),(troop_get_slot, ":troop_no", "trp_temp_array_a", 43),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 43),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 44),(troop_get_slot, ":troop_no", "trp_temp_array_a", 44),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 44),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 45),(troop_get_slot, ":troop_no", "trp_temp_array_a", 45),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 45),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 46),(troop_get_slot, ":troop_no", "trp_temp_array_a", 46),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 46),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 47),(troop_get_slot, ":troop_no", "trp_temp_array_a", 47),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 47),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 48),(troop_get_slot, ":troop_no", "trp_temp_array_a", 48),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 48),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 49),(troop_get_slot, ":troop_no", "trp_temp_array_a", 49),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 49),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 50),(troop_get_slot, ":troop_no", "trp_temp_array_a", 50),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 50),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 51),(troop_get_slot, ":troop_no", "trp_temp_array_a", 51),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 51),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 52),(troop_get_slot, ":troop_no", "trp_temp_array_a", 52),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 52),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 53),(troop_get_slot, ":troop_no", "trp_temp_array_a", 53),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 53),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 54),(troop_get_slot, ":troop_no", "trp_temp_array_a", 54),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 54),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 55),(troop_get_slot, ":troop_no", "trp_temp_array_a", 55),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 55),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 56),(troop_get_slot, ":troop_no", "trp_temp_array_a", 56),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 56),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 57),(troop_get_slot, ":troop_no", "trp_temp_array_a", 57),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 57),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 58),(troop_get_slot, ":troop_no", "trp_temp_array_a", 58),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 58),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 59),(troop_get_slot, ":troop_no", "trp_temp_array_a", 59),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 59),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 60),(troop_get_slot, ":troop_no", "trp_temp_array_a", 60),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 60),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 61),(troop_get_slot, ":troop_no", "trp_temp_array_a", 61),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 61),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 62),(troop_get_slot, ":troop_no", "trp_temp_array_a", 62),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 62),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 63),(troop_get_slot, ":troop_no", "trp_temp_array_a", 63),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 63),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 64),(troop_get_slot, ":troop_no", "trp_temp_array_a", 64),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 64),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 65),(troop_get_slot, ":troop_no", "trp_temp_array_a", 65),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 65),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 66),(troop_get_slot, ":troop_no", "trp_temp_array_a", 66),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 66),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 67),(troop_get_slot, ":troop_no", "trp_temp_array_a", 67),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 67),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 68),(troop_get_slot, ":troop_no", "trp_temp_array_a", 68),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 68),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 69),(troop_get_slot, ":troop_no", "trp_temp_array_a", 69),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 69),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 70),(troop_get_slot, ":troop_no", "trp_temp_array_a", 70),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 70),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 71),(troop_get_slot, ":troop_no", "trp_temp_array_a", 71),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 71),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 72),(troop_get_slot, ":troop_no", "trp_temp_array_a", 72),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 72),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 73),(troop_get_slot, ":troop_no", "trp_temp_array_a", 73),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 73),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 74),(troop_get_slot, ":troop_no", "trp_temp_array_a", 74),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 74),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 75),(troop_get_slot, ":troop_no", "trp_temp_array_a", 75),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 75),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 76),(troop_get_slot, ":troop_no", "trp_temp_array_a", 76),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 76),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 77),(troop_get_slot, ":troop_no", "trp_temp_array_a", 77),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 77),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 78),(troop_get_slot, ":troop_no", "trp_temp_array_a", 78),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 78),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 79),(troop_get_slot, ":troop_no", "trp_temp_array_a", 79),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 79),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 80),(troop_get_slot, ":troop_no", "trp_temp_array_a", 80),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 80),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 81),(troop_get_slot, ":troop_no", "trp_temp_array_a", 81),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 81),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 82),(troop_get_slot, ":troop_no", "trp_temp_array_a", 82),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 82),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 83),(troop_get_slot, ":troop_no", "trp_temp_array_a", 83),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 83),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 84),(troop_get_slot, ":troop_no", "trp_temp_array_a", 84),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 84),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 85),(troop_get_slot, ":troop_no", "trp_temp_array_a", 85),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 85),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 86),(troop_get_slot, ":troop_no", "trp_temp_array_a", 86),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 86),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 87),(troop_get_slot, ":troop_no", "trp_temp_array_a", 87),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 87),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 88),(troop_get_slot, ":troop_no", "trp_temp_array_a", 88),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 88),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 89),(troop_get_slot, ":troop_no", "trp_temp_array_a", 89),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 89),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 90),(troop_get_slot, ":troop_no", "trp_temp_array_a", 90),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 90),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 91),(troop_get_slot, ":troop_no", "trp_temp_array_a", 91),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 91),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 92),(troop_get_slot, ":troop_no", "trp_temp_array_a", 92),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 92),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 93),(troop_get_slot, ":troop_no", "trp_temp_array_a", 93),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 93),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 94),(troop_get_slot, ":troop_no", "trp_temp_array_a", 94),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 94),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 95),(troop_get_slot, ":troop_no", "trp_temp_array_a", 95),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 95),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 96),(troop_get_slot, ":troop_no", "trp_temp_array_a", 96),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 96),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 97),(troop_get_slot, ":troop_no", "trp_temp_array_a", 97),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 97),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 98),(troop_get_slot, ":troop_no", "trp_temp_array_a", 98),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 98),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 99),(troop_get_slot, ":troop_no", "trp_temp_array_a", 99),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 99),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 100),(troop_get_slot, ":troop_no", "trp_temp_array_a", 100),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 100),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 101),(troop_get_slot, ":troop_no", "trp_temp_array_a", 101),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 101),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 102),(troop_get_slot, ":troop_no", "trp_temp_array_a", 102),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 102),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 103),(troop_get_slot, ":troop_no", "trp_temp_array_a", 103),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 103),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 104),(troop_get_slot, ":troop_no", "trp_temp_array_a", 104),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 104),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 105),(troop_get_slot, ":troop_no", "trp_temp_array_a", 105),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 105),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 106),(troop_get_slot, ":troop_no", "trp_temp_array_a", 106),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 106),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 107),(troop_get_slot, ":troop_no", "trp_temp_array_a", 107),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 107),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 108),(troop_get_slot, ":troop_no", "trp_temp_array_a", 108),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 108),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 109),(troop_get_slot, ":troop_no", "trp_temp_array_a", 109),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 109),(jump_to_menu,"mnu_award_fief_selected")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 110),(troop_get_slot, ":troop_no", "trp_temp_array_a", 110),(str_store_troop_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$castle_meeting_selected_troop", "trp_temp_array_a", 110),(jump_to_menu,"mnu_award_fief_selected")]),

      ("nevermind",[(eq,"$temp_2",10000)],
       "Never mind.",
       [(jump_to_menu,"mnu_village")]),

      ("nevermind",[(neq,"$temp_2",10000)],
       "Never mind.",
       [(jump_to_menu,"mnu_manage_kingdom")]),
    ]),

  (
    "award_fief_selected",0,
    "Which center would you like to award to {s6}?",
    "none",
    [(try_begin),
          (eq,"$temp_2",10000),
          (assign,"$temp","$current_town"),
          (jump_to_menu,"mnu_award_fief_both"),
        (try_end),
        (str_store_troop_name, s6, "$castle_meeting_selected_troop"),
        (assign, "$num_castle_meeting_troops", 0),
        (try_for_range, ":center_no", towns_begin, towns_end),
          (party_slot_eq, ":center_no", slot_town_lord, "trp_player"),
          (neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_capital, ":center_no"),
          (troop_set_slot, "trp_temp_array_a", "$num_castle_meeting_troops", ":center_no"),
          (val_add, "$num_castle_meeting_troops", 1),
        (try_end),
        (try_begin),
        (lt,"$lord_request_land",2),
        ...
        (try_end),],
    [
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 0),(troop_get_slot, ":troop_no", "trp_temp_array_a", 0),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 0),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 1),(troop_get_slot, ":troop_no", "trp_temp_array_a", 1),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 1),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 2),(troop_get_slot, ":troop_no", "trp_temp_array_a", 2),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 2),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 3),(troop_get_slot, ":troop_no", "trp_temp_array_a", 3),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 3),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 4),(troop_get_slot, ":troop_no", "trp_temp_array_a", 4),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 4),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 5),(troop_get_slot, ":troop_no", "trp_temp_array_a", 5),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 5),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 6),(troop_get_slot, ":troop_no", "trp_temp_array_a", 6),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 6),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 7),(troop_get_slot, ":troop_no", "trp_temp_array_a", 7),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 7),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 8),(troop_get_slot, ":troop_no", "trp_temp_array_a", 8),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 8),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 9),(troop_get_slot, ":troop_no", "trp_temp_array_a", 9),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 9),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 10),(troop_get_slot, ":troop_no", "trp_temp_array_a", 10),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 10),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 11),(troop_get_slot, ":troop_no", "trp_temp_array_a", 11),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 11),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 12),(troop_get_slot, ":troop_no", "trp_temp_array_a", 12),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 12),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 13),(troop_get_slot, ":troop_no", "trp_temp_array_a", 13),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 13),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 14),(troop_get_slot, ":troop_no", "trp_temp_array_a", 14),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 14),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 15),(troop_get_slot, ":troop_no", "trp_temp_array_a", 15),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 15),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 16),(troop_get_slot, ":troop_no", "trp_temp_array_a", 16),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 16),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 17),(troop_get_slot, ":troop_no", "trp_temp_array_a", 17),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 17),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 18),(troop_get_slot, ":troop_no", "trp_temp_array_a", 18),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 18),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 19),(troop_get_slot, ":troop_no", "trp_temp_array_a", 19),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 19),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 20),(troop_get_slot, ":troop_no", "trp_temp_array_a", 20),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 20),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 21),(troop_get_slot, ":troop_no", "trp_temp_array_a", 21),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 21),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 22),(troop_get_slot, ":troop_no", "trp_temp_array_a", 22),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 22),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 23),(troop_get_slot, ":troop_no", "trp_temp_array_a", 23),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 23),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 24),(troop_get_slot, ":troop_no", "trp_temp_array_a", 24),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 24),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 25),(troop_get_slot, ":troop_no", "trp_temp_array_a", 25),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 25),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 26),(troop_get_slot, ":troop_no", "trp_temp_array_a", 26),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 26),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 27),(troop_get_slot, ":troop_no", "trp_temp_array_a", 27),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 27),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 28),(troop_get_slot, ":troop_no", "trp_temp_array_a", 28),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 28),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 29),(troop_get_slot, ":troop_no", "trp_temp_array_a", 29),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 29),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 30),(troop_get_slot, ":troop_no", "trp_temp_array_a", 30),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 30),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 31),(troop_get_slot, ":troop_no", "trp_temp_array_a", 31),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 31),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 32),(troop_get_slot, ":troop_no", "trp_temp_array_a", 32),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 32),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 33),(troop_get_slot, ":troop_no", "trp_temp_array_a", 33),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 33),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 34),(troop_get_slot, ":troop_no", "trp_temp_array_a", 34),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 34),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 35),(troop_get_slot, ":troop_no", "trp_temp_array_a", 35),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 35),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 36),(troop_get_slot, ":troop_no", "trp_temp_array_a", 36),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 36),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 37),(troop_get_slot, ":troop_no", "trp_temp_array_a", 37),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 37),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 38),(troop_get_slot, ":troop_no", "trp_temp_array_a", 38),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 38),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 39),(troop_get_slot, ":troop_no", "trp_temp_array_a", 39),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 39),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 40),(troop_get_slot, ":troop_no", "trp_temp_array_a", 40),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 40),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 41),(troop_get_slot, ":troop_no", "trp_temp_array_a", 41),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 41),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 42),(troop_get_slot, ":troop_no", "trp_temp_array_a", 42),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 42),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 43),(troop_get_slot, ":troop_no", "trp_temp_array_a", 43),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 43),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 44),(troop_get_slot, ":troop_no", "trp_temp_array_a", 44),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 44),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 45),(troop_get_slot, ":troop_no", "trp_temp_array_a", 45),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 45),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 46),(troop_get_slot, ":troop_no", "trp_temp_array_a", 46),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 46),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 47),(troop_get_slot, ":troop_no", "trp_temp_array_a", 47),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 47),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 48),(troop_get_slot, ":troop_no", "trp_temp_array_a", 48),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 48),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 49),(troop_get_slot, ":troop_no", "trp_temp_array_a", 49),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 49),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 50),(troop_get_slot, ":troop_no", "trp_temp_array_a", 50),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 50),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 51),(troop_get_slot, ":troop_no", "trp_temp_array_a", 51),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 51),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 52),(troop_get_slot, ":troop_no", "trp_temp_array_a", 52),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 52),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 53),(troop_get_slot, ":troop_no", "trp_temp_array_a", 53),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 53),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 54),(troop_get_slot, ":troop_no", "trp_temp_array_a", 54),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 54),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 55),(troop_get_slot, ":troop_no", "trp_temp_array_a", 55),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 55),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 56),(troop_get_slot, ":troop_no", "trp_temp_array_a", 56),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 56),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 57),(troop_get_slot, ":troop_no", "trp_temp_array_a", 57),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 57),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 58),(troop_get_slot, ":troop_no", "trp_temp_array_a", 58),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 58),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 59),(troop_get_slot, ":troop_no", "trp_temp_array_a", 59),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 59),(jump_to_menu,"mnu_award_fief_both")]),
      ("guard_meet_s5",[(gt, "$num_castle_meeting_troops", 60),(troop_get_slot, ":troop_no", "trp_temp_array_a", 60),(str_store_party_name, s5, ":troop_no")],
       "{s5}.",[(troop_get_slot, "$temp", "trp_temp_array_a", 60),(jump_to_menu,"mnu_award_fief_both")]),

      ("nevermind",[(gt,"$lord_request_land",0)],
       "Never mind.",
       [(jump_to_menu,"mnu_lord_request_land")]),

      ("nevermind",[(eq,"$lord_request_land",0)],
       "Never mind.",
       [(jump_to_menu,"mnu_manage_kingdom")]),
    ]),
 ...
 {reg65?She:He} believes {reg65?she:he} deserves at least a {reg63?town:castle} be granted to {reg65?her:him} for\
 {reg65?her:his} loyalty.  Otherwise {reg65?she:he} will have to find someone else to serve under who will properly recognize {reg65?her:his} efforts.\
 ({s59})",
    "none",
    [(set_background_mesh, "mesh_pic_messenger"),
     (troop_get_type, reg65, "$castle_meeting_selected_troop"),
     (call_script, "script_troop_get_player_relation", "$castle_meeting_selected_troop"),
     (assign, ":relation", reg0),
     ...
     (str_store_string, s60, "@{reg65?She:He}"),
     (str_store_string, s59, ":str_id"),
     (str_store_troop_name, s6, "$castle_meeting_selected_troop"),
     (store_sub,reg63,"$lord_request_land",1),
     (assign,"$temp_2",0),
     ],
    [
      ("request_yes",[],
       "Select a fief to award to {s6}.",
       [
           (jump_to_menu,"mnu_award_fief_selected"),
        ]),
      ("request_no",[],
       "Reply that you will not be giving {reg65?her:him} any lands today.",
       [
           (assign,"$lord_request_land",0),
           (call_script,"script_change_player_relation_with_troop","$castle_meeting_selected_troop",-40),
           #(call_script,"script_cf_get_random_active_faction_except_faction", "fac_player_supporters_faction"),
		   (call_script,"script_cf_get_random_active_faction_except_player_faction_and_faction", "fac_player_supporters_faction"),
		   
           (troop_set_slot, "$castle_meeting_selected_troop", slot_troop_change_to_faction, reg0),
           (change_screen_return),
        ]),
    ]),
  ...
  ( "award_fief_both",0,
    ...
    "none",
    [(str_store_troop_name, s6, "$castle_meeting_selected_troop"),
     (str_store_party_name, s7, "$temp"),],
    [
      ("award_yes",[(eq,"$temp_2",10000),],
       "Yes.",
       [
           (call_script,"script_give_center_to_lord","$temp","$castle_meeting_selected_troop",0),
           #(call_script,"script_change_player_relation_with_troop","$castle_meeting_selected_troop",5),
           (troop_set_slot, "$castle_meeting_selected_troop", slot_troop_change_to_faction, 0),
           (jump_to_menu,"mnu_village"),
        ]),
      ("award_no",[(eq,"$temp_2",10000),],
       "No.",
       [
           (jump_to_menu,"mnu_village"),
        ]),
      ("award_yes",[(gt,"$lord_request_land",0)],
       "Yes.",
       [
           (call_script,"script_give_center_to_lord","$temp","$castle_meeting_selected_troop",0),
           #(call_script,"script_change_player_relation_with_troop","$castle_meeting_selected_troop",20),
           (assign,"$lord_request_land",0),
           (change_screen_return),
        ]),
      ("award_no",[(gt,"$lord_request_land",0)],
       "No.",
       [
           (jump_to_menu,"mnu_lord_request_land"),
        ]),
      ("award_yes",[(eq,"$lord_request_land",0),(neq,"$temp_2",10000),],
       "Yes.",
       [
           (call_script,"script_give_center_to_lord","$temp","$castle_meeting_selected_troop",0),
          # (call_script,"script_change_player_relation_with_troop","$castle_meeting_selected_troop",20),
      ...
      ("award_no",[(eq,"$lord_request_land",0),(neq,"$temp_2",10000),],
       "No.",
       [
           (jump_to_menu,"mnu_manage_kingdom"),
        ]),
  ...
  ( "hire_adviser",0,
    "Which adviser would you like to hire?",
    "none",
    [],
    [
      ("civil_adviser",[(neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_civil_adviser, 1),
                        (str_store_troop_name,s1,"trp_civil_adviser"),],
       "{s1}",
       [
           (jump_to_menu,"mnu_hire_civil_adviser"),
        ]),
      ("financial_adviser",[(neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_financial_adviser, 1),
                      (str_store_troop_name,s1,"trp_financial_adviser"),],
       "{s1}",
       [
           (jump_to_menu,"mnu_hire_financial_adviser"),
        ]),
      ("logistics_adviser",[(neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_logistics_adviser, 1),
                      (str_store_troop_name,s1,"trp_logistics_adviser"),],
       "{s1}",
       [
           (jump_to_menu,"mnu_hire_logistics_adviser"),
        ]),
      ("intel_adviser",[(neg|faction_slot_eq, "fac_player_supporters_faction", slot_faction_intel_adviser, 1),
                      (str_store_troop_name,s1,"trp_intel_adviser"),],
       "{s1}",
       [
           (jump_to_menu,"mnu_hire_intel_adviser"),
        ]),
  ...
  ( "hire_civil_adviser",0,
    "A {s1} tracks which castles or towns are outside the influence of your lords and capital.  Centers outside your\
 influence gradually build unrest and will eventually rebel if not controlled.^A {s1} costs 5000 denars to hire. Hire one?",
    "none",
    [(str_store_troop_name,s1,"trp_civil_adviser")],
    [
      ("yes",[],"Yes.",
       [
           (str_store_troop_name,s11,"trp_civil_adviser"),
           (store_troop_gold, ":gold", "trp_player"),
           (try_begin),
             (ge,":gold",5000),
             (troop_remove_gold, "trp_player", 5000),
             (call_script, "script_adjust_finances", slot_finance_center_upgrades, -5000),
             (faction_set_slot, "fac_player_supporters_faction", slot_faction_civil_adviser, 1),
             (display_message,"@A {s11} has been hired and can be found in the castle of your capital."),
           (else_try),
             (display_message,"@You do not have enough money to hire a {s11}."),
           (try_end),
           (jump_to_menu,"mnu_manage_kingdom"),
        ]),
      ("no",[],"No.",
  ...
  ( "hire_intel_adviser",0,
    "A {s1} controls a network of spies throughout Calradia.  He can tell you which lords are unhappy in other kingdoms, which\
 castles are least defended, and where the monarchs of each faction are hiding.^A {s1} costs 5000 denars to hire. Hire one?",
    "none",
    [(str_store_troop_name,s1,"trp_intel_adviser")],
    [
      ("yes",[],"Yes.",
       [
           (str_store_troop_name,s11,"trp_intel_adviser"),
           (store_troop_gold, ":gold", "trp_player"),
           (try_begin),
             (ge,":gold",5000),
             (troop_remove_gold, "trp_player", 5000),
             (call_script, "script_adjust_finances", slot_finance_center_upgrades, -5000),
             (faction_set_slot, "fac_player_supporters_faction", slot_faction_intel_adviser, 1),
             (display_message,"@A {s11} has been hired and can be found in the castle of your capital."),
           (else_try),
             (display_message,"@You do not have enough money to hire a {s11}."),
           (try_end),
  ...
  ( "hire_financial_adviser",0,
    "A {s1} keeps track of your monthly income and expenditures for both the current and previous months.^A {s1} costs 3000 denars to hire. Hire one?",
    "none",
    [(str_store_troop_name,s1,"trp_financial_adviser")],
    [
      ("yes",[],"Yes.",
       [
           (str_store_troop_name,s11,"trp_financial_adviser"),
           (store_troop_gold, ":gold", "trp_player"),
           (try_begin),
             (ge,":gold",3000),
             (troop_remove_gold, "trp_player", 3000),
             (call_script, "script_adjust_finances", slot_finance_center_upgrades, -3000),
             (faction_set_slot, "fac_player_supporters_faction", slot_faction_financial_adviser, 1),
             (display_message,"@A {s11} has been hired and can be found in the castle of your capital."),
           (else_try),
             (display_message,"@You do not have enough money to hire a {s11}."),
           (try_end),
  ...
  ( "hire_logistics_adviser",0,
    "A {s1} tracks the flow of resources and men in your kingdom. With a {s1} hired, your kingdom will automatically generate patrols\
 to keep order in your lands. Combined with a {s2}, he will be able to monitor the population centers of your kingdom and recommend upgrades\
 to be dispatched to those locations.^A {s1} is highly trained and costs 6000 denars to hire. Hire one?",
    "none",
    [(str_store_troop_name,s1,"trp_logistics_adviser"),(str_store_troop_name,s2,"trp_civil_adviser")],
    [
      ("yes",[],"Yes.",
       [
           (str_store_troop_name,s11,"trp_logistics_adviser"),
           (store_troop_gold, ":gold", "trp_player"),
           (try_begin),
             (ge,":gold",6000),
             (troop_remove_gold, "trp_player", 6000),
             (call_script, "script_adjust_finances", slot_finance_center_upgrades, -6000),
             (faction_set_slot, "fac_player_supporters_faction", slot_faction_logistics_adviser, 1),
             (display_message,"@A {s11} has been hired and can be found in the castle of your capital."),
           (else_try),
             (display_message,"@You do not have enough money to hire a {s11}."),
           (try_end),
  ...
  (
    "notification_rebellion",0,
    "Rebellion!^^{s1} has rebelled from {s2}.",
    "none",
    [
      (str_store_party_name, s1, "$g_notification_menu_var1"),
      (str_store_faction_name, s2, "$players_kingdom"),
...
## Kingdom management part 2 end
# NE end kingdom

################################################################################
# APPARENTLY DEPRECATED MENU ITEMS
################################################################################
  ...
  ("morale_report",0,
   ...
   [
     ...
     (try_end),
 # NE quests 
 # v585 Josef add whiskey modifiers to morale report
	  (try_begin),
      (gt, "$g_player_party_morale_modifier_booze", 0),
      (assign, reg6, "$g_player_party_morale_modifier_booze"),
      (str_store_string, s8, "@^Hard Liquor:  +{reg6}"),
    (else_try),
      (str_store_string, s8, "@ "),
    (try_end),
# v585 end
...
# NE settings
    ...
    (try_for_range,":index",0,":stacks"),
      (eq, "$setting_use_wounding", 1),
      (party_stack_get_troop_id,":troop_id","p_main_party",":index"),
      (gt,":troop_id",0),
      (troop_is_hero,":troop_id"),
      (neq,":troop_id","trp_player"),
      (str_store_troop_name,s2,":troop_id"),
      (try_begin),
          (troop_get_slot, ":wound", ":troop_id", slot_troop_wound_str),
          (gt, ":wound", 0),
          (val_sub,":wound",":cur_hours"),
          (val_div,":wound",24),
          (assign,reg4,":wound"),
          (str_store_string,s1,"@{s1}^The wound affecting {s2}'s strength will be healed in {reg4} days."),
      (try_end),
      (try_begin),
          (troop_get_slot, ":wound", ":troop_id", slot_troop_wound_agi),
          (gt, ":wound", 0),
          (val_sub,":wound",":cur_hours"),
          (val_div,":wound",24),
          (assign,reg4,":wound"),
          (str_store_string,s1,"@{s1}^The wound affecting {s2}'s agility will be healed in {reg4} days."),
      (try_end),
      (try_begin),
          (troop_get_slot, ":wound", ":troop_id", slot_troop_wound_cha),
          (gt, ":wound", 0),
          (val_sub,":wound",":cur_hours"),
          (val_div,":wound",24),
          (assign,reg4,":wound"),
          (str_store_string,s1,"@{s1}^The wound affecting {s2}'s charisma will be healed in {reg4} days."),
      (try_end),
      (try_begin),
          (troop_get_slot, ":wound", ":troop_id", slot_troop_wound_int),
          (gt, ":wound", 0),
          (val_sub,":wound",":cur_hours"),
          (val_div,":wound",24),
          (assign,reg4,":wound"),
          (str_store_string,s1,"@{s1}^The wound affecting {s2}'s intelligence will be healed in {reg4} days."),
      (try_end),
    (try_end),
# NE settings	 
  ...
  # DEPRECATED - REPLACED BY INFO_PAGES
  ("lord_relations",0,
   "{s1}",
   "none",
   [   
    ...
    (try_for_range, ":unused", active_npcs_begin, active_npcs_end),
		...
		(str_store_faction_name_link, s5, ":npc_faction"),
		(assign, reg4, ":score_to_beat"),
		(str_store_string, s1, "@{!}{s1}^{s4} of {s5}: {reg4}"),
  ...
  ("character_report",0,
   ...
   [(try_begin),
    ...
    (try_begin),
        ...
        (store_current_hours, ":cur_hours"),
        (try_begin),
            (troop_get_slot, ":wound", "trp_player", slot_troop_wound_str),
            (gt, ":wound", 0),
            (val_sub,":wound",":cur_hours"),
            (val_div,":wound",24),
            (assign,reg4,":wound"),
            (str_store_string,s9,"@{s9}^The wound affecting your strength will be healed in {reg4} days."),
        (try_end),
        (try_begin),
            (troop_get_slot, ":wound", "trp_player", slot_troop_wound_agi),
            (gt, ":wound", 0),
            (val_sub,":wound",":cur_hours"),
            (val_div,":wound",24),
            (assign,reg4,":wound"),
            (str_store_string,s9,"@{s9}^The wound affecting your agility will be healed in {reg4} days."),
        (try_end),
        (try_begin),
            (troop_get_slot, ":wound", "trp_player", slot_troop_wound_cha),
            (gt, ":wound", 0),
            (val_sub,":wound",":cur_hours"),
            (val_div,":wound",24),
            (assign,reg4,":wound"),
            (str_store_string,s9,"@{s9}^The wound affecting your charisma will be healed in {reg4} days."),
        (try_end),
        (try_begin),
            (troop_get_slot, ":wound", "trp_player", slot_troop_wound_int),
            (gt, ":wound", 0),
            (val_sub,":wound",":cur_hours"),
            (val_div,":wound",24),
            (assign,reg4,":wound"),
            (str_store_string,s9,"@{s9}^The wound affecting your intelligence will be healed in {reg4} days."),
        (try_end),	
	(try_end),
	# NE end settings
...
# DEPRECATED IN 0.608b9
  (
    "recruit_nobles_new_system",0,
    "{s18}",
    "none",
    [(party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
     (party_get_slot, ":volunteer_amount", "$current_town", slot_center_volunteer_troop_amount),
	 ...
	 (try_begin), #Recruit nobles from towns now too - Jinnai
       (party_slot_eq, "$current_town", slot_party_type, spt_town),
	   #(is_between, "$current_town", towns_begin, towns_end), 
       (assign,":cost", 100), # Raise cost to 100 denars for noble recruitment
     (else_try),
       (assign,":cost", 10),
     (try_end),
     (store_div, ":gold_capacity", ":gold", ":cost"),#10 denars per man
     ...
     (else_try),
	    # ne noble
	   (store_mul, reg6, ":volunteer_amount", ":cost"),#10 denars per man
       # (store_mul, reg6, ":volunteer_amount", 10),#10 denars per man
	   # ne end noble 
       (str_store_troop_name_by_count, s3, ":volunteer_troop", ":volunteer_amount"),
       (try_begin),
       ...
       (try_end),
     (try_end),
     # Check player's renown, decline recruitment if the player is a nobody
     # s18 is displayed at the end of the recruitment test phase
     # reg7 is used to compare the result of the test phase
     (try_begin),
       (lt, ":player_renown", 250),
       (str_store_string, s18, "@Unwilling to fight for someone they do not know, no one volunteers to join you."),
       (assign, reg7, 2),
     (try_end),
     # check the player's faction, decline recruitment if the player isn't in
     # this town's faction. make it optional in camp menu.
     (try_begin),
       (eq,"$setting_require_faction_noble_recruit",1),
       (store_faction_of_party, ":town_faction", "$current_town"),
       (neg|eq, "$players_kingdom", ":town_faction"),
    ...
    [
      ("continue_player_is_not_faction_member",
      [
        (eq, reg7, 3),
      ],
      "Continue...",
      ...
      [
        ...
        (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
        (store_mul, reg5, reg5, 5),
        (display_message, "@You lose {reg5} renown for hiring Noble soldiers."),
