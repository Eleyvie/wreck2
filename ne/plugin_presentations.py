...
meshes = [
	...
	("ui_white_plane", 0, "white_plane", 0, 0, 0, 0, 0, 0, 50, 50, 50),
	# other
...
extend_syntax(ui_create_label)
extend_syntax(ui_create_mesh)
extend_syntax(ui_create_game_button)
extend_syntax(ui_create_image_button)
extend_syntax(ui_create_checkbox)
extend_syntax(ui_create_container)
extend_syntax(ui_create_textbox)
extend_syntax(ui_create_combobox)



scripts = [

	# (call_script, script.ui_create_color_picker, <color>, <x>, <y>, <scale>),
	# OUTPUT:
	#   reg0 = red_overlay_id
	#   reg1 = green_overlay_id
	#   reg2 = blue_overlay_id
	#   reg3 = red_component_value
	#   reg4 = green_component_value
	#   reg5 = blue_component_value
	("ui_create_color_picker", [
		(store_script_param, l.color, 1),
		(store_script_param, l.x, 2),
		(store_script_param, l.y, 3),
		(store_script_param, l.scale, 4),
		(store_mul, l.offset, 80, l.scale),
		(val_div, l.offset, 1000),

		(store_and, reg3, l.color, 0xff0000),
		(val_rshift, reg3, 16),
		(store_and, reg4, l.color, 0xff00),
		(val_rshift, reg4, 8),
		(store_and, reg5, l.color, 0xff),

		# Red element
		(create_number_box_overlay, reg0, 0, 256),
		(position_set_x, ui_position, l.x),
		(position_set_y, ui_position, l.y),
		(overlay_set_position, reg0, ui_position),
		(overlay_set_val, reg0, reg3),
		# Green element
		(val_add, l.x, l.offset),
		(position_set_x, ui_position, l.x),
		(create_number_box_overlay, reg1, 0, 256),
		(overlay_set_position, reg1, ui_position),
		(overlay_set_val, reg1, reg4),
		# Blue element
		(val_add, l.x, l.offset),
		(position_set_x, ui_position, l.x),
		(create_number_box_overlay, reg2, 0, 256),
		(overlay_set_position, reg2, ui_position),
		(overlay_set_val, reg2, reg5),
		# Resize elements
		(position_set_x, ui_position, l.scale),
		(position_set_y, ui_position, l.scale),
		(overlay_set_size, reg0, ui_position),
		(overlay_set_size, reg1, ui_position),
		(overlay_set_size, reg2, ui_position),
	]),
