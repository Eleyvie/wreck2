...
# pete peasants 
  ("raise_peasants", "Raise {reg1} {s14}", qf_random_quest,
  "{!}{s9} asked you to find {reg1} {s14} to use as servants."
  ),
  
# pete party

 ("party", "Bring wine to {s9}", qf_random_quest,
  "{!}{s9} asked you to find {reg1} {s14} for a banquet he's holding."
  ), 
  
# pete love letter 
 ("deliver_love_letter", "Deliver Message to {s13}", qf_random_quest,
  "{!}{s9} asked you to take a love letter to {s13}. {s13} was at {s4} when you were given this quest."
  ),
  
# pete usurpers
  
  ("kill_elites", "Search for the Rebel Troops and destroy them.", qf_random_quest,
  "{!}{s9} asked you to track down the kingdom rebels and eliminate them."
  ),
...
#Other duel quests
  ...
  # Pete - deliver portrait

 ("deliver_portrait", "Deliver Strange Portrait", qf_random_quest,
  "{!}None"
  ),

  # Pete - deliver love letter 

 ("deliver_letter", "Deliver a love letter to {s13}", qf_random_quest,
  "{!}None"
  ),
# Pete end 

# Pete fight king
  ("fight_king", "Challenge {s13} to a Trial of Arms", qf_random_quest,
  "{!}None"
  ),
# Pete end
...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ...
 ("deal_with_looters", "Deal with Rogue Mercenaries", qf_random_quest,
  "{!}The Guildmaster of {s4} has asked you to deal with several bands of Mercs around {s4}, and bring back any goods you recover."
  ),
...
# NE end quests
  ...
  # Pete Cheese Rustlers
   ("cheese_rustlers", "Hunt Down Cheese Rustlers", qf_random_quest,
  "{s9} of {s4} asked you to hunt down the cheese rustlers in the vicinity of the town."
   ),
# Pete Cheese Paladins
   ("cheese_paladins", "Hunt Down Cheese Rustlers", qf_random_quest,
  "{s9} of {s4} asked you to hunt down the cheese rustlers in the vicinity of the town."
   ),    
# Pete Cheese Paladins
   ("bar_brawl", "Clean Up the Town", qf_random_quest,
  "{s9} of {s4} asked you to deal with the louts in the vicinity of the tavern."
   ),   
...
# NE quests 
  # pete escort scholars
  ("escort_scholars", "Escort Scholars to {s8}", qf_random_quest,
  "Escort the scholars to the town of {s8}."
  ),
 
# pete smugglers

 ("hunt_down_smugglers", "Hunt Down the Smugglers", qf_random_quest,
  "{s9} asked you to bring back the three groups of SMUGGLERS to {s2}. He said all three groups must be running away in the direction of {s3}."
  ),

 
#petegirl
   ("hunt_down_girl", "Hunt down {s4}", qf_random_quest,
  "{s9} asked you to hunt down a girl named {s4}. She is currently believed to be at {s3}."
  ),
  
# pete lumber 
 ("deliver_lumber", "Bring lumber to {s3}", qf_random_quest,
  "The elder of the village of {s3} asked you to bring them {reg5} bales of lumber.."
  ), 

# pete miller
 ("kidnapped_wife", "Ransom Wife from Bandits", qf_random_quest,
  "Village Elder of {s4} asked you to pay the ransom for the miller's wife.\
 You are to meet the bandits near {s3} and pay them the ransom fee.\
 After that you are to bring the woman back to {s4}."
  ),
