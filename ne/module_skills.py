...
skills = [
  ...
  ("prisoner_management",  "Prisoner Management",  sf_base_att_cha,                  10, "Every level of this skill increases maximum number of prisoners by 10. (Leader skill)"), 
  ("reserved_03",          "Reserved Skill #3",    sf_base_att_cha|sf_inactive,      10, "."), 
  ("reserved_04",          "Reserved Skill #4",    sf_base_att_cha|sf_inactive,      10, "."), 
  ("reserved_05",          "Reserved Skill #5",    sf_base_att_cha|sf_inactive,      10, "."), 
  ("reserved_06",          "Reserved Skill #6",    sf_base_att_cha|sf_inactive,      10, "."), 
  ...
  ("spotting",             "Spotting",             sf_base_att_int|sf_effects_party, 10, "Party seeing range is increased by 10%% and enemy lords chances for escape are reduced by 1%% per skill level. (Party skill)"),
  ("pathfinding",          "Pathfinding",          sf_base_att_int|sf_effects_party, 10, "Party map speed is increased by 3%% per skill level. (Party skill)"), 
  ...
  ("tracking",             "Tracking",             sf_base_att_int|sf_effects_party, 10, "Each point to this skill increases information divined from tracks on global map and decreases enemy lords chances of escape by 2%% (Party skill)"),
  ...
  ("reserved_18",          "Reserved Skill #18",   sf_base_att_int|sf_inactive,      10, "."), 
  ("reserved_19",          "Reserved Skill #19",   sf_base_att_int|sf_inactive,      10, "."), 
  ("reserved_20",          "Reserved Skill #20",   sf_base_att_int|sf_inactive,      10, "."), 
  ("reserved_21",          "Reserved Skill #21",   sf_base_att_int|sf_inactive,      10, "."), 
  ...
  ("reserved_28",          "Reserved Skill #28",   sf_base_att_agi|sf_inactive,      10, "."), 
  ("reserved_29",          "Reserved Skill #29",   sf_base_att_agi|sf_inactive,      10, "."), 
  ("reserved_30",          "Reserved Skill #30",   sf_base_att_agi|sf_inactive,      10, "."), 
  ("reserved_31",          "Reserved Skill #31",   sf_base_att_agi|sf_inactive,      10, "."), 
  ("reserved_32",          "Reserved Skill #32",   sf_base_att_agi|sf_inactive,      10, "."), 
  ...
  ("power_strike",         "Power Strike",         sf_base_att_str,                  12, "Each point to this skill increases melee damage by 8%%. (Personal skill)"),
  ("ironflesh",            "Ironflesh",            sf_base_att_str,                  12, "Each point to this skill increases hit points by +2 and decreases received damage by -1. (Personal skill)"), 
  ("reserved_37",          "Reserved Skill #37",   sf_base_att_str|sf_inactive,      10, "."), 
  ("reserved_38",          "Reserved Skill #38",   sf_base_att_str|sf_inactive,      10, "."), 
  ("reserved_39",          "Reserved Skill #39",   sf_base_att_str|sf_inactive,      10, "."), 
  ("reserved_40",          "Reserved Skill #40",   sf_base_att_str|sf_inactive,      10, "."), 
  ("reserved_41",          "Reserved Skill #41",   sf_base_att_str|sf_inactive,      10, "."), 
]
