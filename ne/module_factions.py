...
factions = [
  ...
  ("outlaws","Outlaws", max_player_rating(-30), 0.5,[("commoners",-0.6),("player_faction",-0.15)], [], 0xFF0000), #0x888888),
# Factions before this point are hardwired into the game end their order should not be changed.
  ...
  ("culture_dark_knights",  "{!}culture_dark_knights", 0, 0.9, [], []),
...
#  ("vaegir_caravans","Vaegir Caravans", 0, 0.5,[("outlaws",-0.8), ("dark_knights",-0.2)], []),
  ...
  ("player_faction","Player Faction",0, 0.9, [], [], 0xffff80),
  ("player_supporters_faction","Player's Supporters",0, 0.9, [("player_faction",1.00),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x0000ff), #changed name so that can tell difference if shows up on map
  ...
  ("kingdom_2",  "Vaegir Czardom",    0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xCCBB99),
  ("kingdom_3",  "Khergit Khaganate", 0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xCC99FF),
  ("kingdom_4",  "Jarldom of Nords",    0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x33DDDD),
  ("kingdom_5",  "Rhodokian Republic",  0, 0.9, [("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x33DD33),
  ...
  ("dark_knights","Dark Knights", max_player_rating(-40), 0.5,[("commoners",-0.9),("player_faction",-0.4),("player_supporters_faction",-0.4)], [], 0x010101),
...
##  ("rebel_peasants","Rebel Peasants", 0, 0.5,[("vaegirs",-0.5),("player_faction",0.0)], []),
  ...
  ("deserters","Deserters", 0, 0.5,[("manhunters",-0.6),("player_faction",-0.1)], [], 0xff0000),
  ("mountain_bandits","Mountain Bandits", 0, 0.5,[("commoners",-0.2),("manhunters",-0.6),("player_faction",-0.15)], [], 0xff0000),
  ("forest_bandits","Forest Bandits", 0, 0.5,[("commoners",-0.2),("manhunters",-0.6),("player_faction",-0.15)], [], 0xff0000),
