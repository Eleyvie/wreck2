...
##  ("nothing", "nothing"),
  ...
  ("tutorial_map1","You are now viewing the overland map. Left-click on the map to move your party to that location, enter the selected town, or pursue the selected party. Time will pause on the overland map if your party is not moving, waiting or resting. To wait anywhere simply press and hold down the space bar."),
   # Ne quests 
   # v585 Josef Cheese Rustler Message
   ("cheese_rustlers_eliminated_by_another", "The cheese rustlers have been eliminated by another party."),
   ("elites_eliminated_by_another", "The usurpers have been eliminated by another party."),
 # Ne end quests
...
# Surname
 ...
 # NE quests
  ...
  ("girl_surname_3", "{s50} the Broadbeamed"),

  ("girl_surnames_end", "girl_surnames_end"),
...
# NE Companions
  ...
  ("npc3_intro", "What do you want?"),
  ("npc4_intro", "Cattle die; Kinsfolk die; All things but renown fade with time."),
  ...
  ("npc15_intro", "What did you come here for?"),
  ...
  ("npc3_intro_response_1", "I just wanted to ask, what are you doing here?"),
  ("npc4_intro_response_1", "Umm...are you okay, sir?"),
  ...
  ("npc8_intro_response_1", "I noticed you wear the badge of the Craftsman's Guild."),
  ("npc9_intro_response_1", "You must have me confused with the tavernkeep, sir."),
  ("npc10_intro_response_1", "Thanks. So, what are you doing here?"),
  ("npc11_intro_response_1", "What's the occasion?"),
  ("npc12_intro_response_1", "How is that?"),
  ("npc13_intro_response_1", "Um... I don't think so."),
  ("npc14_intro_response_1", "To pass the time of day with a fellow traveller, if you permit. What are you doing here?"),
  ("npc15_intro_response_1", "Merely to speak with you, if I could. Why are you here?"),
  ...
  ("npc3_intro_response_2", "Away with you, vile beggar!"),
  ("npc4_intro_response_2", "Well, I have better things to do than talk to a lunatic."),
...
#backstory intro
  ...
  ("npc2_backstory_a", "It's a tragic tale, sir."),
   ("npc3_backstory_a", "Well, I was a doctor in a great mercenary company, headed by a commander named Alyssa and a sergeant named Kelemvor."),
  ...
  ("npc8_backstory_a", "Yes, that's because I'm an engineer. Specialist in the art of fortification... and destroying said fortifications. Though recently I've done more fighting than anything."),
  ...
  ("npc10_backstory_a", "Well, I was once the Captain of the Civil Guard in Veluca. I was the best of the best watchmen in the lands of the Confederacy."),
...
#backstory main body
  ...
  # Pellagus
  #("npc3_backstory_b", "We went off to kill some person named Achilles in the ice-bound lands near Khudan. Well, most of us froze, thanks to Kelemvor, and the rest of us got cut to pieces, thanks to Kelemvor."),
  ("npc3_backstory_b", "We were chasing a spy in the ice-bound lands near Khudan. We were caught in a blizzard, our quarry was lost and I became separated from my company."),
  ...
  ("npc8_backstory_b", "I was hired by a lord to prepare the needed siege equipment to take {s20}. Unfortunately, I was not supplied enough materials and assistance to complete the project before reinforcements arrived to defend {s20}.  The lord decided he could run faster if he left the majority of his army behind and snuck away in the night leaving us to be butchered."),
  ...
  ("npc10_backstory_b", "But no, the Lord decided that the assassination of a merchant by some person wasn't worth looking into. I continued investigating, found a trail to a mercenary commander, but the Lord banished me before I could continue, with a farce of a trial. I then traveled around, looking for a job - I joined the army as a sniper and fought the Swadians for a few months."),
  ...
  # Pellagus
  #("npc14_backstory_b", "So I did. The Golden Company, led by a Commander named Alyssa, hired me to train the troops for a particular mission. These mercenaries, encouraged by a wench named Xerina,  rebelled against my discipline and we ended up getting slashed to pieces.  I survived the battle - barely, and I made my way here, unable to tell if Alyssa had survived. I fear she did not, and so I wait here for a new company, that is in need of better discipline."),
  #("npc15_backstory_b", "A Swadian Lord ordered us to go and defeat a warrior named Achilles. Well, we went there, and got ambushed by six Vaegir Lords and their war parties. That was the end of my company; I was the only survivor, and I made my way here."),
  ("npc14_backstory_b", "I joined the Golden Company, under the reknowned Alyssa. We were tasked with capturing a foreign spy and followed them into the mountains above Khudan. A storm came down and the damned fool troops forgot their training. I expect half of them froze to death up there. Discipline, you see? They would not listen."),  
  ("npc15_backstory_b", "I was tasked by a Swadian Lord to track down a villainous spy. The man was cunning, and led us into the treacherous peaks above Khudan. A cruel snowstorm took our sight and we were undone. My Golden Company is no more."),
...
#backstory recruit pitch
  ...
  # Pellagus
  #("npc3_backstory_c", "At least Kel died. But now I need to find another mercenary band to join with - it's a scary world for a single woman who's more of a healer than a medic. I can handle myself, but I don't like to kill."),
  ("npc3_backstory_c", "Damned Kelemvor! His 'discipline' was our downfall. So now I need to find another mercenary band to join with. I am highly skilled with a blade, but prefer to use my skills for healing."),
  ...
  ("npc8_backstory_c", "Fearing for my life I armed myself and joined the fight, but was knocked unconscious and taken prisoner.  I spent some time as a prisoner, but managed to organize an escape.  I've wandered for a while looking for employment, but given my recent experiences I find myself more discerning of who I will work for."),
  ...
  ("npc10_backstory_c", "I found myself on a campaign as a Captain. Crossbows are beautiful weapons - can punch clear through plate armour, spilling the noble's blue blood on the ground. No chance for my red blood to shower the ground because of those lances. But I found myself in trouble, after a certain Lord of Veluca contracted a case of bolt-in-the-eye, and I deserted, when his son looked for, ironically, justice. Now here I am, spending my money on women and drink, and the Devil take tomorrow."),
  ...
  #("npc15_backstory_c", "So, here I am, spending all my money on women and drink while waiting for a war party that requires a capable commander to come past. You wouldn't happen to know of one, would you?"),
  ("npc14_backstory_c", "So, if you know of any commander who believes that his purpose is to win battles, rather than pamper his soldiers, I would be pleased if you directed me to him."),
  ("npc15_backstory_c", "So, here I am, spending my money on women and drink while waiting for a war party that requires a capable commander to come past. You wouldn't happen to know of one, would you?"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc2_backstory_later", "I sold my boots and have managed to make a few denars peddling goods from town to town, but it's a hard living."),  # Pellagus
  #("npc3_backstory_later", "I hired myself on as a medic for some passing caravans, and that at least keeps me fed. But it is rough company on the road, and I grow weary of fighting off guards and others who would try to take liberties. I was thinking that if I could find work with a real mercenary company, men would know to leave me alone."),
  ("npc3_backstory_later", "I have found some small work treating the ailments of local merchants. They pay well, but it is not my calling to minister the boils of fat men. Though I sometimes resent it, I know I am a soldier at heart."),
  ...
  ("npc8_backstory_later", "Well, I've had a few job offers. But when I investigated the patrons' backgrounds they were always... lacking."),
  ...
  ("npc10_backstory_later", "I don't know if I told you or not, but I deserted my unit after I killed a Lord who I have an old grievance with. Since then I've been laying low. Thankfully I had the wit to pilfer my captain's purse before heading out, but the money is running low."),
  ...
  # Pellagus
  #("npc15_backstory_later", "I have wandered around a bit, killing bandits and using the gold off of their equipment to continue paying for drink and women, but I'm still looking for someone who needs a capable commander under them."),
  ("npc15_backstory_later", "I have wandered around a bit, killing bandits and using the proceeds of their loot to continue paying for drink and women, but I'm still looking for someone who needs a capable commander under them."),
  ...
  ("npc8_backstory_response_1", "I could use someone of your talents."),
  ...
  ("npc15_backstory_response_1", "Well, I've been looking for a commander lately...what can you do?"),
 ...
 ("npc3_backstory_response_2", "I can't help, sorry."),
 ("npc4_backstory_response_2", "No, sorry, I haven't heard of one."),
  ...
  ("npc8_backstory_response_2", "I'm sorry to hear that.  Hopefully you will find a worthy project soon."),
  ...
  ("npc15_backstory_response_2", "Sorry, I don't need another commander. Having too many commanders can lead a company to its death."),
  ...
  ("npc3_signup", "Do you? Then I would be pleased to join you."),
   ("npc4_signup", "Good! I look forward to vanquishing your enemies."),
  ("npc5_signup", "Why, that is a most generous offer."),
  ("npc6_signup", "Yes! You must have been sent by the Valar! Lead me -- lead me away from darkness!"),
  ("npc7_signup", "I might be. I could certainly use the money."),
  ("npc8_signup", "I can only imagine the number of places you plan on sieging and from what I can tell you seem to be a trustworthy enough person."),
  ...
  # Pellagus
  #("npc15_signup", "Excellent. I will be happy to leave these flea-infested inns and their crude inhabitants behind, in favor of a clean tent along my soldiers."),
  ("npc15_signup", "Excellent. I will be happy to leave these flea-infested inns and their crude inhabitants behind, in favour of a clean tent alongside good soldiers."),
  ...
  ("npc3_signup_2", "I think you would find I would be a most valuable addition to your ranks. I am well versed in medicine, and can fight decently, though I dislike doing so."),
  ...
  ("npc8_signup_2", "Just give me a share of the loot and never throw me to the enemy to save your own skin and we have a deal."),
  ...
  # Pellagus
  #("npc15_signup_2", "I am one of the best swordfighters in Calradia, and I can lead soldiers quite well."),
  ("npc15_signup_2", "I am one of the best swordfighters in Calradia, and I have good command experience."), 
  ...
  ("npc3_signup_response_1", "Excellent. Welcome to the company."),
  ...
  ("npc8_signup_response_1", "Works for me. Welcome to my company."),
  ...
  ("npc12_signup_response_1", "Then welcome to our company."),
...
#11
  ...
  ("npc8_signup_response_2", "Sorry, I need a different type of expertise. Maybe later. Apologies."),
  ...
  ("npc15_signup_response_2", "Actually, I have no need of a commander or another common soldier in my ranks. Good day, ma'am."),
  ...
  ("npc2_payment", "{!}."),
   # Pellagus
  #("npc3_payment", "Thank you, {sir/madame}.  Although I must humbly request {reg3} denars before we leave.  Both to settle my debts here, and to make sure I'm not wasting my time in case things don't go as well as you plan."),
  ("npc3_payment", "Thank you, {sir/madame}.  Although I must request {reg3} denars before we leave. You will find no finer battlefield surgeon in Calradia."),
("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} denars? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ...
  ("npc8_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} denars would be fair, I think."),
  ...
  # Pellagus
  #("npc15_payment", "Excellent. By the way, as a capable commander, I'd like a signing bonus. {reg3} denars would be fair, I think."),
  ("npc15_payment", "Excellent. It is the local custom to offer a commander a favour of payment. {reg3} denars would be fair, I think."),
  ...
  ("npc3_payment_response", "Of course.  Here's {reg3} denars."),
  ...
  ("npc8_payment_response", "Here's {reg3} denars, then."),
  ...
  ("npc4_morality_speech", "Your pardon -- just so you know, the men of the House of Thorgrim do not care to {s21}. I will not be pleased if you continue to take this course."),
  ...
  ("npc15_morality_speech", "{Sir/Ma'am} -- just so you know my opinion, any commander with sense will not let his company {s21}.I hope you don't mind me speaking so bluntly."),
  ...
  ("npc1_personalityclash_speech", "Captain -- no offense, but I'm a bit tired of {s11}, who puts on airs like she's something better than your humble servant Kana."),
  ...
  ("npc4_personalityclash_speech", "{Sir/Madame}. The House of Thorgrim is one of the most ancient and respected families in this part of the world, with a provenance dating back to the Old Calradic Empire. Yet {s11} openly shows me disrespect, and casts doubt on the provenance of my house."),
  ...
  ("npc6_personalityclash_speech", "Your pardon, {sir/madame}, but I cannot keep my tongue stilled any longer. That superstitious imbecile, {s11} -- every time he sees me he points the five fingers of his hand at me -- a peasant's sign to ward off evil."),
  ...
  ("npc10_personalityclash_speech", "Excuse me, captain. I hate to trouble you with such things, but I just wanted to let you know that I can't abide that fellow Thorgrim, the one who calls himself a baron."),
  ...
  ("npc16_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. She has papers with strange symbols and numbers on them."),
  ...
  ("npc8_personalityclash_speech_b", "{s11}, that font of impudence, overheard me, and called me ignorant, and a savage, and other words I do not care to repeat. It was only out of respect for you that I have refrained from arranging an accident for him. I thought it only fit that I should warn you."),
  ...
  ("npc15_personalityclash_speech_b", "What's more, I suspect she's a thief. I found her going through my baggage and pawing some of my past contracts, and she pulled a knife on me when I thought fit to object. A wise captain would not allow her in his company."),
  ("npc16_personalityclash_speech_b", "Fearing witchcraft, I asked her about it, and she told me that a half-clothed, wild-eyed, dirty brat like myself should mind her own business. So I had a look in her baggage, and found strange plans and diagrams. I think she's a sorceress, {sir/madame}, and if I catch her trying to make me fall in love with her, she'll have a knife in her throat."),
...
### set off by behavior after victorious battle
  ...
  ("npc4_personalityclash2_speech", "{Sir/Madame}. I happened to exchange a few words with {s11} as we were dividing up the spoils of battle. Please inform her that when she speaks to me, she should call me 'Baron' or perhaps 'Baron Thorgrim,' or 'Your Grace,' but certainly not just 'Thorgrim.'"),
  ...
  ("npc12_personalityclash2_speech", "Captain. I can no longer abide the rank ignorance of {s11}. As I was treating the wounded during our last battle, she saw fit to disparage my use of laudanum in relieving the pain while I conducted surgery, and of treating wounds with a poultice of honey."),
  ...
  ("npc8_personalityclash2_speech_b",  "As we were cleaning our weapons after that last battle, I remarked that I thought her a handsome girl, and after I established a regular business I would happily find her a match with one of my clients. I thought it was a very generous offer, as a woman disinherited by her father is hardly going to find herself awash in prospects. But rather than thank me, she simply turned her back without a word. It was only out of respect for your leadership that I did not immediately try to teach her some manners."),  #matheld - ymira
  ...
  ("npc12_personalityclash2_speech_b", "Captain, if that chit knew the slightest thing about medical matters, she would know that one should never undermine a patient's confidence in his doctor, particularly not during a complicated operation. If you would be kind enough to dismiss her from this company, you would be doing all of us a great service."), # jeremenus - artimenner
  ...
  ("npc13_personalitymatch_speech", "You have earned your name today, oh valorous one! And {s11}, too! I like that one. He sings the songs of his people as he goes into battle, which appeals to an artistic soul like my own."),
  ("npc14_personalitymatch_speech", "Captain. I am amazed that {s11} still lives. I had thought her dead, but I find it a great relief that she still lives and that she fights even better than before."),
  ("npc15_personalitymatch_speech", "{Sir/Ma'am}, I must say that I found myself surprised when I saw {s11} again. I had always thought him dead; I am glad to see at least one member of my company still lives."),
  ...
  ("npc8_personalitymatch_speech_b", "He managed to include their geneology, their appearance, and their eating habits in a well-framed Old Calradic quatrain. I personally prefer the saga, but we Khergits respect poetic craftwork when we hear it."),
  ...
  ("npc13_personalitymatch_speech_b", "Also, although I normally prefer the company of artists to artisans, there is a certain cold beauty in the work of an engineer. Who knew that ideas like surveying the ground and angles of approach could be so universally applied?"),
  # Pellagus
  #("npc14_personalityclash_speech_b", "I am proud to fight along my old commander once more. Perhaps, one day...but I say too much."),
  ("npc14_personalitymatch_speech_b", "I am proud to fight alongside my old commander once more. Perhaps, one day...but I say too much."),
  ("npc15_personalitymatch_speech_b", "I had always thought that I, of all my friends in that company, was the only survivor. I am glad at least that he survived. Perhaps more of my company waits elsewhere..."),
  ...
  # Pellagus
  #("npc3_retirement_speech", "I am afraid I have something to tell you. I have decided that the warrior's life is not for me. I think it is probably too late for me to find a good marriage -- no one of my people would take a wife who had served with a company of soldiers -- but I may have enough money to start myself up as a healer. I hope you will not be angry, {sir/madame}."),
  ("npc3_retirement_speech", "I have something to tell you. I tire of the warrior's life once more. I have no need for money. I think I shall retire to one of the universities, there to teach my skills. I hope you will not be angry, {sir/madame}."), 
  ("npc4_retirement_speech", "I have fought with you honourably, as befits a son of the House of Thorgrim, but I am not altogether satisfied with your leadership. I will go home to my ancestral estates, which are much in need of my services."),
  ...
  ("npc8_retirement_speech", "I have fought in your shield wall, and done well by it. But your leadership is not always to my liking, and anyways I have been receiving other offers. I think I will hire some mercenaries and travel home with them. Perhaps one day, I will see you again. Farewell, Captain."),
  ...
  ("npc13_retirement_speech", "As the lustre of your name grows ever brighter, I fear that my own reputation will seem pale in comparison, as the moon is outshined by the sun. I have decided to strike out on my own. The very best of luck to you!"),
  ...
  # Pellagus
  #("npc3_rehire_speech", "Well, hello {sir/madame}! It is very good to see you again. I have not fared so well since we parted, I am afraid. My mother's family. whom I hoped would give me a start in chirurgery, have not been as welcoming as I have hoped. I receive nothing but lectures from my aunts, on how I have ruined my prospects for marriage by taking service in a mercenary company. Perhaps I am better suited to war than to commerce, to share a meal over a campfire with rough fellows than to drink wine with the burghers of Veluca. {Sir/Madame}, I must ask you -- will you take me back?"),
  ("npc3_rehire_speech", "Well, hello {sir/madame}! It is very good to see you again. I found the universities to be filled with boring, bookish men who fear their own shadows! Perhaps I am better suited to war than to the pursuit of knowledge, to share a meal over a campfire with rough fellows than to pore over dusty parchments in the library of Jelkala. {Sir/Madame}, I must ask you -- will you take me back?"),
  ...
  ("npc8_rehire_speech", "Greetings to you, {playername}. I was wondering if the harsh words spoken between us in the past could be forgotten. I have been hurting for business here. When I first got here I had to entirely re-equip my shop tools as one of the mercenaries I had hired apparently forgot they didn't belong to them when they left me in the middle of the night. And so now my reserve of denars is running startingly low."),
...
#local color strings
  ...
  ("npc3_home_intro", "Can you smell that? Lemon trees, apples and crocus flowers, it's the scent of Veluca. I was born there, the daughter of a physician. I learned my skills watching him stitch the wounds of Rhodokian soldiers."),
  ...
  ("npc15_home_intro", "Culmarr Castle. I started my career as a mercenary not far from here."),
  ...
  ("npc3_home_description", "Veluca has a long history of scientific discovery, {sir/madame} -- my father was no exception. His methods have saved many lives throughout Calradia and he called the patron Di Veluchi amongst his friends."),
  ...
  ("npc8_home_description", "You haven't heard the story? When Gundig Hairy-Breeks came to Calradia from Nordland, he planted his banner on the headland and said that it would remain there until he recaptured his 'inheritance.' His 'inheritance', he called it. Gundig believed the skalds who told him that the Emperor had bequeathed Calradia to the Nords, when in fact he just gave them a small strip of land along the coast, so that they would crew his galleys."),
  ...
  ("npc15_home_description", "I ran a profitable company of men here for a while, chasing bandits down for the local lord. One day the fat fool thought I would prefer his company rather than his gold and tried to seduce me. Of course, I refused his advances, perhaps a little too forcefully."),
 ...
 #("npc3_home_description_2", "The poets call Veluca a paradise, and I think for once that they do not exaggerate."),
  ("npc3_home_description_2", "Sadly, it was not to last. A greedy merchant who would not pay his bills accused my father of being a fake. He died in disgrace in prison, a broken man. On the day my father died, the merchant was assassinated, by whom I cannot say. He was not missed, unlike my father."),
  ...
  ("npc8_home_description_2", "The skalds' tales at least gave Gundig an excuse to raise a warband -- not that the Nords ever need an excuse, mind. He sailed across the sea, rallied the Calradian Nords to his banner, and marched on the Rock of Rivacheg. The Vaegirs killed him, and threw his banner into the surf. But the Nords keep coming..."),
  ...
  ("npc15_home_description_2", "I should have known a man's pride is tied to his codpiece. He pursued my company with his own army later that day, killing some of my men. Luckily the Rhodoks and Nords were at war at the time. He ran into a patrol of huskarls and with my help they tore his army apart. It still makes me smile when I remember them dragging him away."),
  ...
  ("npc8_home_recap", "I was born in Khergit lands. My parents belonged to a still nomadic tribe raising horses on the open steppe."),
  ...
  ("npc14_kingsupport_objection", "I understand that you've sent your man Kana to proclaim to all Calradia that you intend to free all the miscreants of this land upon your accession to the throne. What a foul idea... Men must be governed, {sir/madame} -- with whips and chains and the noose, if necessary. You'll find that out the hard way if you become {king/queen}, I'll warrant."), #lezalit
...
#
  ...
  ("npc1_fief_acceptance", "You'd make me lord of {s17}, Boss? Well, that would be the kindest thing that anyone has ever done for me in a long time. Heh. I'll make the most of it -- you can count on that. I have to say, though -- I'm not sure how the other lords of this realm will react, when they find old Kana in their august company."), #Borcha
  ...
  ("npc15_fief_acceptance", "Well, {sir/my lady}, that's a gracious act, and marks you as the kind of monarch who can save this sorry land from the incompetence of the current batch. Let me demonstrate what a real commander can do."), #artimenner
...
#### Warband added texts
  ...
  # NE 
  ("s4_is_present_at_the_center_and_is_necessary_for_quest", "{!}{s4} is present at the center and can have the letter delivered"),
  # NE end 
  #Relative types
...
("the_coast", "the coast"),
  ...
  # NE minstrel
  #586 changes start
  ("verse1_female", "Oh Cal-rad-i-aaaaaaa has never seen^A foreigner rising to the rank of Queen^However we may see that yet^As {playername} attempts that feat!^^"),
  ("verse1_male", "Come gather round, for I shall sing^Of an unknown drifter who would be King!^Unlikely as that feat may sound,^{playername} would see himself crown'd.^^"),
  ("verse2_female", "She started out a {s50} when young^And then became a {s51} later,^Ambition's changed her so much that^Nothing less than Queendom'll sate her!^^"),
  ("verse2_male", "He started off a {s50}, a nice young lad^And then became a {s51} - not too bad!^But ambition reared its ugly head^And now he'll be King! (or end up dead)^^"),
  ("verse3_both", "So {he/she} arrived in Calradia - fair land^Of milk and honey and feuds aplenty.^And through the strength of {his/her} own hand^Strives to become one of the landed gentry."),
  ("verse4_merc", " But hush, this story must be told!^To start with, {he/she} had little gold^And {s50} needed a helping hand^So {he/she} joined them with a mercenary band.^^"),
  ("verse4_nonmerc", "{He/She} arrived here with an empty purse,^And knew to fill it would take months or worse,^So {he/she} visited the villages and talked some men^Into riding with {him/her} into bandits' dens.^^"),
  ("verse5_vassal", "At length {his/her} deeds were widely known^And {his/her} fame was quickly growin'^{s51} wooed {him/her} so hard^That {playername} became a vassal lord.^^"),
  ("verse5_nonvassal", "Offers of vassalage came thick and fast^But {playername} knew {he/she} wouldn't last^{He/She} struck at the heart of the tired old guard^And struck out on {his/her} own as a masterless warlord!^^"),
  ("verse6_both", "So now {he's/she's} a {lord/lady} and holds fiefs in {his/her} name^And dreams sweeter dreams where {he/she} furthers {his/her} fame^And plots {his/her} next move and hopes it's not long^Before {his/her} next exploits are worthy of song!"),

  ("verse1_song2", "Silence fell upon the blood-soaked field^As the sun set on a day of war^And the cruel wind, it seemed to keen:^'The {s50}, they are no more!.'^^"),
  ("verse2_song2", "Horses scream and arrows fly^And fighters clash, and cry out, and die^And carrion birds darken the sky.^No quarter is given on either side.^^"),
  ("verse3_song2", "For {s51}: the last battle, the final chance.^But {playername} unleashed the dogs of war.^The {s50} died on sword and lance:^And a race was extinguished, for ever more."),

  
  ("verse1_song3", "O come gather round while I sing of a Stranger^Who came from afar to this beautiful land^And braved feuding nations and all kinds of danger^To build an Empire by strength of {his/her} hand.^^"),
  ("verse2_song3", "A penniless serf with an old farm horse^And a crossbow which shot aged wooden bolts.^A broken sword in {his/her} scabbard, of course^And a carefully hoarded purseful of gold.^^"),
  ("verse3_song3", "{He/She} assembled {his/her} group of companions with care,^Kept them in line with a smile or a glare,^Laughed at {his/her} enemies while {he/she} smote them down,^And set about taking Calradia, town by bloody town. "),
  ("verse4_song3", "The Lords in their castles at first they did sneer^Too coddled and lazy to see this new threat^Till one fateful night they woke up in a sweat^To hear their servants whisper, 'My Lord, {he/she} is here!'^^"),
  ("verse5_song3", "And finally, on the field of battle^The Dark Knights were defeated at last^{He/She} slaughtered them like they were cattle^And wrote {his/her} legend, and made it fast!^^"),
  ("verse6_song3", "{playername}, Calradia salutes you!^{playername}, we sing of your fame!^And every place a tale is told^{playername}, we shout your name!^Huzzah! Huzzah! Huzzah!"),
...
# 0.608b7 new stuff
  ...
  ("noble_title_1_1", "Sir {s0}"),
  ("noble_title_1_2", "Baron {s0}"),
  ("noble_title_1_3", "Viscount {s0}"),
  ("noble_title_1_4", "Count {s0}"),
  ("noble_title_1_5", "Queen {s0}"),

  ("noble_title_2_1", "Blizhnik {s0}"),
  ("noble_title_2_2", "Mestnik {s0}"),
  ("noble_title_2_3", "Boyarin {s0}"),
  ("noble_title_2_4", "Knyaz {s0}"),
  ("noble_title_2_5", "Czar {s0}"),

  ("noble_title_3_1", "{s0}-Darga"),
  ("noble_title_3_2", "{s0}-Noyan"),
  ("noble_title_3_3", "{s0}-Khan"),
  ("noble_title_3_4", "{s0}-Taiji"),
  ("noble_title_3_5", "{s0}-Khagan"),

  ("noble_title_4_1", "Huskarl {s0}"),
  ("noble_title_4_2", "Thegn {s0}"),
  ("noble_title_4_3", "Thane {s0}"),
  ("noble_title_4_4", "Drottinn {s0}"),
  ("noble_title_4_5", "Jarl {s0}"),

  ("noble_title_5_1", "Advisor {s0}"),
  ("noble_title_5_2", "Elder {s0}"),
  ("noble_title_5_3", "Councilor {s0}"),
  ("noble_title_5_4", "Senator {s0}"),
  ("noble_title_5_5", "Dictator {s0}"),

  ("noble_title_6_1", "{s0}-Effendi"),
  ("noble_title_6_2", "{s0}-Bey"),
  ("noble_title_6_3", "{s0}-Pasha"),
  ("noble_title_6_4", "{s0}-Khedive"),
  ("noble_title_6_5", "Sultan {s0}"),

  ("noble_title_7_1", "Brother {s0}"),
  ("noble_title_7_2", "Komtur {s0}"),
  ("noble_title_7_3", "Landkomtur {s0}"),
  ("noble_title_7_4", "Grosskomtur {s0}"),
  ("noble_title_7_5", "Kaiserine {s0}"),

  ("noble_title_a_1", "Strator {s0}"),
  ("noble_title_a_2", "Patrikios {s0}"),
  ("noble_title_a_3", "Vestes {s0}"),
  ("noble_title_a_4", "Magistros {s0}"),
  ("noble_title_a_5", "Player"),

  ("noble_title_b_1", "Sayyid {s0}"),
  ("noble_title_b_2", "Sharif {s0}"),
  ("noble_title_b_3", "Habib {s0}"),
  ("noble_title_b_4", "Sheikh {s0}"),
  ("noble_title_b_5", "Caliph {s0}"),

  ("noble_title_c_1", "{s0}-Agha"),
  ("noble_title_c_2", "{s0}-Mirza"),
  ("noble_title_c_3", "{s0}-Satrap"),
  ("noble_title_c_4", "{s0}-Shah"),
  ("noble_title_c_5", "Player"),

  ("noble_title_d_1", "Shliakhta {s0}"),
  ("noble_title_d_2", "Pan {s0}"),
  ("noble_title_d_3", "Komes {s0}"),
  ("noble_title_d_4", "Hetman {s0}"),
  ("noble_title_d_5", "Player"),

  ("noble_title_e_1", "Hidalgo {s0}"),
  ("noble_title_e_2", "Caballero {s0}"),
  ("noble_title_e_3", "Ricohombre {s0}"),
  ("noble_title_e_4", "Grande {s0}"),
  ("noble_title_e_5", "Player"),

  ("noble_title_f_1", "Laird {s0}"),
  ("noble_title_f_2", "Esquire {s0}"),
  ("noble_title_f_3", "Lord {s0}"),
  ("noble_title_f_4", "Earl {s0}"),
  ("noble_title_f_5", "Player"),

  ("noble_title_g_1", "Samurai {s0}"),
  ("noble_title_g_2", "Baishin {s0}"),
  ("noble_title_g_3", "Daimyou {s0}"),
  ("noble_title_g_4", "Shogun {s0}"),
  ("noble_title_g_5", "Player"),

  ("noble_title_h_1", "Tovarisch {s0}"),
  ("noble_title_h_2", "Partiyetz {s0}"),
  ("noble_title_h_3", "Comissar {s0}"),
  ("noble_title_h_4", "Narkom {s0}"),
  ("noble_title_h_5", "Player"),

  ("noble_title_i_1", "Sheriff {s0}"),
  ("noble_title_i_2", "Deputy {s0}"),
  ("noble_title_i_3", "Mayor {s0}"),
  ("noble_title_i_4", "Governor {s0}"),
  ("noble_title_i_5", "Player"),

  ("noble_title_j_1", "reserved {s0}"),
  ("noble_title_j_2", "reserved {s0}"),
  ("noble_title_j_3", "reserved {s0}"),
  ("noble_title_j_4", "reserved {s0}"),
  ("noble_title_j_5", "Player"),

  ("noble_title_k_1", "reserved {s0}"),
  ("noble_title_k_2", "reserved {s0}"),
  ("noble_title_k_3", "reserved {s0}"),
  ("noble_title_k_4", "reserved {s0}"),
  ("noble_title_k_5", "Player"),

  ("noble_title_l_1", "reserved {s0}"),
  ("noble_title_l_2", "reserved {s0}"),
  ("noble_title_l_3", "reserved {s0}"),
  ("noble_title_l_4", "reserved {s0}"),
  ("noble_title_l_5", "Player"),

  ("noble_title_m_1", "reserved {s0}"),
  ("noble_title_m_2", "reserved {s0}"),
  ("noble_title_m_3", "reserved {s0}"),
  ("noble_title_m_4", "reserved {s0}"),
  ("noble_title_m_5", "Player"),

  ("noble_title_n_1", "reserved {s0}"),
  ("noble_title_n_2", "reserved {s0}"),
  ("noble_title_n_3", "reserved {s0}"),
  ("noble_title_n_4", "reserved {s0}"),
  ("noble_title_n_5", "Player"),

  ("noble_title_o_1", "reserved {s0}"),
  ("noble_title_o_2", "reserved {s0}"),
  ("noble_title_o_3", "reserved {s0}"),
  ("noble_title_o_4", "reserved {s0}"),
  ("noble_title_o_5", "Player"),

  ("noble_title_p_1", "reserved {s0}"),
  ("noble_title_p_2", "reserved {s0}"),
  ("noble_title_p_3", "reserved {s0}"),
  ("noble_title_p_4", "reserved {s0}"),
  ("noble_title_p_5", "Player"),

  ("prosperity_0_brief",  "wretchedly poor"),
  ("prosperity_1_brief",  "extremely poor"),
  ("prosperity_2_brief",  "very poor"),
  ("prosperity_3_brief",  "quite poor"),
  ("prosperity_4_brief",  "poor"),
  ("prosperity_5_brief",  "unremarkable"),
  ("prosperity_6_brief",  "somewhat prosperous"),
  ("prosperity_7_brief",  "prosperous"),
  ("prosperity_8_brief",  "rich"),
  ("prosperity_9_brief",  "very rich"),
  ("prosperity_10_brief", "filthy rich"),

  ("relation_minus_100_brief", "hates you with a passion"),
  ("relation_minus_90_brief", "hates you intensely"),
  ("relation_minus_80_brief", "hates you strongly"), 
  ("relation_minus_70_brief", "hates you"), 
  ("relation_minus_60_brief", "hateful to you"), 
  ("relation_minus_50_brief", "extremely hostile to you"), 
  ("relation_minus_40_brief", "very hostile to you"), 
  ("relation_minus_30_brief", "hostile to you"), 
  ("relation_minus_20_brief", "against you"), 
  ("relation_minus_10_brief", "opposed to you"), 
  ("relation_plus_0_brief", "indifferent to you"), 
  ("relation_plus_10_brief", "acceptive to you"), 
  ("relation_plus_20_brief", "cooperative to you"), 
  ("relation_plus_30_brief", "somewhat supportive to you"), 
  ("relation_plus_40_brief", "supportive to you"), 
  ("relation_plus_50_brief", "very supportive to you"), 
  ("relation_plus_60_brief", "loyal to you"), 
  ("relation_plus_70_brief", "highly loyal to you"), 
  ("relation_plus_80_brief", "devoted to you"), 
  ("relation_plus_90_brief", "fiercely devoted to you"),
  ("relation_plus_100_brief", "fanatically devoted to you"),

  # Version 0.608b9 strings

  ("improvement_manor", "Manor"),
  ("improvement_fish_pond", "Mill"),
  ("improvement_watch_tower", "Watch Tower"),
  ("improvement_school", "School"),
  ("improvement_palisade", "Palisade"),
  ("improvement_horse_ranch", "Horse Ranch"),
  ("improvement_distillery", "Distillery"),
  ("improvement_caltrops", "Caltrops"),
  ("improvement_cattle_ranch", "Cattle Ranch"),
  ("improvement_messenger_post", "Messenger Post"),
  ("improvement_bugged", "Useless Building"),
  ("improvement_caravan_escort", "Caravan Escort Outpost"),
  ("improvement_bookstore", "Bookstore"),
  ("improvement_festival_square", "Festival Square"),
  ("improvement_blacksmith", "Blacksmith"),
  ("improvement_prisoner_tower", "Prisoner Tower"),
  ("improvement_cathedral", "Cathedral"),
  ("improvement_ivory_temple", "Ivory Temple"),
  ("improvement_palace", "Palace"),
  ("improvement_hall", "Halls of Glory"),
  ("improvement_chambers", "Council Chambers"),
  ("improvement_baths", "House of Swords"),

  ("key_name_unassigned", "(unassigned)"),
  ("key_name_00", "(unassigned)"), # Legacy
  ("key_name_01", "Escape"),
  ("key_name_02", "1"),
  ("key_name_03", "2"),
  ("key_name_04", "3"),
  ...
  ("key_name_34", ". >"),
  ("key_name_35", "/ ?"),
  ("key_name_36", "Right Shift"),
  ("key_name_37", "Numpad *"),
  ("key_name_38", "Left Alt"),
  ("key_name_39", "Space"),
  ("key_name_3a", "Caps Lock"),
  ("key_name_3b", "F1"),
  ("key_name_3c", "F2"),
  ("key_name_3d", "F3"),
  ("key_name_3e", "F4"),
  ...
  ("key_name_43", "F9"),
  ("key_name_44", "F10"),
  ("key_name_45", "Num Lock"),
  ("key_name_46", "Scroll Lock"),
  ("key_name_47", "Numpad 7"),
  ("key_name_48", "Numpad 8"),
  ("key_name_49", "Numpad 9"),
  ("key_name_4a", "Numpad -"),
  ("key_name_4b", "Numpad 4"),
  ("key_name_4c", "Numpad 5"),
  ("key_name_4d", "Numpad 6"),
  ("key_name_4e", "Numpad +"),
  ("key_name_4f", "Numpad 1"),
  ("key_name_50", "Numpad 2"),
  ("key_name_51", "Numpad 3"),
  ("key_name_52", "Numpad 0"),
  ("key_name_53", "Numpad ."),
  ("key_name_54", "(key code 0x54)"),
  ("key_name_55", "(key code 0x55)"),
  ("key_name_56", "(key code 0x56)"),
  ("key_name_57", "F11"),
  ("key_name_58", "F12"),
  ("key_name_59", "(key code 0x59)"),
  ("key_name_5a", "(key code 0x5a)"),
  ("key_name_5b", "(key code 0x5b)"),
  ("key_name_5c", "(key code 0x5c)"),
  ("key_name_5d", "(key code 0x5d)"),
  ("key_name_5e", "(key code 0x5e)"),
  ("key_name_5f", "(key code 0x5f)"),
  ("key_name_60", "(key code 0x60)"),
  ("key_name_61", "(key code 0x61)"),
  ("key_name_62", "(key code 0x62)"),
  ("key_name_63", "(key code 0x63)"),
  ("key_name_64", "(key code 0x64)"),
  ("key_name_65", "(key code 0x65)"),
  ("key_name_66", "(key code 0x66)"),
  ("key_name_67", "(key code 0x67)"),
  ("key_name_68", "(key code 0x68)"),
  ("key_name_69", "(key code 0x69)"),
  ("key_name_6a", "(key code 0x6a)"),
  ("key_name_6b", "(key code 0x6b)"),
  ("key_name_6c", "(key code 0x6c)"),
  ("key_name_6d", "(key code 0x6d)"),
  ("key_name_6e", "(key code 0x6e)"),
  ("key_name_6f", "(key code 0x6f)"),
  ("key_name_70", "(key code 0x70)"),
  ("key_name_71", "(key code 0x71)"),
  ("key_name_72", "(key code 0x72)"),
  ("key_name_73", "(key code 0x73)"),
  ("key_name_74", "(key code 0x74)"),
  ("key_name_75", "(key code 0x75)"),
  ("key_name_76", "(key code 0x76)"),
  ("key_name_77", "(key code 0x77)"),
  ("key_name_78", "(key code 0x78)"),
  ("key_name_79", "(key code 0x79)"),
  ("key_name_7a", "(key code 0x7a)"),
  ("key_name_7b", "(key code 0x7b)"),
  ("key_name_7c", "(key code 0x7c)"),
  ("key_name_7d", "(key code 0x7d)"),
  ("key_name_7e", "(key code 0x7e)"),
  ("key_name_7f", "(key code 0x7f)"),
  ("key_name_80", "(key code 0x80)"),
  ("key_name_81", "(key code 0x81)"),
  ("key_name_82", "(key code 0x82)"),
  ("key_name_83", "(key code 0x83)"),
  ("key_name_84", "(key code 0x84)"),
  ("key_name_85", "(key code 0x85)"),
  ("key_name_86", "(key code 0x86)"),
  ("key_name_87", "(key code 0x87)"),
  ("key_name_88", "(key code 0x88)"),
  ("key_name_89", "(key code 0x89)"),
  ("key_name_8a", "(key code 0x8a)"),
  ("key_name_8b", "(key code 0x8b)"),
  ("key_name_8c", "(key code 0x8c)"),
  ("key_name_8d", "(key code 0x8d)"),
  ("key_name_8e", "(key code 0x8e)"),
  ("key_name_8f", "(key code 0x8f)"),
  ("key_name_90", "(key code 0x90)"),
  ("key_name_91", "(key code 0x91)"),
  ("key_name_92", "(key code 0x92)"),
  ("key_name_93", "(key code 0x93)"),
  ("key_name_94", "(key code 0x94)"),
  ("key_name_95", "(key code 0x95)"),
  ("key_name_96", "(key code 0x96)"),
  ("key_name_97", "(key code 0x97)"),
  ("key_name_98", "(key code 0x98)"),
  ("key_name_99", "(key code 0x99)"),
  ("key_name_9a", "(key code 0x9a)"),
  ("key_name_9b", "(key code 0x9b)"),
  ("key_name_9c", "Numpad Enter"),
  ("key_name_9d", "Right Ctrl"),
  ("key_name_9e", "(key code 0x9e)"),
  ("key_name_9f", "(key code 0x9f)"),
  ("key_name_a0", "(key code 0xa0)"),
  ("key_name_a1", "(key code 0xa1)"),
  ("key_name_a2", "(key code 0xa2)"),
  ("key_name_a3", "(key code 0xa3)"),
  ("key_name_a4", "(key code 0xa4)"),
  ("key_name_a5", "(key code 0xa5)"),
  ("key_name_a6", "(key code 0xa6)"),
  ("key_name_a7", "(key code 0xa7)"),
  ("key_name_a8", "(key code 0xa8)"),
  ("key_name_a9", "(key code 0xa9)"),
  ("key_name_aa", "(key code 0xaa)"),
  ("key_name_ab", "(key code 0xab)"),
  ("key_name_ac", "(key code 0xac)"),
  ("key_name_ad", "(key code 0xad)"),
  ("key_name_ae", "(key code 0xae)"),
  ("key_name_af", "(key code 0xaf)"),
  ("key_name_b0", "(key code 0xb0)"),
  ("key_name_b1", "(key code 0xb1)"),
  ("key_name_b2", "(key code 0xb2)"),
  ("key_name_b3", "(key code 0xb3)"),
  ("key_name_b4", "(key code 0xb4)"),
  ("key_name_b5", "Numpad /"),
  ("key_name_b6", "(key code 0xb6)"),
  ("key_name_b7", "Print Screen"),
  ("key_name_b8", "Right Alt"),
  ("key_name_b9", "(key code 0xb9)"),
  ("key_name_ba", "(key code 0xba)"),
  ("key_name_bb", "(key code 0xbb)"),
  ("key_name_bc", "(key code 0xbc)"),
  ("key_name_bd", "(key code 0xbd)"),
  ("key_name_be", "(key code 0xbe)"),
  ("key_name_bf", "(key code 0xbf)"),
  ("key_name_c0", "(key code 0xc0)"),
  ("key_name_c1", "(key code 0xc1)"),
  ("key_name_c2", "(key code 0xc2)"),
  ("key_name_c3", "(key code 0xc3)"),
  ("key_name_c4", "(key code 0xc4)"),
  ("key_name_c5", "Pause/Break"),
  ("key_name_c6", "(key code 0xc6)"),
  ("key_name_c7", "Home"),
  ("key_name_c8", "Up Arrow"),
  ("key_name_c9", "Page Up"),
  ("key_name_ca", "(key code 0xca)"),
  ("key_name_cb", "Left Arrow"),
  ("key_name_cc", "(key code 0xcc)"),
  ("key_name_cd", "Right Arrow"),
  ("key_name_ce", "(key code 0xce)"),
  ("key_name_cf", "End"),
  ("key_name_d0", "Down Arrow"),
  ("key_name_d1", "Page Down"),
  ("key_name_d2", "Insert"),
  ("key_name_d3", "Delete"),
  ("key_name_d4", "(key code 0xd4)"),
  ("key_name_d5", "(key code 0xd5)"),
  ("key_name_d6", "(key code 0xd6)"),
  ("key_name_d7", "(key code 0xd7)"),
  ("key_name_d8", "(key code 0xd8)"),
  ("key_name_d9", "(key code 0xd9)"),
  ("key_name_da", "(key code 0xda)"),
  ("key_name_db", "(key code 0xdb)"),
  ("key_name_dc", "(key code 0xdc)"),
  ("key_name_dd", "(key code 0xdd)"),
  ("key_name_de", "(key code 0xde)"),
  ("key_name_df", "(key code 0xdf)"),
  ("key_name_e0", "Left Mouse Button"),
  ("key_name_e1", "Right Mouse Button"),
  ("key_name_e2", "Middle Mouse Button"),
  ("key_name_e3", "Mouse Button 4"),
  ("key_name_e4", "Mouse Button 5"),
  ("key_name_e5", "Mouse Button 6"),
  ("key_name_e6", "Mouse Button 7"),
  ("key_name_e7", "Mouse Button 8"),
  ("key_name_e8", "(key code 0xe8)"),
  ("key_name_e9", "(key code 0xe9)"),
  ("key_name_ea", "(key code 0xea)"),
  ("key_name_eb", "(key code 0xeb)"),
  ("key_name_ec", "(key code 0xec)"),
  ("key_name_ed", "(key code 0xed)"),
  ("key_name_ee", "Mouse Scroll Up"),
  ("key_name_ef", "Mouse Scroll Down"),
  ("key_name_f0", "Xbox A"),
  ("key_name_f1", "Xbox B"),
  ("key_name_f2", "Xbox X"),
  ("key_name_f3", "Xbox Y"),
  ("key_name_f4", "Xbox D-pad Up"),
  ("key_name_f5", "Xbox D-pad Down"),
  ("key_name_f6", "Xbox D-pad Right"),
  ("key_name_f7", "Xbox D-pad Left"),
  ("key_name_f8", "Xbox Start"),
  ("key_name_f9", "Xbox Back"),
  ("key_name_fa", "Xbox Right Bumber"),
  ("key_name_fb", "Xbox Left Bumber"),
  ("key_name_fc", "Xbox Left Trigger"),
  ("key_name_fd", "Xbox Right Trigger"),
  ("key_name_fe", "Xbox Right Stick"),
  ("key_name_ff", "Xbox Left Stick"),

  ("gamekey_name_00", "Move Forward"),
  ("gamekey_name_01", "Move Backward"),
  ("gamekey_name_02", "Move Left"),
  ("gamekey_name_03", "Move Right"),
  ("gamekey_name_04", "Action"),
  ("gamekey_name_05", "Jump"),
  ("gamekey_name_06", "Attack"),
  ("gamekey_name_07", "Defend"),
  ("gamekey_name_08", "Kick"),
  ("gamekey_name_09", "Toggle Weapon Mode"),
  ("gamekey_name_10", "Equip Weapon #1"),
  ("gamekey_name_11", "Equip Weapon #2"),
  ("gamekey_name_12", "Equip Weapon #3"),
  ("gamekey_name_13", "Equip Weapon #4"),
  ("gamekey_name_14", "Equip Primary Weapon"),
  ("gamekey_name_15", "Equip Secondary Weapon"),
  ("gamekey_name_16", "Drop Weapon"),
  ("gamekey_name_17", "Sheath Weapon"),
  ("gamekey_name_18", "Leave"),
  ("gamekey_name_19", "Zoom"),
  ("gamekey_name_20", "View Char"),
  ("gamekey_name_21", "Camera Toggle"),
  ("gamekey_name_22", "View Orders"),
  ("gamekey_name_23", "Order #1"),
  ("gamekey_name_24", "Order #2"),
  ("gamekey_name_25", "Order #3"),
  ("gamekey_name_26", "Order #4"),
  ("gamekey_name_27", "Order #5"),
  ("gamekey_name_28", "Order #6"),
  ("gamekey_name_29", "Everyone!"),
  ("gamekey_name_30", "Infantry!"),
  ("gamekey_name_31", "Archers!"),
  ("gamekey_name_32", "Cavalry!"),
  ("gamekey_name_33", "Group #3!"),
  ("gamekey_name_34", "Group #4!"),
  ("gamekey_name_35", "Group #5!"),
  ("gamekey_name_36", "Group #6!"),
  ("gamekey_name_37", "Group #7!"),
  ("gamekey_name_38", "Group #8!"),
  ("gamekey_name_39", "Reverse Order Group"),
  ("gamekey_name_40", "Everyone Around Hear"),
  ("gamekey_name_41", "MP Message to All"),
  ("gamekey_name_42", "MP Message to Team"),
  ("gamekey_name_43", "Character Window"),
  ("gamekey_name_44", "Inventory Window"),
  ("gamekey_name_45", "Party Window"),
  ("gamekey_name_46", "Quests Window"),
  ("gamekey_name_47", "Game Log Window"),
  ("gamekey_name_48", "Quicksave"),
  ("gamekey_name_49", "Crouch"),
  ("gamekey_name_50", "Order #7"),
  ("gamekey_name_51", "Order #8"),
