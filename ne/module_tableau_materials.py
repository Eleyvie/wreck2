...
################################################################################
    ...
    ("heraldic_armor_a", 0, "sample_heraldic_armor_a", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_heraldic_armor_a", ":banner_mesh", -25, 130, 103, 200),
    ]),
    ("heraldic_armor_c", 0, "sample_heraldic_armor_c", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_heraldic_armor_c", ":banner_mesh", 0, 130, 115, 200),
    ]),
    ("heraldic_armor_d", 0, "sample_heraldic_armor_d", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_heraldic_armor_d", ":banner_mesh", 0, 130, 113, 200),
    ]),

    ("heraldic_shirt_a", 0, "shirt_a", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_shirt_a", ":banner_mesh", 14, 125, 92, 200),
    ]),
    ("heraldic_arena_tunic_new", 0, "arena_tunicW", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_arena_tunicW", ":banner_mesh", -3, 133, 85, 200),
    ]),
    ("heraldic_rich_tunic_a", 0, "rich_tunic_a", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_rich_tunic_a", ":banner_mesh", 32, 116, 80, 200),
    ]),
    ("heraldic_tabard_b", 0, "tabard_b", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_tabard_b", ":banner_mesh", 52, 110, 67, 200),
    ]),
    ("heraldic_padded_cloth_a", 0, "padded_cloth_a", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_padded_cloth_a", ":banner_mesh", -61, 141, 87, 200),
    ]),
    ("heraldic_padded_cloth_b", 0, "padded_cloth_b", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_padded_cloth_b", ":banner_mesh", -63, 131, 80, 200),
    ]),
    ("heraldic_archers_vest", 0, "archers_vest", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_archers_vest", ":banner_mesh", -61, 115, 60, 200),
    ]),
    ("heraldic_leather_vest_a", 0, "leather_vest_a", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_leather_vest_a", ":banner_mesh", -61, 122, 80, 200),
    ]),
    ("heraldic_shirt_leather_plate", 0, "pino_shirt_leather_plate", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_shirt_leather_plate", ":banner_mesh", -63, 140, 90, 200),
    ]),
    ("heraldic_sarranid_leather_armor", 0, "sarranid_leather_armor", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_sarranid_leather_armor", ":banner_mesh", 12, 103, 97, 200),
    ]),
    ("heraldic_tribal_warrior_outfit_a_new", 0, "tribal_warrior_outfit_a", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_tribal_warrior_outfit_a", ":banner_mesh", 0, 65, 100, 200),
    ]),
    ("heraldic_light_mail_and_plate", 0, "light_mail_and_plate", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_light_mail_and_plate", ":banner_mesh", -59, 135, 87, 200),
    ]),
    ("heraldic_mail_and_plate", 0, "mail_and_plate", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mail_and_plate", ":banner_mesh", -57, 133, 80, 200),
    ]),
    ("heraldic_cuir_bouilli_a", 0, "cuir_bouilli_a", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_cuir_bouilli_a", ":banner_mesh", -71, 127, 80, 200),
    ]),
    ("heraldic_brigandine_b", 0, "brigandine_b", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_brigandine_b", ":banner_mesh", -59, 135, 87, 200),
    ]),
    ("heraldic_arena_armor_new", 0, "arena_armorW", 512, 512, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_arena_armorW", ":banner_mesh", -5, 114, 75, 200),
    ]),
    ("heraldic_mail_long_surcoat_new", 0, "mail_long_surcoat", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mail_long_surcoat", ":banner_mesh", 54, 90, 70, 200),
    ]),
    ("heraldic_full_plate_armor", 0, "full_plate", 1024, 1024, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_full_plate", ":banner_mesh", 34, 121, 80, 200),
    ]),

    ("round_shield_1", 0, "sample_shield_round_1", 512, 256, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_round_1", ":banner_mesh", -50, 125, 120, 100),
    ]),
    ("round_shield_2", 0, "sample_shield_matte", 512, 256, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_round_2", ":banner_mesh", -50, 120, 116, 100),
    ]),
    ("round_shield_3", 0, "sample_shield_matte", 512, 256, 0, 0, 0, 0, [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_round_3", ":banner_mesh", -50, 120, 116, 100),
    ]),
  
  ("round_shield_4", 0, "sample_shield_matte", 512, 256, 0, 0, 0, 0,
   [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_round_4", ":banner_mesh", -50, 125, 123, 100),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
  ...
  ("round_shield_5", 0, "sample_shield_matte", 512, 256, 0, 0, 0, 0,
   [
        (store_script_param, ":banner_mesh", 1),
        (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_round_5", ":banner_mesh", -50, 125, 122, 100),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
       #(position_set_y, pos1, 125),
  ...
  ("small_round_shield_1", 0, "sample_shield_small_round_1", 512, 256, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_small_round_1", ":banner_mesh", -50, 130, 127, 100),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
  ...
  ("small_round_shield_2", 0, "sample_shield_small_round_2", 512, 256, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_small_round_2", ":banner_mesh", -50, 130, 127, 100),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
       #(position_set_y, pos1, 130),
  ...
  ("small_round_shield_3", 0, "sample_shield_matte", 512, 256, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_small_round_3", ":banner_mesh", -50, 130, 127, 100),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
       #(position_set_y, pos1, 130),
  ...
  ("kite_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_kite_1", ":banner_mesh", -60, 140, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -60),
  ...
  ("kite_shield_2", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_kite_2", ":banner_mesh", -57, 140, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
  ...
  ("kite_shield_3", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_kite_3", ":banner_mesh", -57, 140, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -57),
       #(position_set_y, pos1, 140),
  ...
  ("kite_shield_4", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_kite_4", ":banner_mesh", -50, 160, 120, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
  ...
  ("heater_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_heater_1", ":banner_mesh", -60, 151, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -60),
  ...
  ("heater_shield_2", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_heater_2", ":banner_mesh", -50, 150, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -50),
  ...
  ("pavise_shield_1", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_pavise_1", ":banner_mesh", -54, 120, 118, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
  ...
  ("pavise_shield_2", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_mesh_shield_pavise_2", ":banner_mesh", -54, 120, 116, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -54),
       #(position_set_y, pos1, 120),
  ...
  ("pavise_shield_3", 0, "lav_heraldic_shield_pavise_3", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       (call_script, "script_setup_heraldry", "mesh_tableau_shield_pavise_3", ":banner_mesh", -52, 104, 100, 200),
       #(set_fixed_point_multiplier, 100),
       #(init_position, pos1),
       #(position_set_x, pos1, -54),
       #(position_set_y, pos1, 120),
    ...
    #("tableau_material_name", 0, "sample_material_name", 1024, 1024, 0, 0, 0, 0, [
    #   (store_script_param, ":banner_mesh", 1),
    #   (call_script, "script_setup_heraldry", "mesh_heraldic_tableau", ":banner_mesh", g.heraldic_x, g.heraldic_y, g.heraldic_s, 200),
    #]),
