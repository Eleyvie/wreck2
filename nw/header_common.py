...
multiplayer_event_admin_set_num_bots_in_team                  = 3
multiplayer_event_admin_set_friendly_fire                     = 4
multiplayer_event_admin_set_ghost_mode                        = 5
multiplayer_event_admin_set_control_block_dir                 = 6
#multiplayer_event_admin_set_add_to_servers_list               = 7
multiplayer_event_admin_set_respawn_period                    = 7
multiplayer_event_admin_set_game_max_minutes                  = 8
multiplayer_event_admin_set_round_max_seconds                 = 9
multiplayer_event_admin_set_game_max_points                   = 10
multiplayer_event_admin_set_point_gained_from_flags           = 11
multiplayer_event_admin_set_point_gained_from_capturing_flag  = 12
multiplayer_event_admin_set_server_name                       = 13
multiplayer_event_admin_set_game_password                     = 14
multiplayer_event_admin_set_team_faction                      = 15
multiplayer_event_open_admin_panel                            = 16
multiplayer_event_change_team_no                              = 17
multiplayer_event_change_troop_id                             = 18
multiplayer_event_start_new_poll                              = 19
multiplayer_event_answer_to_poll                              = 20
multiplayer_event_admin_kick_player                           = 21
multiplayer_event_admin_ban_player                            = 22
multiplayer_event_admin_set_num_bots_voteable                 = 23
multiplayer_event_admin_set_factions_voteable                 = 24
multiplayer_event_admin_set_maps_voteable                     = 25
multiplayer_event_admin_set_player_respawn_as_bot             = 26
multiplayer_event_admin_set_combat_speed                      = 27
multiplayer_event_admin_set_respawn_count                     = 28
multiplayer_event_admin_set_kick_voteable                     = 29
multiplayer_event_admin_set_ban_voteable                      = 30
multiplayer_event_admin_set_valid_vote_ratio                  = 31
multiplayer_event_admin_set_auto_team_balance_limit           = 32
multiplayer_event_admin_set_welcome_message                   = 33
multiplayer_event_admin_set_melee_friendly_fire               = 34
multiplayer_event_admin_set_friendly_fire_damage_self_ratio   = 35
multiplayer_event_admin_set_friendly_fire_damage_friend_ratio = 36
multiplayer_event_admin_set_allow_player_banners              = 37
# Vincenzo
#multiplayer_event_admin_set_anti_cheat                        = 38
multiplayer_event_open_game_rules                             = 38
multiplayer_event_offer_duel                                  = 39

#server events
multiplayer_event_return_max_num_players                      = 40
multiplayer_event_return_num_bots_in_team                     = 41
multiplayer_event_return_friendly_fire                        = 42
multiplayer_event_return_ghost_mode                           = 43
multiplayer_event_return_control_block_dir                    = 44
multiplayer_event_return_combat_speed                         = 45
#multiplayer_event_return_add_to_servers_list                  = 46
multiplayer_event_return_respawn_period                       = 46
multiplayer_event_return_game_max_minutes                     = 47
multiplayer_event_return_round_max_seconds                    = 48
multiplayer_event_return_game_max_points                      = 49
multiplayer_event_return_point_gained_from_flags              = 50
multiplayer_event_return_point_gained_from_capturing_flag     = 51
multiplayer_event_return_server_name                          = 52
multiplayer_event_return_game_password                        = 53
multiplayer_event_return_game_type                            = 54
multiplayer_event_return_confirmation                         = 55
multiplayer_event_return_rejection                            = 56
multiplayer_event_show_multiplayer_message                    = 57
multiplayer_event_draw_this_round                             = 58
multiplayer_event_set_attached_scene_prop                     = 59
multiplayer_event_set_team_flag_situation                     = 60
multiplayer_event_set_team_score                              = 61
multiplayer_event_set_num_agents_around_flag                  = 62
multiplayer_event_ask_for_poll                                = 63
multiplayer_event_change_flag_owner                           = 64
multiplayer_event_use_item                                    = 65
multiplayer_event_set_scene_prop_open_or_close                = 66
multiplayer_event_set_round_start_time                        = 67
multiplayer_event_force_start_team_selection                  = 68
multiplayer_event_start_death_mode                            = 69
multiplayer_event_return_num_bots_voteable                    = 70
multiplayer_event_return_factions_voteable                    = 71
multiplayer_event_return_maps_voteable                        = 72
multiplayer_event_return_next_team_faction                    = 73
multiplayer_event_return_player_respawn_as_bot                = 74
multiplayer_event_set_player_score_kill_death                 = 75
multiplayer_event_return_respawn_count                        = 76
multiplayer_event_return_player_respawn_spent                 = 77
multiplayer_event_return_kick_voteable                        = 78
multiplayer_event_return_ban_voteable                         = 79
multiplayer_event_return_valid_vote_ratio                     = 80
multiplayer_event_return_auto_team_balance_limit              = 81
multiplayer_event_return_renaming_server_allowed              = 82
multiplayer_event_return_changing_game_type_allowed           = 83
multiplayer_event_return_melee_friendly_fire                  = 84
multiplayer_event_return_friendly_fire_damage_self_ratio      = 85
multiplayer_event_return_friendly_fire_damage_friend_ratio    = 86
multiplayer_event_return_allow_player_banners                 = 87
multiplayer_event_return_anti_cheat                           = 88
multiplayer_event_return_open_game_rules                      = 89
multiplayer_event_return_max_num_bots                         = 90
multiplayer_event_return_server_mission_timer_while_player_joined = 91
multiplayer_event_show_duel_request                           = 92
multiplayer_event_start_duel                                  = 93
multiplayer_event_cancel_duel                                 = 94
multiplayer_event_show_server_message                         = 95
multiplayer_event_return_agent_stop_sound                     = 96
multiplayer_event_set_spawn_flag                              = 97
multiplayer_event_admin_set_mod_variable                      = 98
multiplayer_event_return_mod_variable                         = 99
multiplayer_event_send_admin_chat                             = 100
multiplayer_event_return_admin_chat                           = 101
multiplayer_event_send_inter_admin_chat                       = 102
multiplayer_event_return_inter_admin_chat                     = 103
multiplayer_event_player_list_action                          = 104
multiplayer_event_admin_cheat_spawn_item                      = 105
multiplayer_event_admin_cheat_teleport                        = 106
multiplayer_event_reset_map                                   = 107
multiplayer_event_return_sound_at_pos                         = 108
multiplayer_event_return_particle_at_pos                      = 109
multiplayer_event_return_scale_object                         = 110
multiplayer_event_send_control_command                        = 111
multiplayer_event_return_currently_controlling_object         = 112
multiplayer_event_player_build_prop                           = 113
multiplayer_event_return_build_points                         = 114
multiplayer_event_return_prop_effects                         = 115
multiplayer_event_return_thunder                              = 116
multiplayer_event_send_player_action                          = 117
multiplayer_event_return_server_action                        = 118
...
multiplayer_message_types_end                        = 21
...
multiplayer_game_type_king	                 = 22
multiplayer_game_type_scene_making           = 8
